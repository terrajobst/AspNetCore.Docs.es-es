...
<span data-ttu-id="b4447-103">[Anterior: Agregar un modelo](adding-model.md)
[Siguiente: Vistas y métodos de controlador](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="b4447-103">[Previous - Add a model](adding-model.md)
