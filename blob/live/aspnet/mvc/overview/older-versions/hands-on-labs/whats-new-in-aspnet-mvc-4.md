...
3. <span data-ttu-id="008cd-334">Agregue los siguientes miembros a la **fotográfica** clase.</span><span class="sxs-lookup"><span data-stu-id="008cd-334">Add the following members to the **Photo** class.</span></span>
    ...
    <span data-ttu-id="008cd-335">(Código de fragmento de código: *modelo foto de ASP.NET MVC 4 laboratorio - Ex02 -*)</span><span class="sxs-lookup"><span data-stu-id="008cd-335">(Code Snippet - *ASP.NET MVC 4 Lab - Ex02 - Photo model*)</span></span>
...
10. <span data-ttu-id="008cd-349">Ejecute la aplicación.</span><span class="sxs-lookup"><span data-stu-id="008cd-349">Run the application.</span></span> <span data-ttu-id="008cd-350">Ahora debería ver la página principal muestra las fotos en la galería.</span><span class="sxs-lookup"><span data-stu-id="008cd-350">You should now see the home page displaying the photos in the gallery.</span></span>
    ...
    <span data-ttu-id="008cd-351">![La Galería fotográfica](whats-new-in-aspnet-mvc-4/_static/image21.png "la Galería fotográfica")</span><span class="sxs-lookup"><span data-stu-id="008cd-351">![Photo Gallery](whats-new-in-aspnet-mvc-4/_static/image21.png "Photo Gallery")</span></span>
...
6. <span data-ttu-id="008cd-417">Corrija la posición del título fotográfica para que aparezca en el lado derecho de la imagen.</span><span class="sxs-lookup"><span data-stu-id="008cd-417">Fix the positioning of the photo title to make it show at the right side of the image.</span></span> <span data-ttu-id="008cd-418">Para ello, agregue el código siguiente a la **Site.Mobile.css** archivo.</span><span class="sxs-lookup"><span data-stu-id="008cd-418">To do this, add the following code to the **Site.Mobile.css** file.</span></span>

    <span data-ttu-id="008cd-419">CSS</span><span class="sxs-lookup"><span data-stu-id="008cd-419">CSS</span></span>

    [!code-css[Main](whats-new-in-aspnet-mvc-4/samples/sample12.css)]
7. <span data-ttu-id="008cd-420">Presione **CTRL + S** para guardar los cambios.</span><span class="sxs-lookup"><span data-stu-id="008cd-420">Press **CTRL + S** to save the changes.</span></span>
8. <span data-ttu-id="008cd-421">Vuelva a la **emulador de Windows Phone** y actualizar el sitio.</span><span class="sxs-lookup"><span data-stu-id="008cd-421">Switch back to the **Windows Phone Emulator** and refresh the site.</span></span> <span data-ttu-id="008cd-422">Tenga en cuenta que el título de la fotografía está colocado correctamente ahora.</span><span class="sxs-lookup"><span data-stu-id="008cd-422">Notice the photo title is properly positioned now.</span></span>

    <span data-ttu-id="008cd-423">![Título que se coloca en el lado derecho de la imagen](whats-new-in-aspnet-mvc-4/_static/image26.png "título situado en el lado derecho de la imagen")</span><span class="sxs-lookup"><span data-stu-id="008cd-423">![Title positioned on the right side of the image](whats-new-in-aspnet-mvc-4/_static/image26.png "Title positioned on the right side of the image")</span></span>

    <span data-ttu-id="008cd-424">*Título que se coloca en el lado derecho de la imagen*</span><span class="sxs-lookup"><span data-stu-id="008cd-424">*Title positioned on the right side of the image*</span></span>

<a id="Task_3_-_jQuery_Mobile_Themes"></a>
#### <a name="task-3---jquery-mobile-themes"></a><span data-ttu-id="008cd-425">Tarea 3: temas de jQuery Mobile</span><span class="sxs-lookup"><span data-stu-id="008cd-425">Task 3 - jQuery Mobile Themes</span></span>

<span data-ttu-id="008cd-426">Cada diseño y el widget de jQuery Mobile está diseñado alrededor de un nuevo marco CSS orientada a objetos que permite aplicar un tema de completar el diseño visual unificado a sitios y aplicaciones.</span><span class="sxs-lookup"><span data-stu-id="008cd-426">Every layout and widget in jQuery Mobile is designed around a new object-oriented CSS framework that makes it possible to apply a complete unified visual design theme to sites and applications.</span></span>

<span data-ttu-id="008cd-427">predeterminado de jQuery Mobile tema incluye 5 muestras que se asignan letras (a, b, c y d, e) para una referencia rápida.</span><span class="sxs-lookup"><span data-stu-id="008cd-427">jQuery Mobile's default Theme includes 5 swatches that are given letters (a, b, c, d, e) for quick reference.</span></span>

<span data-ttu-id="008cd-428">En esta tarea, actualizará el diseño móvil para que utilice un tema diferente que el valor predeterminado.</span><span class="sxs-lookup"><span data-stu-id="008cd-428">In this task, you will update the mobile layout to use a different theme than the default.</span></span>

1. <span data-ttu-id="008cd-429">Cambie a Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="008cd-429">Switch back to Visual Studio.</span></span>
2. <span data-ttu-id="008cd-430">Abra la  **\_Layout.Mobile.cshtml** archivo se encuentra en **Views\Shared**.</span><span class="sxs-lookup"><span data-stu-id="008cd-430">Open the **\_Layout.Mobile.cshtml** file located in **Views\Shared**.</span></span>
3. <span data-ttu-id="008cd-431">Busque el elemento div con el rol de datos establecido en &quot;página&quot; y actualizar la **datos tema** a &quot; **e**&quot;.</span><span class="sxs-lookup"><span data-stu-id="008cd-431">Find the div element with the data-role set to &quot;page&quot; and update the **data-theme** to &quot;**e**&quot;.</span></span>


    [!code-html[Main](whats-new-in-aspnet-mvc-4/samples/sample13.html)]
4. <span data-ttu-id="008cd-432">Presione **CTRL + S** para guardar los cambios.</span><span class="sxs-lookup"><span data-stu-id="008cd-432">Press **CTRL + S** to save the changes.</span></span>
5. <span data-ttu-id="008cd-433">Actualizar el sitio en el **emulador de Windows Phone** y observe la nueva combinación de colores.</span><span class="sxs-lookup"><span data-stu-id="008cd-433">Refresh the site in the **Windows Phone Emulator** and notice the new colors scheme.</span></span>

    <span data-ttu-id="008cd-434">![Diseño móvil con una combinación de colores diferentes](whats-new-in-aspnet-mvc-4/_static/image27.png "diseño móvil con una combinación de colores diferentes")</span><span class="sxs-lookup"><span data-stu-id="008cd-434">![Mobile layout with a different color scheme](whats-new-in-aspnet-mvc-4/_static/image27.png "Mobile layout with a different color scheme")</span></span>

    <span data-ttu-id="008cd-435">*Diseño móvil con una combinación de colores diferentes*</span><span class="sxs-lookup"><span data-stu-id="008cd-435">*Mobile layout with a different color scheme*</span></span>

<a id="Task_4_-_Using_the_View-Switcher_Component_and_the_Browser_Overriding_Features"></a>
#### <a name="task-4---using-the-view-switcher-component-and-the-browser-overriding-features"></a><span data-ttu-id="008cd-436">Tarea 4: mediante el componente de modificador de vista y el explorador reemplazar características</span><span class="sxs-lookup"><span data-stu-id="008cd-436">Task 4 - Using the View-Switcher Component and the Browser Overriding Features</span></span>

<span data-ttu-id="008cd-437">Es una convención para las páginas de web móvil optimizada agregar un vínculo cuyo texto está algo como vista de escritorio o en modo de sitio completo que permite a los usuarios cambiar a una versión de escritorio de la página.</span><span class="sxs-lookup"><span data-stu-id="008cd-437">A convention for mobile-optimized web pages is to add a link whose text is something like Desktop view or Full site mode that lets users switch to a desktop version of the page.</span></span> <span data-ttu-id="008cd-438">El paquete jQuery.Mobile.MVC incluye un ejemplo de **modificador de vista** componente para este propósito que se utiliza en el  **\_Layout.Mobile.cshtml** vista.</span><span class="sxs-lookup"><span data-stu-id="008cd-438">The jQuery.Mobile.MVC package includes a sample **view-switcher** component for this purpose used in the **\_Layout.Mobile.cshtml** view.</span></span>

<span data-ttu-id="008cd-439">![Vínculo para cambiar a vista de escritorio](whats-new-in-aspnet-mvc-4/_static/image28.png "vínculo para cambiar a vista de escritorio")</span><span class="sxs-lookup"><span data-stu-id="008cd-439">![Link to switch to Desktop View](whats-new-in-aspnet-mvc-4/_static/image28.png "Link to switch to Desktop View")</span></span>

<span data-ttu-id="008cd-440">*Use el vínculo para cambiar a la vista de escritorio*</span><span class="sxs-lookup"><span data-stu-id="008cd-440">*Link to switch to Desktop View*</span></span>

<span data-ttu-id="008cd-441">El modificador de vista utiliza una nueva característica denominada **explorador reemplazar**.</span><span class="sxs-lookup"><span data-stu-id="008cd-441">The view switcher uses a new feature called **Browser Overriding**.</span></span> <span data-ttu-id="008cd-442">Esta característica permite que la aplicación trate las solicitudes como si procediesen de un explorador distinto (agente de usuario) a la que realmente proceden del.</span><span class="sxs-lookup"><span data-stu-id="008cd-442">This feature lets your application treat requests as if they were coming from a different browser (user agent) than the one they are actually coming from.</span></span>

<span data-ttu-id="008cd-443">En esta tarea, explorará la implementación del ejemplo de un modificador de vista agregada por jQuery.Mobile.MVC y el nuevo explorador reemplazar las características de ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="008cd-443">In this task, you will explore the sample implementation of a view-switcher added by jQuery.Mobile.MVC and the new browser overriding features in ASP.NET MVC 4.</span></span>

1. <span data-ttu-id="008cd-444">Cambie a Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="008cd-444">Switch back to Visual Studio.</span></span>
2. <span data-ttu-id="008cd-445">Abra la  **\_Layout.Mobile.cshtml** vista se encuentra en la **Views\Shared** carpeta y observe el componente de modificador de vista que se hace referencia como una vista parcial.</span><span class="sxs-lookup"><span data-stu-id="008cd-445">Open the **\_Layout.Mobile.cshtml** view located under the **Views\Shared** folder and notice the view-switcher component being referenced as a partial view.</span></span>

    <span data-ttu-id="008cd-446">![Diseño móvil mediante el componente de modificador de vista](whats-new-in-aspnet-mvc-4/_static/image29.png "diseño móvil mediante el componente de modificador de vista")</span><span class="sxs-lookup"><span data-stu-id="008cd-446">![Mobile layout using View-Switcher component](whats-new-in-aspnet-mvc-4/_static/image29.png "Mobile layout using View-Switcher component")</span></span>

    <span data-ttu-id="008cd-447">*Diseño móvil mediante el componente de modificador de vista*</span><span class="sxs-lookup"><span data-stu-id="008cd-447">*Mobile layout using View-Switcher component*</span></span>
3. <span data-ttu-id="008cd-448">Abra la  **\_ViewSwitcher.cshtml** vista parcial.</span><span class="sxs-lookup"><span data-stu-id="008cd-448">Open the **\_ViewSwitcher.cshtml** partial view.</span></span>

    <span data-ttu-id="008cd-449">La vista parcial utiliza el nuevo método **ViewContext.HttpContext.GetOverriddenBrowser()** para determinar el origen de la solicitud web y mostrar el vínculo correspondiente para pasar a las vistas de escritorio o móvil.</span><span class="sxs-lookup"><span data-stu-id="008cd-449">The partial view uses the new method **ViewContext.HttpContext.GetOverriddenBrowser()** to determine the origin of the web request and show the corresponding link to switch either to the Desktop or Mobile views.</span></span>

    <span data-ttu-id="008cd-450">El **GetOverridenBrowser** método devuelve un **HttpBrowserCapabilitiesBase** instancia que se corresponde con el agente de usuario establecido actualmente para la solicitud (real o reemplazada).</span><span class="sxs-lookup"><span data-stu-id="008cd-450">The **GetOverridenBrowser** method returns an **HttpBrowserCapabilitiesBase** instance that corresponds to the user agent currently set for the request (actual or overridden).</span></span> <span data-ttu-id="008cd-451">Puede usar este valor para obtener propiedades como **IsMobileDevice**.</span><span class="sxs-lookup"><span data-stu-id="008cd-451">You can use this value to get properties such as **IsMobileDevice**.</span></span>

    <span data-ttu-id="008cd-452">![Vista parcial ViewSwitcher](whats-new-in-aspnet-mvc-4/_static/image30.png "ViewSwitcher de vista parcial")</span><span class="sxs-lookup"><span data-stu-id="008cd-452">![ViewSwitcher partial view](whats-new-in-aspnet-mvc-4/_static/image30.png "ViewSwitcher partial view")</span></span>

    <span data-ttu-id="008cd-453">*Vista parcial ViewSwitcher*</span><span class="sxs-lookup"><span data-stu-id="008cd-453">*ViewSwitcher partial view*</span></span>
4. <span data-ttu-id="008cd-454">Abra la **ViewSwitcherController.cs** clase ubicado en el **controladores** carpeta.</span><span class="sxs-lookup"><span data-stu-id="008cd-454">Open the **ViewSwitcherController.cs** class located in the **Controllers** folder.</span></span> <span data-ttu-id="008cd-455">Desprotección esa acción SwitchView es llamado por el vínculo en el componente ViewSwitcher y observe los nuevos métodos de HttpContext.</span><span class="sxs-lookup"><span data-stu-id="008cd-455">Check out that SwitchView action is called by the link in the ViewSwitcher component, and notice the new HttpContext methods.</span></span>

    - <span data-ttu-id="008cd-456">El **HttpContext.ClearOverridenBrowser()** método quita cualquier agente de usuario invalidado para la solicitud actual.</span><span class="sxs-lookup"><span data-stu-id="008cd-456">The **HttpContext.ClearOverridenBrowser()** method removes any overridden user agent for the current request.</span></span>
    - <span data-ttu-id="008cd-457">El **HttpContext.SetOverridenBrowser()** método invalida el valor de agente de usuario real de la solicitud mediante el agente de usuario especificado.</span><span class="sxs-lookup"><span data-stu-id="008cd-457">The **HttpContext.SetOverridenBrowser()** method overrides the request's actual user agent value using the specified user agent.</span></span>  
        <span data-ttu-id="008cd-458">![Controlador de ViewSwitcher](whats-new-in-aspnet-mvc-4/_static/image31.png "ViewSwitcher controlador")</span><span class="sxs-lookup"><span data-stu-id="008cd-458">![ViewSwitcher Controller](whats-new-in-aspnet-mvc-4/_static/image31.png "ViewSwitcher Controller")</span></span>  
<span data-ttu-id="008cd-459">*Controlador ViewSwitcher*</span><span class="sxs-lookup"><span data-stu-id="008cd-459">*ViewSwitcher Controller*</span></span>

        <span data-ttu-id="008cd-460">Reemplazando explorador es una característica fundamental de ASP.NET MVC 4, que también está disponible incluso si no instala el paquete jQuery.Mobile.MVC.</span><span class="sxs-lookup"><span data-stu-id="008cd-460">Browser Overriding is a core feature of ASP.NET MVC 4, which is also available even if you do not install the jQuery.Mobile.MVC package.</span></span> <span data-ttu-id="008cd-461">Sin embargo, esta característica puede afectar a solo vista, diseño y vista parcial y no afecta a ninguna de las características que dependen del objeto Request.Browser.</span><span class="sxs-lookup"><span data-stu-id="008cd-461">However, this feature affects only view, layout, and partial-view, and it does not affect any of the features that depend on the Request.Browser object.</span></span>

<a id="Task_5_-_Adding_the_View-Switcher_in_the_Desktop_View"></a>
#### <a name="task-5---adding-the-view-switcher-in-the-desktop-view"></a><span data-ttu-id="008cd-462">Tarea 5: agregar al modificador de vista en la vista de escritorio</span><span class="sxs-lookup"><span data-stu-id="008cd-462">Task 5 - Adding the View-Switcher in the Desktop View</span></span>

<span data-ttu-id="008cd-463">En esta tarea, actualizará el diseño del escritorio para que incluya al modificador de vista.</span><span class="sxs-lookup"><span data-stu-id="008cd-463">In this task, you will update the desktop layout to include the view-switcher.</span></span> <span data-ttu-id="008cd-464">Esto permitirá a los usuarios móviles volver a la vista móvil al examinar la vista de escritorio.</span><span class="sxs-lookup"><span data-stu-id="008cd-464">This will allow mobile users to go back to the mobile view when browsing the desktop view.</span></span>

1. <span data-ttu-id="008cd-465">Actualizar el sitio en el **emulador de Windows Phone**.</span><span class="sxs-lookup"><span data-stu-id="008cd-465">Refresh the site in the **Windows Phone Emulator**.</span></span>
2. <span data-ttu-id="008cd-466">Haga clic en el **vista de escritorio** vínculo en la parte superior de la galería.</span><span class="sxs-lookup"><span data-stu-id="008cd-466">Click on the **Desktop view** link at the top of the gallery.</span></span> <span data-ttu-id="008cd-467">Tenga en cuenta que no hay ningún modificador de vista en la vista de escritorio para permitir que volver a la vista móvil.</span><span class="sxs-lookup"><span data-stu-id="008cd-467">Notice there is no view-switcher in the desktop view to allow you return to the mobile view.</span></span>
3. <span data-ttu-id="008cd-468">Vuelva a Visual Studio y abra el  **\_Layout.cshtml** vista.</span><span class="sxs-lookup"><span data-stu-id="008cd-468">Go back to Visual Studio and open the **\_Layout.cshtml** view.</span></span>
4. <span data-ttu-id="008cd-469">Busque la sección de inicio de sesión e inserte una llamada para representar la  **\_ViewSwitcher** vista parcial siguiente la  **\_LogOnPartial** vista parcial.</span><span class="sxs-lookup"><span data-stu-id="008cd-469">Find the login section and insert a call to render the **\_ViewSwitcher** partial view below the **\_LogOnPartial** partial view.</span></span> <span data-ttu-id="008cd-470">A continuación, presione **CTRL + S** para guardar los cambios.</span><span class="sxs-lookup"><span data-stu-id="008cd-470">Then, press **CTRL + S** to save the changes.</span></span>


    [!code-cshtml[Main](whats-new-in-aspnet-mvc-4/samples/sample14.cshtml)]
5. <span data-ttu-id="008cd-471">Presione **CTRL + S** para guardar los cambios.</span><span class="sxs-lookup"><span data-stu-id="008cd-471">Press **CTRL + S** to save the changes.</span></span>
6. <span data-ttu-id="008cd-472">Actualice la página en el emulador de Windows Phone y haga doble clic en la pantalla para acercar.</span><span class="sxs-lookup"><span data-stu-id="008cd-472">Refresh the page in the Windows Phone Emulator and double-click the screen to zoom in.</span></span> <span data-ttu-id="008cd-473">Observe que ahora se muestra en la página principal de la **vista móvil** vínculo que se activa desde dispositivos móviles en vista de escritorio.</span><span class="sxs-lookup"><span data-stu-id="008cd-473">Notice that the home page now shows the **Mobile view** link that switches from mobile to desktop view.</span></span>

    <span data-ttu-id="008cd-474">![Ver modificador que se representan en la vista de escritorio](whats-new-in-aspnet-mvc-4/_static/image32.png "cambiador de vistas que se representan en la vista de escritorio")</span><span class="sxs-lookup"><span data-stu-id="008cd-474">![View Switcher rendered in desktop view](whats-new-in-aspnet-mvc-4/_static/image32.png "View Switcher rendered in desktop view")</span></span>

    <span data-ttu-id="008cd-475">*Modificador de vista que se representan en la vista de escritorio*</span><span class="sxs-lookup"><span data-stu-id="008cd-475">*View Switcher rendered in desktop view*</span></span>
7. <span data-ttu-id="008cd-476">Cambie a la vista móvil nuevo y vaya a **sobre** página (http://localhost[puerto]/principal/acercade).</span><span class="sxs-lookup"><span data-stu-id="008cd-476">Switch to the Mobile view again and browse to **About** page (http://localhost[port]/Home/About).</span></span> <span data-ttu-id="008cd-477">Tenga en cuenta que, incluso si no ha creado una vista About.Mobile.cshtml, acerca de se muestra la página con el diseño móvil (\_Layout.Mobile.cshtml).</span><span class="sxs-lookup"><span data-stu-id="008cd-477">Notice that, even if you haven't created an About.Mobile.cshtml view, the About page is displayed using the mobile layout (\_Layout.Mobile.cshtml).</span></span>

    <span data-ttu-id="008cd-478">![Acerca de la página](whats-new-in-aspnet-mvc-4/_static/image33.png "acerca de la página")</span><span class="sxs-lookup"><span data-stu-id="008cd-478">![About page](whats-new-in-aspnet-mvc-4/_static/image33.png "About page")</span></span>

    <span data-ttu-id="008cd-479">*Acerca de la página*</span><span class="sxs-lookup"><span data-stu-id="008cd-479">*About page*</span></span>
8. <span data-ttu-id="008cd-480">Por último, abra el sitio en un explorador Web de escritorio.</span><span class="sxs-lookup"><span data-stu-id="008cd-480">Finally, open the site in a desktop Web browser.</span></span> <span data-ttu-id="008cd-481">Tenga en cuenta que ninguna de las actualizaciones anteriores ha afectado a la vista de escritorio.</span><span class="sxs-lookup"><span data-stu-id="008cd-481">Notice that none of the previous updates has affected the desktop view.</span></span>

    <span data-ttu-id="008cd-482">![Vista de escritorio de la Galería fotográfica](whats-new-in-aspnet-mvc-4/_static/image34.png "vista de escritorio de la Galería fotográfica")</span><span class="sxs-lookup"><span data-stu-id="008cd-482">![PhotoGallery desktop view](whats-new-in-aspnet-mvc-4/_static/image34.png "PhotoGallery desktop view")</span></span>

    <span data-ttu-id="008cd-483">*Vista de escritorio de la Galería fotográfica*</span><span class="sxs-lookup"><span data-stu-id="008cd-483">*PhotoGallery desktop view*</span></span>

<a id="Task_6_-_Creating_New_Display_Modes"></a>
#### <a name="task-6---creating-new-display-modes"></a><span data-ttu-id="008cd-484">Tarea 6: crear nuevos modos de presentación</span><span class="sxs-lookup"><span data-stu-id="008cd-484">Task 6 - Creating New Display Modes</span></span>

<span data-ttu-id="008cd-485">La nueva característica de modos de presentación permite que una aplicación seleccionar vistas dependiendo del explorador que se va a generar la solicitud.</span><span class="sxs-lookup"><span data-stu-id="008cd-485">The new display modes feature lets an application select views depending on the browser that is generating the request.</span></span> <span data-ttu-id="008cd-486">Por ejemplo, si un explorador de escritorio, solicita la página de inicio, la aplicación devolverá la **Views\Home\Index.cshtml** plantilla.</span><span class="sxs-lookup"><span data-stu-id="008cd-486">For example, if a desktop browser requests the Home page, the application will return the **Views\Home\Index.cshtml** template.</span></span> <span data-ttu-id="008cd-487">A continuación, si un explorador móvil solicita la página de inicio, la aplicación devolverá la **Views\Home\Index.mobile.cshtml** plantilla.</span><span class="sxs-lookup"><span data-stu-id="008cd-487">Then, if a mobile browser requests the Home page, the application will return the **Views\Home\Index.mobile.cshtml** template.</span></span>

<span data-ttu-id="008cd-488">En esta tarea, creará un diseño personalizado para los dispositivos iPhone y tendrá que simular las solicitudes de dispositivos iPhone.</span><span class="sxs-lookup"><span data-stu-id="008cd-488">In this task, you will create a customized layout for iPhone devices, and you will have to simulate requests from iPhone devices.</span></span> <span data-ttu-id="008cd-489">Para ello, puede usar cualquier un iPhone emulador o simulador (como [Electric simulador Mobile](http://www.electricplum.com/)) o un explorador con los complementos que modifican el agente de usuario.</span><span class="sxs-lookup"><span data-stu-id="008cd-489">To do this, you can use either an iPhone emulator/simulator (like [Electric Mobile Simulator](http://www.electricplum.com/)) or a browser with add-ons that modify the user agent.</span></span> <span data-ttu-id="008cd-490">Para que obtener instrucciones sobre cómo establecer la cadena de agente de usuario en un explorador Safari emular un iPhone, consulte [cómo permiten Safari Finjan es IE](http://www.davidalison.com/2008/05/how-to-let-safari-pretend-its-ie.html) en el blog de David Alison.</span><span class="sxs-lookup"><span data-stu-id="008cd-490">For instructions on how to set the user agent string in an Safari browser to emulate an iPhone, see [How to let Safari pretend it's IE](http://www.davidalison.com/2008/05/how-to-let-safari-pretend-its-ie.html) in David Alison's blog.</span></span>

<span data-ttu-id="008cd-491">**Tenga en cuenta que esta tarea es opcional y puede continuar a lo largo del laboratorio sin ejecutarla.**</span><span class="sxs-lookup"><span data-stu-id="008cd-491">**Notice that this task is optional and you can continue throughout the lab without executing it.**</span></span>

1. <span data-ttu-id="008cd-492">En Visual Studio, presione **MAYÚS** + **F5** para detener la depuración de la aplicación.</span><span class="sxs-lookup"><span data-stu-id="008cd-492">In Visual Studio, press **SHIFT** + **F5** to stop debugging the application.</span></span>
2. <span data-ttu-id="008cd-493">Abra **Global.asax.cs** y agregue la siguiente instrucción using.</span><span class="sxs-lookup"><span data-stu-id="008cd-493">Open **Global.asax.cs** and add the following using statement.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample15.cs)]
3. <span data-ttu-id="008cd-494">Agregue el código que aparece resaltado en la aplicación\_Start (método).</span><span class="sxs-lookup"><span data-stu-id="008cd-494">Add the following highlighted code into the Application\_Start method.</span></span>

    <span data-ttu-id="008cd-495">(Código de fragmento de código: *iPhone DisplayMode de ASP.NET MVC 4 laboratorio - Ex03 -*)</span><span class="sxs-lookup"><span data-stu-id="008cd-495">(Code Snippet - *ASP.NET MVC 4 Lab - Ex03 - iPhone DisplayMode*)</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample16.cs)]

    <span data-ttu-id="008cd-496">Se ha registrado un nuevo **DefaultDisplayMode denominado &quot;iPhone&quot;**, en el método estático **DisplayModeProvider.Instance.Modes** lista estática, que se comparará con cada solicitud entrante.</span><span class="sxs-lookup"><span data-stu-id="008cd-496">You have registered a new **DefaultDisplayMode named &quot;iPhone&quot;**, within the static **DisplayModeProvider.Instance.Modes** static list, that will be matched against each incoming request.</span></span> <span data-ttu-id="008cd-497">Si la solicitud entrante contiene la cadena &quot;iPhone&quot;, ASP.NET MVC se detectarán las vistas cuyo nombre contenga la &quot;iPhone&quot; sufijo.</span><span class="sxs-lookup"><span data-stu-id="008cd-497">If the incoming request contains the string &quot;iPhone&quot;, ASP.NET MVC will find the views whose name contain the &quot;iPhone&quot; suffix.</span></span> <span data-ttu-id="008cd-498">El parámetro 0 indica cómo específico es el nuevo modo; Por ejemplo, esta vista es más específica que la ficha general &quot;.mobile&quot; regla que coincide con las solicitudes de dispositivos móviles.</span><span class="sxs-lookup"><span data-stu-id="008cd-498">The 0 parameter indicates how specific is the new mode; for instance, this view is more specific than the general &quot;.mobile&quot; rule that matches requests from mobile devices.</span></span>

    <span data-ttu-id="008cd-499">Después de ejecuta este código, cuando un explorador de iPhone genera una solicitud, la aplicación utilizará la **Views\Shared\\_Layout.iPhone.cshtml** diseño que se va a crear en los pasos siguientes.</span><span class="sxs-lookup"><span data-stu-id="008cd-499">After this code runs, when an iPhone browser generates a request, your application will use the **Views\Shared\\_Layout.iPhone.cshtml** layout you will create in the next steps.</span></span>

    > [!NOTE]
    > <span data-ttu-id="008cd-500">Esta manera de probar la solicitud para iPhone se ha simplificado para fines de demostración y podría no funcionar según lo previsto para cada cadena de agente de usuario de iPhone (para la prueba de ejemplo distingue mayúsculas de minúsculas).</span><span class="sxs-lookup"><span data-stu-id="008cd-500">This way of testing the request for iPhone has been simplified for demo purposes and might not work as expected for every iPhone user agent string (for example test is case sensitive).</span></span>
4. <span data-ttu-id="008cd-501">Crear una copia de la  **\_Layout.Mobile.cshtml** un archivo en el **Views\Shared** carpeta y cambiar el nombre de la copia a &quot;  **\_Layout.iPhone.csthml** &quot;.</span><span class="sxs-lookup"><span data-stu-id="008cd-501">Create a copy of the **\_Layout.Mobile.cshtml** file in the **Views\Shared** folder and rename the copy to &quot;**\_Layout.iPhone.csthml**&quot;.</span></span>
5. <span data-ttu-id="008cd-502">Abra  **\_Layout.iPhone.csthml** que creó en el paso anterior.</span><span class="sxs-lookup"><span data-stu-id="008cd-502">Open **\_Layout.iPhone.csthml** you created in the previous step.</span></span>
6. <span data-ttu-id="008cd-503">Busque el elemento div con el atributo de rol de datos establecido en **página** y cambie el **datos tema** atribuir a &quot; **una**&quot;.</span><span class="sxs-lookup"><span data-stu-id="008cd-503">Find the div element with the data-role attribute set to **page** and change the **data-theme** attribute to &quot;**a**&quot;.</span></span>


    [!code-cshtml[Main](whats-new-in-aspnet-mvc-4/samples/sample17.cshtml)]

    <span data-ttu-id="008cd-504">Ahora tiene 3 diseños en la aplicación de ASP.NET MVC 4:</span><span class="sxs-lookup"><span data-stu-id="008cd-504">Now you have 3 layouts in your ASP.NET MVC 4 application:</span></span>

    1. <span data-ttu-id="008cd-505">**\_Layout.cshtml**: diseño predeterminado utilizado para los exploradores de escritorio.</span><span class="sxs-lookup"><span data-stu-id="008cd-505">**\_Layout.cshtml**: default layout used for desktop browsers.</span></span>
    2. <span data-ttu-id="008cd-506">**\_Layout.Mobile.cshtml**: diseño predeterminado utilizado para dispositivos móviles.</span><span class="sxs-lookup"><span data-stu-id="008cd-506">**\_Layout.mobile.cshtml**: default layout used for mobile devices.</span></span>
    3. <span data-ttu-id="008cd-507">**\_Layout.iPhone.cshtml**: diseño específico de dispositivos de iPhone, mediante una combinación de colores diferentes para diferenciar de \_Layout.mobile.cshtml.</span><span class="sxs-lookup"><span data-stu-id="008cd-507">**\_Layout.iPhone.cshtml**: specific layout for iPhone devices, using a different color scheme to differentiate from \_Layout.mobile.cshtml.</span></span>
7. <span data-ttu-id="008cd-508">Presione **F5** para ejecutar la aplicación y explora el sitio en el **emulador de Windows Phone**.</span><span class="sxs-lookup"><span data-stu-id="008cd-508">Press **F5** to run the application and browse the site in the **Windows Phone Emulator**.</span></span>
8. <span data-ttu-id="008cd-509">Abrir un **iPhone simulador** (consulte [Apéndice C](#AppendixC) para obtener instrucciones sobre cómo instalar y configurar un emulador de iPhone) y busque el sitio demasiado.</span><span class="sxs-lookup"><span data-stu-id="008cd-509">Open an **iPhone simulator** (see [Appendix C](#AppendixC) for instructions on how to install and configure an iPhone simulator), and browse to the site too.</span></span> <span data-ttu-id="008cd-510">Tenga en cuenta que cada teléfono está usando la plantilla específica.</span><span class="sxs-lookup"><span data-stu-id="008cd-510">Notice that each phone is using the specific template.</span></span>

    ![Using-Different-Views-for-Each-Mobile-device2](whats-new-in-aspnet-mvc-4/_static/image35.png)

    <span data-ttu-id="008cd-512">*Usar vistas diferentes para cada dispositivo móvil*</span><span class="sxs-lookup"><span data-stu-id="008cd-512">*Using different views for each mobile device*</span></span>

<a id="Exercise4"></a>

<a id="Exercise_4_Using_Asynchronous_Controllers"></a>
### <a name="exercise-4-using-asynchronous-controllers"></a><span data-ttu-id="008cd-513">Ejercicio 4: Usar controladores asincrónicos</span><span class="sxs-lookup"><span data-stu-id="008cd-513">Exercise 4: Using Asynchronous Controllers</span></span>

<span data-ttu-id="008cd-514">Microsoft .NET Framework 4.5 presenta nuevas características del lenguaje en C# y Visual Basic para proporcionar una nueva base de asincronía en programación de. NET.</span><span class="sxs-lookup"><span data-stu-id="008cd-514">Microsoft .NET Framework 4.5 introduces new language features in C# and Visual Basic to provide a new foundation for asynchrony in .NET programming.</span></span> <span data-ttu-id="008cd-515">Esta nueva base hace que la programación asincrónica similar a - y unos tan sencillo como - programación sincrónica.</span><span class="sxs-lookup"><span data-stu-id="008cd-515">This new foundation makes asynchronous programming similar to - and about as straightforward as - synchronous programming.</span></span> <span data-ttu-id="008cd-516">Ahora es posible escribir métodos de acción asincrónicos en ASP.NET MVC 4 mediante la **AsyncController** clase.</span><span class="sxs-lookup"><span data-stu-id="008cd-516">You are now able to write asynchronous action methods in ASP.NET MVC 4 by using the **AsyncController** class.</span></span> <span data-ttu-id="008cd-517">Puede utilizar métodos de acción asincrónicos de ejecución prolongada, no con la CPU solicitudes.</span><span class="sxs-lookup"><span data-stu-id="008cd-517">You can use asynchronous action methods for long-running, non-CPU bound requests.</span></span> <span data-ttu-id="008cd-518">Esto evita que el servidor Web realizar trabajo mientras se procesa la solicitud de bloqueo.</span><span class="sxs-lookup"><span data-stu-id="008cd-518">This avoids blocking the Web server from performing work while the request is being processed.</span></span> <span data-ttu-id="008cd-519">La clase AsyncController normalmente se usa para llamadas de servicio Web de ejecución prolongada.</span><span class="sxs-lookup"><span data-stu-id="008cd-519">The AsyncController class is typically used for long-running Web service calls.</span></span>

<span data-ttu-id="008cd-520">Este ejercicio explica los conceptos básicos de la operación asincrónica en ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="008cd-520">This exercise explains the basics of asynchronous operation in ASP.NET MVC 4.</span></span> <span data-ttu-id="008cd-521">Si desea un análisis más profundo, puede consultar el siguiente artículo: [ [https://msdn.microsoft.com/en-us/library/ee728598%28v=vs.100%29.aspx](https://msdn.microsoft.com/en-us/library/ee728598%28v=vs.100%29.aspx)](https://msdn.microsoft.com/en-us/library/ee728598%28v=vs.100%29.aspx)</span><span class="sxs-lookup"><span data-stu-id="008cd-521">If you want a deeper dive, you can check out the following article: [[https://msdn.microsoft.com/en-us/library/ee728598%28v=vs.100%29.aspx](https://msdn.microsoft.com/en-us/library/ee728598%28v=vs.100%29.aspx)](https://msdn.microsoft.com/en-us/library/ee728598%28v=vs.100%29.aspx)</span></span>

<a id="Task_1_-_Implementing_an_Asynchronous_Controller"></a>
#### <a name="task-1---implementing-an-asynchronous-controller"></a><span data-ttu-id="008cd-522">Tarea 1: implementar un controlador asincrónico</span><span class="sxs-lookup"><span data-stu-id="008cd-522">Task 1 - Implementing an Asynchronous Controller</span></span>

1. <span data-ttu-id="008cd-523">Abra la **comenzar** solución ubicado en **origen/Ex4-Async/Begin/** carpeta.</span><span class="sxs-lookup"><span data-stu-id="008cd-523">Open the **Begin** solution located at **Source/Ex4-Async/Begin/** folder.</span></span> <span data-ttu-id="008cd-524">En caso contrario, puede seguir usando el **final** solución obtenido siguiendo el ejercicio anterior.</span><span class="sxs-lookup"><span data-stu-id="008cd-524">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

    1. <span data-ttu-id="008cd-525">Si abrió proporcionado **comenzar** solución, deberá descargar algunos paquetes de NuGet que faltan antes de continuar.</span><span class="sxs-lookup"><span data-stu-id="008cd-525">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="008cd-526">Para ello, haga clic en el **proyecto** menú y seleccione **administrar paquetes de NuGet**.</span><span class="sxs-lookup"><span data-stu-id="008cd-526">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
    2. <span data-ttu-id="008cd-527">En el **administrar paquetes de NuGet** cuadro de diálogo, haga clic en **restaurar** para descargar los paquetes que falten.</span><span class="sxs-lookup"><span data-stu-id="008cd-527">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
    3. <span data-ttu-id="008cd-528">Por último, compile la solución haciendo clic en **generar** | **generar solución**.</span><span class="sxs-lookup"><span data-stu-id="008cd-528">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="008cd-529">Una de las ventajas del uso de NuGet es que no tiene que enviar todas las bibliotecas en el proyecto, lo que reduce el tamaño del proyecto.</span><span class="sxs-lookup"><span data-stu-id="008cd-529">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="008cd-530">Con NuGet Power Tools, mediante la especificación de las versiones del paquete en el archivo Packages.config, podrá descargar la primera vez que ejecute el proyecto de todas las bibliotecas necesarias.</span><span class="sxs-lookup"><span data-stu-id="008cd-530">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="008cd-531">Este es el motivo por el que se deben ejecutar estos pasos después de abrir una solución existente de este laboratorio.</span><span class="sxs-lookup"><span data-stu-id="008cd-531">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="008cd-532">Abra la **HomeController.cs** clase desde el **controladores** carpeta.</span><span class="sxs-lookup"><span data-stu-id="008cd-532">Open the **HomeController.cs** class from the **Controllers** folder.</span></span>
3. <span data-ttu-id="008cd-533">Agregue la siguiente instrucción using.</span><span class="sxs-lookup"><span data-stu-id="008cd-533">Add the following using statement.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample18.cs)]
4. <span data-ttu-id="008cd-534">Actualización de la **HomeController** clase herede de **AsyncController**.</span><span class="sxs-lookup"><span data-stu-id="008cd-534">Update the **HomeController** class to inherit from **AsyncController**.</span></span> <span data-ttu-id="008cd-535">Controladores que se derivan de AsyncController permiten a ASP.NET procesar solicitudes asincrónicas y pueden métodos de acción sincrónicos de servicio.</span><span class="sxs-lookup"><span data-stu-id="008cd-535">Controllers that derive from AsyncController enable ASP.NET to process asynchronous requests, and they can still service synchronous action methods.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample19.cs)]
5. <span data-ttu-id="008cd-536">Agregar el **async** palabra clave para la **índice** método y hacer que el tipo de valor devuelto **tarea&lt;ActionResult&gt;**.</span><span class="sxs-lookup"><span data-stu-id="008cd-536">Add the **async** keyword to the **Index** method and make it return the type **Task&lt;ActionResult&gt;**.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample20.cs)]

    > [!NOTE]
    > <span data-ttu-id="008cd-537">El **async** palabra clave es una de las nuevas palabras clave proporciona .NET Framework 4.5; indica al compilador que este método contiene código asincrónico.</span><span class="sxs-lookup"><span data-stu-id="008cd-537">The **async** keyword is one of the new keywords the .NET Framework 4.5 provides; it tells the compiler that this method contains asynchronous code.</span></span> <span data-ttu-id="008cd-538">A **tarea** objeto representa una operación asincrónica que puede completar en algún momento en el futuro.</span><span class="sxs-lookup"><span data-stu-id="008cd-538">A **Task** object represents an asynchronous operation that may complete at some point in the future.</span></span>
6. <span data-ttu-id="008cd-539">Reemplace el **cliente. GetAsync()** llamada con la versión de async completa mediante palabra clave await, tal y como se muestra a continuación.</span><span class="sxs-lookup"><span data-stu-id="008cd-539">Replace the **client.GetAsync()** call with the full async version using await keyword as shown below.</span></span>

    <span data-ttu-id="008cd-540">(Código de fragmento de código: *GetAsync de ASP.NET MVC 4 laboratorio - Ex04 -*)</span><span class="sxs-lookup"><span data-stu-id="008cd-540">(Code Snippet - *ASP.NET MVC 4 Lab - Ex04 - GetAsync*)</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample21.cs)]

    > [!NOTE]
    > <span data-ttu-id="008cd-541">En la versión anterior, usaba la **resultado** propiedad desde el **tarea** objeto para bloquear el subproceso hasta que el resultado se devuelve (versión de sincronización).</span><span class="sxs-lookup"><span data-stu-id="008cd-541">In the previous version, you were using the **Result** property from the **Task** object to block the thread until the result is returned (sync version).</span></span>
    > 
    > <span data-ttu-id="008cd-542">Agregar el **await** palabra clave indica al compilador que esperar para la tarea devuelta desde la llamada al método de forma asincrónica.</span><span class="sxs-lookup"><span data-stu-id="008cd-542">Adding the **await** keyword tells the compiler to asynchronously wait for the task returned from the method call.</span></span> <span data-ttu-id="008cd-543">Esto significa que el resto del código se ejecutará como una devolución de llamada únicamente cuando haya finalizado el método esperado.</span><span class="sxs-lookup"><span data-stu-id="008cd-543">This means that the rest of the code will be executed as a callback only after the awaited method completes.</span></span> <span data-ttu-id="008cd-544">Otra cosa que debe tener en cuenta es que no es necesario cambiar el bloque try-catch para solucionar este problema: todavía se detectarán las excepciones que se producen en segundo plano o en primer plano sin ningún trabajo adicional con un controlador proporcionado por el marco de trabajo.</span><span class="sxs-lookup"><span data-stu-id="008cd-544">Another thing to notice is that you do not need to change your try-catch block in order to make this work: the exceptions that happen in background or in foreground will still be caught without any extra work using a handler provided by the framework.</span></span>
7. <span data-ttu-id="008cd-545">Cambiar el código para continuar con la implementación asincrónica reemplazando las líneas con el nuevo código, tal y como se muestra a continuación</span><span class="sxs-lookup"><span data-stu-id="008cd-545">Change the code to continue with the asynchronous implementation by replacing the lines with the new code as shown below</span></span>

    <span data-ttu-id="008cd-546">(Código de fragmento de código: *ReadAsStringAsync de ASP.NET MVC 4 laboratorio - Ex04 -*)</span><span class="sxs-lookup"><span data-stu-id="008cd-546">(Code Snippet - *ASP.NET MVC 4 Lab - Ex04 - ReadAsStringAsync*)</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample22.cs)]
8. <span data-ttu-id="008cd-547">Ejecute la aplicación.</span><span class="sxs-lookup"><span data-stu-id="008cd-547">Run the application.</span></span> <span data-ttu-id="008cd-548">Observará que no hay cambios importantes, pero el código, no se bloqueará un subproceso del grupo de subprocesos que hace un mejor uso de los recursos del servidor y se mejora el rendimiento.</span><span class="sxs-lookup"><span data-stu-id="008cd-548">You will notice no major changes, but your code will not block a thread from the thread pool making a better usage of the server resources and improving performance.</span></span>

    > [!NOTE]
    > <span data-ttu-id="008cd-549">Puede aprender más sobre las nuevas características de programación asincrónicas en el laboratorio &quot; **programación asincrónica en .NET 4.5 con C# y Visual Basic** &quot; incluidos en el Kit de aprendizaje Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="008cd-549">You can learn more about the new asynchronous programming features in the lab &quot;**Asynchronous Programming in .NET 4.5 with C# and Visual Basic**&quot; included in the Visual Studio Training Kit.</span></span>

<a id="Task_2_-_Handling_Time-Outs_with_Cancellation_Tokens"></a>
#### <a name="task-2---handling-time-outs-with-cancellation-tokens"></a><span data-ttu-id="008cd-550">Tarea 2: los tiempos de espera de control con Tokens de cancelación</span><span class="sxs-lookup"><span data-stu-id="008cd-550">Task 2 - Handling Time-Outs with Cancellation Tokens</span></span>

<span data-ttu-id="008cd-551">Métodos de acción asincrónicos que devuelven instancias de la tarea también admiten los tiempos de espera.</span><span class="sxs-lookup"><span data-stu-id="008cd-551">Asynchronous action methods that return Task instances can also support time-outs.</span></span> <span data-ttu-id="008cd-552">En esta tarea, actualizará el código del método de índice para controlar una situación de tiempo de espera con un token de cancelación.</span><span class="sxs-lookup"><span data-stu-id="008cd-552">In this task, you will update the Index method code to handle a time-out scenario using a cancellation token.</span></span>

1. <span data-ttu-id="008cd-553">Vuelva a Visual Studio y presione **MAYÚS + F5** para detener la depuración.</span><span class="sxs-lookup"><span data-stu-id="008cd-553">Go back to Visual Studio and press **SHIFT + F5** to stop debugging.</span></span>
2. <span data-ttu-id="008cd-554">Agregue la siguiente instrucción using en la **HomeController.cs** archivo.</span><span class="sxs-lookup"><span data-stu-id="008cd-554">Add the following using statement to the **HomeController.cs** file.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample23.cs)]
3. <span data-ttu-id="008cd-555">Actualizar la acción del índice para recibir un **CancellationToken** argumento.</span><span class="sxs-lookup"><span data-stu-id="008cd-555">Update the Index action to receive a **CancellationToken** argument.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample24.cs)]
4. <span data-ttu-id="008cd-556">Actualización de la **GetAsync** llamada para pasar el token de cancelación.</span><span class="sxs-lookup"><span data-stu-id="008cd-556">Update the **GetAsync** call to pass the cancellation token.</span></span>

    <span data-ttu-id="008cd-557">(Código de fragmento de código: *ASP.NET MVC 4 laboratorio - Ex04 - SendAsync con CancellationToken*)</span><span class="sxs-lookup"><span data-stu-id="008cd-557">(Code Snippet - *ASP.NET MVC 4 Lab - Ex04 - SendAsync with CancellationToken*)</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample25.cs)]
5. <span data-ttu-id="008cd-558">Decorar la *índice* método con un **AsyncTimeout** atributo establecido en 500 milisegundos y un **HandleError** configurado para controlar el atributo  **TaskCanceledException** redirigiendo a un **TimedOut** vista.</span><span class="sxs-lookup"><span data-stu-id="008cd-558">Decorate the *Index* method with an **AsyncTimeout** attribute set to 500 milliseconds and a **HandleError** attribute configured to handle **TaskCanceledException** by redirecting to a **TimedOut** view.</span></span>

    <span data-ttu-id="008cd-559">(Código de fragmento de código: *atributos de ASP.NET MVC 4 laboratorio - Ex04 -*)</span><span class="sxs-lookup"><span data-stu-id="008cd-559">(Code Snippet - *ASP.NET MVC 4 Lab - Ex04 - Attributes*)</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample26.cs)]
6. <span data-ttu-id="008cd-560">Abra el **PhotoController** clase y actualizar el **galería** método retrasar los milisegundos de ejecución 1000 (1 segundo) para simular una tarea de ejecución prolongada.</span><span class="sxs-lookup"><span data-stu-id="008cd-560">Open the **PhotoController** class and update the **Gallery** method to delay the execution 1000 miliseconds (1 second) to simulate a long running task.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-mvc-4/samples/sample27.cs)]
7. <span data-ttu-id="008cd-561">Abra la **Web.config** de archivos y habilitar errores personalizados agregando el siguiente elemento.</span><span class="sxs-lookup"><span data-stu-id="008cd-561">Open the **Web.config** file and enable custom errors by adding the following element.</span></span>


    [!code-xml[Main](whats-new-in-aspnet-mvc-4/samples/sample28.xml)]
8. <span data-ttu-id="008cd-562">Crear una nueva vista en **Views\Shared** denominado **TimedOut** y usar el diseño predeterminado.</span><span class="sxs-lookup"><span data-stu-id="008cd-562">Create a new view in **Views\Shared** named **TimedOut** and use the default layout.</span></span> <span data-ttu-id="008cd-563">En el Explorador de soluciones, haga clic en el **Views\Shared** carpeta y seleccione **agregar | Vista**.</span><span class="sxs-lookup"><span data-stu-id="008cd-563">In the Solution Explorer, right-click the **Views\Shared** folder and select **Add | View**.</span></span>

    <span data-ttu-id="008cd-564">![Usar vistas diferentes para cada dispositivo móvil](whats-new-in-aspnet-mvc-4/_static/image36.png "con vistas diferentes para cada dispositivo móvil")</span><span class="sxs-lookup"><span data-stu-id="008cd-564">![Using different views for each mobile device](whats-new-in-aspnet-mvc-4/_static/image36.png "Using different views for each mobile device")</span></span>

    <span data-ttu-id="008cd-565">*Usar vistas diferentes para cada dispositivo móvil*</span><span class="sxs-lookup"><span data-stu-id="008cd-565">*Using different views for each mobile device*</span></span>
9. <span data-ttu-id="008cd-566">Actualización de la **TimedOut** ver el contenido tal y como se muestra a continuación.</span><span class="sxs-lookup"><span data-stu-id="008cd-566">Update the **TimedOut** view content as shown below.</span></span>


    [!code-cshtml[Main](whats-new-in-aspnet-mvc-4/samples/sample29.cshtml)]
10. <span data-ttu-id="008cd-567">Ejecute la aplicación y vaya a la dirección URL raíz.</span><span class="sxs-lookup"><span data-stu-id="008cd-567">Run the application and navigate to the root URL.</span></span> <span data-ttu-id="008cd-568">Tal y como se ha agregado un **Thread.Sleep** de 1000 milisegundos, obtendrá un error de tiempo de espera, generado por el **AsyncTimeout** de atributo y captura el **HandleError** atributo.</span><span class="sxs-lookup"><span data-stu-id="008cd-568">As you have added a **Thread.Sleep** of 1000 milliseconds, you will get a time-out error, generated by the **AsyncTimeout** attribute and catch by the **HandleError** attribute.</span></span>

    <span data-ttu-id="008cd-569">![Excepción de tiempo de espera controlan](whats-new-in-aspnet-mvc-4/_static/image37.png "excepción de tiempo de espera controlan")</span><span class="sxs-lookup"><span data-stu-id="008cd-569">![Time-out exception handled](whats-new-in-aspnet-mvc-4/_static/image37.png "Time-out exception handled")</span></span>

    <span data-ttu-id="008cd-570">*Excepción de tiempo de espera controlan*</span><span class="sxs-lookup"><span data-stu-id="008cd-570">*Time-out exception handled*</span></span>

> [!NOTE]
> <span data-ttu-id="008cd-571">Además, puede implementar esta aplicación a los siguientes sitios Web Windows Azure [apéndice D: publicar una aplicación de ASP.NET MVC 4 mediante Web Deploy](#AppendixD).</span><span class="sxs-lookup"><span data-stu-id="008cd-571">Additionally, you can deploy this application to Windows Azure Web Sites following [Appendix D: Publishing an ASP.NET MVC 4 Application using Web Deploy](#AppendixD).</span></span>


<a id="Summary"></a>

<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="008cd-572">Resumen</span><span class="sxs-lookup"><span data-stu-id="008cd-572">Summary</span></span>

<span data-ttu-id="008cd-573">En este laboratorio de prácticas, se han observado que algunas de las nuevas características residente en ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="008cd-573">In this hands-on-lab, you've observed some of the new features resident in ASP.NET MVC 4.</span></span> <span data-ttu-id="008cd-574">Se han tratado los conceptos siguientes:</span><span class="sxs-lookup"><span data-stu-id="008cd-574">The following concepts have been discussed:</span></span>

- <span data-ttu-id="008cd-575">Aprovechar las ventajas de las mejoras en las plantillas de proyecto incluidas ASP.NET MVC la nueva plantilla de proyecto de aplicación para dispositivos móviles</span><span class="sxs-lookup"><span data-stu-id="008cd-575">Take advantage of the enhancements to the ASP.NET MVC project templates-including the new mobile application project template</span></span>
- <span data-ttu-id="008cd-576">Utilice el atributo de la ventanilla de HTML5 y las consultas de medios CSS para mejorar la presentación en dispositivos móviles</span><span class="sxs-lookup"><span data-stu-id="008cd-576">Use the HTML5 viewport attribute and CSS media queries to improve the display on mobile devices</span></span>
- <span data-ttu-id="008cd-577">Usar jQuery Mobile para mejorar el progresiva y para la creación de la interfaz de usuario web táctiles optimizadas</span><span class="sxs-lookup"><span data-stu-id="008cd-577">Use jQuery Mobile for progressive enhancements and for building touch-optimized web UI</span></span>
- <span data-ttu-id="008cd-578">Crear vistas específicas de mobile</span><span class="sxs-lookup"><span data-stu-id="008cd-578">Create mobile-specific views</span></span>
- <span data-ttu-id="008cd-579">Utilice el componente de modificador de vista para alternar entre las vistas de escritorio y móviles en la aplicación</span><span class="sxs-lookup"><span data-stu-id="008cd-579">Use the view-switcher component to toggle between mobile and desktop views in the application</span></span>
- <span data-ttu-id="008cd-580">Crear controladores asincrónicos utilizando el soporte de tarea</span><span class="sxs-lookup"><span data-stu-id="008cd-580">Create asynchronous controllers using task support</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Using_Code_Snippets"></a>
## <a name="appendix-a-using-code-snippets"></a><span data-ttu-id="008cd-581">Apéndice A: usar fragmentos de código</span><span class="sxs-lookup"><span data-stu-id="008cd-581">Appendix A: Using Code Snippets</span></span>

<span data-ttu-id="008cd-582">Con fragmentos de código, tiene todo el código que necesita a su alcance.</span><span class="sxs-lookup"><span data-stu-id="008cd-582">With code snippets, you have all the code you need at your fingertips.</span></span> <span data-ttu-id="008cd-583">El documento de laboratorio le indicará exactamente cuándo utilizarlas, tal como se muestra en la ilustración siguiente.</span><span class="sxs-lookup"><span data-stu-id="008cd-583">The lab document will tell you exactly when you can use them, as shown in the following figure.</span></span>

<span data-ttu-id="008cd-584">![Uso de fragmentos de código de Visual Studio para insertar código en el proyecto](whats-new-in-aspnet-mvc-4/_static/image38.png "fragmentos de código en Visual Studio para insertar código en el proyecto")</span><span class="sxs-lookup"><span data-stu-id="008cd-584">![Using Visual Studio code snippets to insert code into your project](whats-new-in-aspnet-mvc-4/_static/image38.png "Using Visual Studio code snippets to insert code into your project")</span></span>

<span data-ttu-id="008cd-585">*Uso de fragmentos de código de Visual Studio para insertar código en el proyecto*</span><span class="sxs-lookup"><span data-stu-id="008cd-585">*Using Visual Studio code snippets to insert code into your project*</span></span>

<span data-ttu-id="008cd-586">***Para agregar un fragmento de código mediante el teclado (solo C#)***</span><span class="sxs-lookup"><span data-stu-id="008cd-586">***To add a code snippet using the keyboard (C# only)***</span></span>

1. <span data-ttu-id="008cd-587">Coloque el cursor donde desea insertar el código.</span><span class="sxs-lookup"><span data-stu-id="008cd-587">Place the cursor where you would like to insert the code.</span></span>
2. <span data-ttu-id="008cd-588">Comience a escribir el nombre del fragmento (sin espacios ni guiones).</span><span class="sxs-lookup"><span data-stu-id="008cd-588">Start typing the snippet name (without spaces or hyphens).</span></span>
3. <span data-ttu-id="008cd-589">Observe como coincidencia de nombres de fragmentos de código de muestra de IntelliSense.</span><span class="sxs-lookup"><span data-stu-id="008cd-589">Watch as IntelliSense displays matching snippets' names.</span></span>
4. <span data-ttu-id="008cd-590">Seleccione el fragmento de código correcto (o siga escribiendo hasta que se selecciona el nombre del fragmento de código completo).</span><span class="sxs-lookup"><span data-stu-id="008cd-590">Select the correct snippet (or keep typing until the entire snippet's name is selected).</span></span>
5. <span data-ttu-id="008cd-591">Presione la tecla Tab dos veces para insertar el fragmento de código en la ubicación del cursor.</span><span class="sxs-lookup"><span data-stu-id="008cd-591">Press the Tab key twice to insert the snippet at the cursor location.</span></span>

<span data-ttu-id="008cd-592">![Comience a escribir el nombre del fragmento](whats-new-in-aspnet-mvc-4/_static/image39.png "comience a escribir el nombre del fragmento de código")</span><span class="sxs-lookup"><span data-stu-id="008cd-592">![Start typing the snippet name](whats-new-in-aspnet-mvc-4/_static/image39.png "Start typing the snippet name")</span></span>

<span data-ttu-id="008cd-593">*Comience a escribir el nombre del fragmento de código*</span><span class="sxs-lookup"><span data-stu-id="008cd-593">*Start typing the snippet name*</span></span>

<span data-ttu-id="008cd-594">![Presione la tecla Tab para seleccionar el fragmento de código resaltada](whats-new-in-aspnet-mvc-4/_static/image40.png "presione Tab para seleccionar el fragmento de código resaltada")</span><span class="sxs-lookup"><span data-stu-id="008cd-594">![Press Tab to select the highlighted snippet](whats-new-in-aspnet-mvc-4/_static/image40.png "Press Tab to select the highlighted snippet")</span></span>

<span data-ttu-id="008cd-595">*Presione la tecla Tab para seleccionar el fragmento de código resaltada*</span><span class="sxs-lookup"><span data-stu-id="008cd-595">*Press Tab to select the highlighted snippet*</span></span>

<span data-ttu-id="008cd-596">![Vuelva a presionar Tab y el fragmento de código se expandirán](whats-new-in-aspnet-mvc-4/_static/image41.png "vuelva a presionar Tab y el fragmento de código se expandirán")</span><span class="sxs-lookup"><span data-stu-id="008cd-596">![Press Tab again and the snippet will expand](whats-new-in-aspnet-mvc-4/_static/image41.png "Press Tab again and the snippet will expand")</span></span>

<span data-ttu-id="008cd-597">*Vuelva a presionar Tab y el fragmento de código se expandirán*</span><span class="sxs-lookup"><span data-stu-id="008cd-597">*Press Tab again and the snippet will expand*</span></span>

<span data-ttu-id="008cd-598">***Para agregar un fragmento de código con el mouse (C#, en Visual Basic y XML)***</span><span class="sxs-lookup"><span data-stu-id="008cd-598">***To add a code snippet using the mouse (C#, Visual Basic and XML)***</span></span>

1. <span data-ttu-id="008cd-599">Haga clic en donde desea insertar el fragmento de código.</span><span class="sxs-lookup"><span data-stu-id="008cd-599">Right-click where you want to insert the code snippet.</span></span>
2. <span data-ttu-id="008cd-600">Seleccione **Insertar fragmento de código** seguido **Mis fragmentos de código**.</span><span class="sxs-lookup"><span data-stu-id="008cd-600">Select **Insert Snippet** followed by **My Code Snippets**.</span></span>
3. <span data-ttu-id="008cd-601">Seleccione el fragmento de código relevante de la lista haciendo clic en él.</span><span class="sxs-lookup"><span data-stu-id="008cd-601">Pick the relevant snippet from the list, by clicking on it.</span></span>

<span data-ttu-id="008cd-602">![Menú contextual donde desea insertar el fragmento de código y seleccione Insertar fragmento de código](whats-new-in-aspnet-mvc-4/_static/image42.png "contextual donde desea insertar el fragmento de código y seleccione Insertar fragmento de código")</span><span class="sxs-lookup"><span data-stu-id="008cd-602">![Right-click where you want to insert the code snippet and select Insert Snippet](whats-new-in-aspnet-mvc-4/_static/image42.png "Right-click where you want to insert the code snippet and select Insert Snippet")</span></span>

<span data-ttu-id="008cd-603">*Haga clic en donde desea insertar el fragmento de código y seleccione Insertar fragmento de código*</span><span class="sxs-lookup"><span data-stu-id="008cd-603">*Right-click where you want to insert the code snippet and select Insert Snippet*</span></span>

<span data-ttu-id="008cd-604">![Seleccione el fragmento de código relevante de la lista haciendo clic en él](whats-new-in-aspnet-mvc-4/_static/image43.png "elegir el fragmento de código relevante de la lista haciendo clic en él")</span><span class="sxs-lookup"><span data-stu-id="008cd-604">![Pick the relevant snippet from the list, by clicking on it](whats-new-in-aspnet-mvc-4/_static/image43.png "Pick the relevant snippet from the list, by clicking on it")</span></span>

<span data-ttu-id="008cd-605">*Seleccione el fragmento de código relevante de la lista haciendo clic en él*</span><span class="sxs-lookup"><span data-stu-id="008cd-605">*Pick the relevant snippet from the list, by clicking on it*</span></span>

<a id="AppendixB"></a>

<a id="Appendix_B_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-b-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="008cd-606">Apéndice B: instalación de Visual Studio Express 2012 para Web</span><span class="sxs-lookup"><span data-stu-id="008cd-606">Appendix B: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="008cd-607">Puede instalar **Microsoft Visual Studio Express 2012 para Web** u otro &quot;Express&quot; versión usando la  **[instalador de plataforma Web de Microsoft](https://www.microsoft.com/web/downloads/platform.aspx)** .</span><span class="sxs-lookup"><span data-stu-id="008cd-607">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="008cd-608">Las instrucciones siguientes le guían a través de los pasos necesarios para instalar *Visual studio Express 2012 para Web* con *instalador de plataforma Web de Microsoft*.</span><span class="sxs-lookup"><span data-stu-id="008cd-608">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="008cd-609">Vaya a [ [https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="008cd-609">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="008cd-610">O bien, si ya ha instalado el instalador de plataforma Web, puede abrirla y busque el producto &quot; *Visual Studio Express 2012 for Web con SDK de Windows Azure*&quot;.</span><span class="sxs-lookup"><span data-stu-id="008cd-610">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;*Visual Studio Express 2012 for Web with Windows Azure SDK*&quot;.</span></span>
2. <span data-ttu-id="008cd-611">Haga clic en **instalar ahora**.</span><span class="sxs-lookup"><span data-stu-id="008cd-611">Click on **Install Now**.</span></span> <span data-ttu-id="008cd-612">Si no tiene **instalador de plataforma Web** se le redirigirá para descargarlo e instalarlo primero.</span><span class="sxs-lookup"><span data-stu-id="008cd-612">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="008cd-613">Una vez **instalador de plataforma Web** está abierto, haga clic en **instalar** para iniciar el programa de instalación.</span><span class="sxs-lookup"><span data-stu-id="008cd-613">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="008cd-614">![Instale Visual Studio Express](whats-new-in-aspnet-mvc-4/_static/image44.png "instale Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="008cd-614">![Install Visual Studio Express](whats-new-in-aspnet-mvc-4/_static/image44.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="008cd-615">*Instale Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="008cd-615">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="008cd-616">Lea los términos y licencias de todos los productos y haga clic en **acepto** para continuar.</span><span class="sxs-lookup"><span data-stu-id="008cd-616">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![Acepte los términos de licencia](whats-new-in-aspnet-mvc-4/_static/image45.png)

    <span data-ttu-id="008cd-618">*Acepte los términos de licencia*</span><span class="sxs-lookup"><span data-stu-id="008cd-618">*Accepting the license terms*</span></span>
5. <span data-ttu-id="008cd-619">Espere hasta que finalice el proceso de descarga e instalación.</span><span class="sxs-lookup"><span data-stu-id="008cd-619">Wait until the downloading and installation process completes.</span></span>

    ![Progreso de la instalación](whats-new-in-aspnet-mvc-4/_static/image46.png)

    <span data-ttu-id="008cd-621">*Progreso de la instalación*</span><span class="sxs-lookup"><span data-stu-id="008cd-621">*Installation progress*</span></span>
6. <span data-ttu-id="008cd-622">Cuando se complete la instalación, haga clic en **finalizar**.</span><span class="sxs-lookup"><span data-stu-id="008cd-622">When the installation completes, click **Finish**.</span></span>

    ![Se completó la instalación](whats-new-in-aspnet-mvc-4/_static/image47.png)

    <span data-ttu-id="008cd-624">*Se completó la instalación*</span><span class="sxs-lookup"><span data-stu-id="008cd-624">*Installation completed*</span></span>
7. <span data-ttu-id="008cd-625">Haga clic en **Exit** para cerrar el instalador de plataforma Web.</span><span class="sxs-lookup"><span data-stu-id="008cd-625">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="008cd-626">Para abrir Visual Studio Express para Web, vaya a la **iniciar** pantalla y comienza a escribir &quot; **Express frente a**&quot;, a continuación, haga clic en el **VS Express para Web** colocar en mosaico.</span><span class="sxs-lookup"><span data-stu-id="008cd-626">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![Express de VS para icono Web](whats-new-in-aspnet-mvc-4/_static/image48.png)

    <span data-ttu-id="008cd-628">*Express de VS para icono Web*</span><span class="sxs-lookup"><span data-stu-id="008cd-628">*VS Express for Web tile*</span></span>

<a id="AppendixC"></a>

<a id="Appendix_C_Installing_WebMatrix_2_and_iPhone_Simulator"></a>
## <a name="appendix-c-installing-webmatrix-2-and-iphone-simulator"></a><span data-ttu-id="008cd-629">Apéndice C: instalar WebMatrix 2 y iPhone simulador</span><span class="sxs-lookup"><span data-stu-id="008cd-629">Appendix C: Installing WebMatrix 2 and iPhone Simulator</span></span>

<span data-ttu-id="008cd-630">Para ejecutar el sitio en un dispositivo simulado iPhone puede utilizar la extensión de WebMatrix &quot;Electric simulador Mobile para iPhone&quot;.</span><span class="sxs-lookup"><span data-stu-id="008cd-630">To run your site in a simulated iPhone device you can use the WebMatrix extension &quot;Electric Mobile Simulator for the iPhone&quot;.</span></span> <span data-ttu-id="008cd-631">Además, puede configurar la misma extensión para ejecutar el simulador de Visual Studio 2012.</span><span class="sxs-lookup"><span data-stu-id="008cd-631">Also, you can configure the same extension to run the simulator from Visual Studio 2012.</span></span>

<a id="ApxCTask1"></a>

<a id="Task_1_-_Installing_WebMatrix_2"></a>
#### <a name="task-1---installing-webmatrix-2"></a><span data-ttu-id="008cd-632">Tarea 1: instalar WebMatrix 2</span><span class="sxs-lookup"><span data-stu-id="008cd-632">Task 1 - Installing WebMatrix 2</span></span>

1. <span data-ttu-id="008cd-633">Vaya a [ [https://go.microsoft.com/?linkid=9809776](https://go.microsoft.com/?linkid=9809776)](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="008cd-633">Go to [[https://go.microsoft.com/?linkid=9809776](https://go.microsoft.com/?linkid=9809776)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="008cd-634">O bien, si ya ha instalado el instalador de plataforma Web, puede abrirla y busque el producto &quot; *WebMatrix 2*&quot;.</span><span class="sxs-lookup"><span data-stu-id="008cd-634">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;*WebMatrix 2*&quot;.</span></span>
2. <span data-ttu-id="008cd-635">Haga clic en **instalar ahora**.</span><span class="sxs-lookup"><span data-stu-id="008cd-635">Click on **Install Now**.</span></span> <span data-ttu-id="008cd-636">Si no tiene **instalador de plataforma Web** se le redirigirá para descargarlo e instalarlo primero.</span><span class="sxs-lookup"><span data-stu-id="008cd-636">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="008cd-637">Una vez **instalador de plataforma Web** está abierto, haga clic en **instalar** para iniciar el programa de instalación.</span><span class="sxs-lookup"><span data-stu-id="008cd-637">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="008cd-638">![Instalar WebMatrix 2](whats-new-in-aspnet-mvc-4/_static/image49.png "instalar WebMatrix 2")</span><span class="sxs-lookup"><span data-stu-id="008cd-638">![Install WebMatrix 2](whats-new-in-aspnet-mvc-4/_static/image49.png "Install WebMatrix 2")</span></span>

    <span data-ttu-id="008cd-639">*Instalar WebMatrix 2*</span><span class="sxs-lookup"><span data-stu-id="008cd-639">*Install WebMatrix 2*</span></span>
4. <span data-ttu-id="008cd-640">Lea los términos y licencias de todos los productos y haga clic en **acepto** para continuar.</span><span class="sxs-lookup"><span data-stu-id="008cd-640">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    <span data-ttu-id="008cd-641">![Acepte los términos de licencia](whats-new-in-aspnet-mvc-4/_static/image50.png "aceptando los términos de licencia")</span><span class="sxs-lookup"><span data-stu-id="008cd-641">![Accepting the license terms](whats-new-in-aspnet-mvc-4/_static/image50.png "Accepting the license terms")</span></span>

    <span data-ttu-id="008cd-642">*Acepte los términos de licencia*</span><span class="sxs-lookup"><span data-stu-id="008cd-642">*Accepting the license terms*</span></span>
5. <span data-ttu-id="008cd-643">Espere hasta que finalice el proceso de descarga e instalación.</span><span class="sxs-lookup"><span data-stu-id="008cd-643">Wait until the downloading and installation process completes.</span></span>

    <span data-ttu-id="008cd-644">![Progreso de la instalación](whats-new-in-aspnet-mvc-4/_static/image51.png "progreso de la instalación")</span><span class="sxs-lookup"><span data-stu-id="008cd-644">![Installation progress](whats-new-in-aspnet-mvc-4/_static/image51.png "Installation progress")</span></span>

    <span data-ttu-id="008cd-645">*Progreso de la instalación*</span><span class="sxs-lookup"><span data-stu-id="008cd-645">*Installation progress*</span></span>
6. <span data-ttu-id="008cd-646">Cuando se complete la instalación, haga clic en **finalizar**.</span><span class="sxs-lookup"><span data-stu-id="008cd-646">When the installation completes, click **Finish**.</span></span>

    <span data-ttu-id="008cd-647">![Se completó la instalación](whats-new-in-aspnet-mvc-4/_static/image52.png "se completó la instalación")</span><span class="sxs-lookup"><span data-stu-id="008cd-647">![Installation completed](whats-new-in-aspnet-mvc-4/_static/image52.png "Installation completed")</span></span>

    <span data-ttu-id="008cd-648">*Se completó la instalación*</span><span class="sxs-lookup"><span data-stu-id="008cd-648">*Installation completed*</span></span>
7. <span data-ttu-id="008cd-649">Haga clic en **Exit** para cerrar el instalador de plataforma Web.</span><span class="sxs-lookup"><span data-stu-id="008cd-649">Click **Exit** to close Web Platform Installer.</span></span>

<a id="ApxCTask2"></a>

<a id="Task_2_-_Installing_the_iPhone_Simulator_Extension"></a>
#### <a name="task-2---installing-the-iphone-simulator-extension"></a><span data-ttu-id="008cd-650">Tarea 2: instalar la extensión de simulador de iPhone</span><span class="sxs-lookup"><span data-stu-id="008cd-650">Task 2 - Installing the iPhone Simulator Extension</span></span>

1. <span data-ttu-id="008cd-651">Ejecutar **WebMatrix** y abrir cualquier sitio Web existente o cree uno nuevo.</span><span class="sxs-lookup"><span data-stu-id="008cd-651">Run **WebMatrix** and open any existing Web site or create a new one.</span></span>
2. <span data-ttu-id="008cd-652">Haga clic en el **ejecutar** botón desde la **inicio** la cinta de opciones y seleccione **agregar nueva**.</span><span class="sxs-lookup"><span data-stu-id="008cd-652">Click the **Run** button from the **Home** ribbon and select **Add new**.</span></span>

    <span data-ttu-id="008cd-653">![Agregar nueva extensión de WebMatrix](whats-new-in-aspnet-mvc-4/_static/image53.png "agregar nueva extensión de WebMatrix")</span><span class="sxs-lookup"><span data-stu-id="008cd-653">![Adding new WebMatrix extension](whats-new-in-aspnet-mvc-4/_static/image53.png "Adding new WebMatrix extension")</span></span>

    <span data-ttu-id="008cd-654">*Agregar nueva extensión de WebMatrix*</span><span class="sxs-lookup"><span data-stu-id="008cd-654">*Adding new WebMatrix extension*</span></span>
3. <span data-ttu-id="008cd-655">Seleccione **iPhone simulador** y haga clic en **instalar**.</span><span class="sxs-lookup"><span data-stu-id="008cd-655">Select **iPhone Simulator** and click **Install**.</span></span>

    <span data-ttu-id="008cd-656">![Examen de las extensiones de WebMatrix](whats-new-in-aspnet-mvc-4/_static/image54.png "extensiones de examen de WebMatrix")</span><span class="sxs-lookup"><span data-stu-id="008cd-656">![Browsing WebMatrix extensions](whats-new-in-aspnet-mvc-4/_static/image54.png "Browsing WebMatrix extensions")</span></span>

    <span data-ttu-id="008cd-657">*Exploración de las extensiones de WebMatrix*</span><span class="sxs-lookup"><span data-stu-id="008cd-657">*Browsing WebMatrix extensions*</span></span>
4. <span data-ttu-id="008cd-658">En los detalles del paquete, haga clic en **instalar** para continuar con la instalación de la extensión.</span><span class="sxs-lookup"><span data-stu-id="008cd-658">In the package details, click **Install** to continue with the extension installation.</span></span>

    <span data-ttu-id="008cd-659">![iPhone extensión simulador](whats-new-in-aspnet-mvc-4/_static/image55.png "iPhone extensión simulador")</span><span class="sxs-lookup"><span data-stu-id="008cd-659">![iPhone Simulator extension](whats-new-in-aspnet-mvc-4/_static/image55.png "iPhone Simulator extension")</span></span>

    <span data-ttu-id="008cd-660">*extensión de simulador de iPhone*</span><span class="sxs-lookup"><span data-stu-id="008cd-660">*iPhone Simulator extension*</span></span>
5. <span data-ttu-id="008cd-661">Lea y acepte la términos de licencia de extensión.</span><span class="sxs-lookup"><span data-stu-id="008cd-661">Read and accept the extension EULA.</span></span>

    <span data-ttu-id="008cd-662">![Extensión de WebMatrix CLUF](whats-new-in-aspnet-mvc-4/_static/image56.png "extensión de WebMatrix términos de licencia")</span><span class="sxs-lookup"><span data-stu-id="008cd-662">![WebMatrix extension EULA](whats-new-in-aspnet-mvc-4/_static/image56.png "WebMatrix extension EULA")</span></span>

    <span data-ttu-id="008cd-663">*Extensión de WebMatrix términos de licencia*</span><span class="sxs-lookup"><span data-stu-id="008cd-663">*WebMatrix extension EULA*</span></span>
6. <span data-ttu-id="008cd-664">Ahora, puede ejecutar el sitio Web desde WebMatrix mediante la opción de simulador de iPhone.</span><span class="sxs-lookup"><span data-stu-id="008cd-664">Now, you can run your Web site from WebMatrix using the iPhone Simulator option.</span></span>

    <span data-ttu-id="008cd-665">![Ejecutar con iPhone](whats-new-in-aspnet-mvc-4/_static/image57.png "ejecutar con iPhone")</span><span class="sxs-lookup"><span data-stu-id="008cd-665">![Run using iPhone](whats-new-in-aspnet-mvc-4/_static/image57.png "Run using iPhone")</span></span>

    <span data-ttu-id="008cd-666">*Ejecutar con iPhone*</span><span class="sxs-lookup"><span data-stu-id="008cd-666">*Run using iPhone*</span></span>

<a id="ApxCTask3"></a>

<a id="Task_3_-_Configuring_Visual_Studio_2012_to_run_iPhone_Simulator"></a>
#### <a name="task-3---configuring-visual-studio-2012-to-run-iphone-simulator"></a><span data-ttu-id="008cd-667">Tarea 3: configuración de Visual Studio 2012 para ejecutar el simulador de iPhone</span><span class="sxs-lookup"><span data-stu-id="008cd-667">Task 3 - Configuring Visual Studio 2012 to run iPhone Simulator</span></span>

1. <span data-ttu-id="008cd-668">Abra **Visual Studio 2012** y abrir cualquier sitio Web o crear un nuevo proyecto.</span><span class="sxs-lookup"><span data-stu-id="008cd-668">Open **Visual Studio 2012** and open any Web site or create a new project.</span></span>
2. <span data-ttu-id="008cd-669">Haga clic en la flecha hacia abajo en el botón de ejecución y seleccione **examinar con**.</span><span class="sxs-lookup"><span data-stu-id="008cd-669">Click the down arrow from the Run button and select **Browse with**.</span></span>

    <span data-ttu-id="008cd-670">![Examinar con](whats-new-in-aspnet-mvc-4/_static/image58.png "examinar con")</span><span class="sxs-lookup"><span data-stu-id="008cd-670">![Browse with](whats-new-in-aspnet-mvc-4/_static/image58.png "Browse with")</span></span>

    <span data-ttu-id="008cd-671">*Examinar con*</span><span class="sxs-lookup"><span data-stu-id="008cd-671">*Browse with*</span></span>
3. <span data-ttu-id="008cd-672">En el &quot;explorar con&quot; cuadro de diálogo, haga clic en **agregar**.</span><span class="sxs-lookup"><span data-stu-id="008cd-672">In the &quot;Browse With&quot; dialog, click **Add**.</span></span>
4. <span data-ttu-id="008cd-673">En el &quot;Agregar programa&quot; cuadro de diálogo, utilice los siguientes valores:</span><span class="sxs-lookup"><span data-stu-id="008cd-673">In the &quot;Add Program&quot; dialog, use the following values:</span></span>

    - <span data-ttu-id="008cd-674">**Programa**: C:\Users\*{CurrentUser}*\AppData\Local\Microsoft\WebMatrix\Extensions\20\iPhoneSimulator\ElectricMobileSim\ElectricMobileSim.exe *(actualización de la ruta de acceso según corresponda)*</span><span class="sxs-lookup"><span data-stu-id="008cd-674">**Program**: C:\Users\*{CurrentUser}*\AppData\Local\Microsoft\WebMatrix\Extensions\20\iPhoneSimulator\ElectricMobileSim\ElectricMobileSim.exe *(update the path accordingly)*</span></span>
    - <span data-ttu-id="008cd-675">**Argumentos**: &quot;1&quot;</span><span class="sxs-lookup"><span data-stu-id="008cd-675">**Arguments**: &quot;1&quot;</span></span>
    - <span data-ttu-id="008cd-676">**Nombre descriptivo**: iPhone simulador</span><span class="sxs-lookup"><span data-stu-id="008cd-676">**Friendly name**: iPhone Simulator</span></span>

    <span data-ttu-id="008cd-677">![Agregar programa](whats-new-in-aspnet-mvc-4/_static/image59.png "Agregar programa")</span><span class="sxs-lookup"><span data-stu-id="008cd-677">![Add program](whats-new-in-aspnet-mvc-4/_static/image59.png "Add program")</span></span>

    <span data-ttu-id="008cd-678">*Agregar programa para examinar con*</span><span class="sxs-lookup"><span data-stu-id="008cd-678">*Add program to browse with*</span></span>
5. <span data-ttu-id="008cd-679">Haga clic en **Aceptar** y cierre los cuadros de diálogo.</span><span class="sxs-lookup"><span data-stu-id="008cd-679">Click **OK** and close the dialogs.</span></span>
6. <span data-ttu-id="008cd-680">Ahora es posible ejecutar las aplicaciones Web en el simulador iPhone desde Visual Studio 2012.</span><span class="sxs-lookup"><span data-stu-id="008cd-680">Now you are able to run your Web applications in the iPhone simulator from Visual Studio 2012.</span></span>

    <span data-ttu-id="008cd-681">![Examinar con iPhone simulador](whats-new-in-aspnet-mvc-4/_static/image60.png "examinar con iPhone simulador")</span><span class="sxs-lookup"><span data-stu-id="008cd-681">![Browse with iPhone Simulator](whats-new-in-aspnet-mvc-4/_static/image60.png "Browse with iPhone Simulator")</span></span>

    <span data-ttu-id="008cd-682">*Examinar con iPhone simulador*</span><span class="sxs-lookup"><span data-stu-id="008cd-682">*Browse with iPhone Simulator*</span></span>

<a id="AppendixD"></a>

<a id="Appendix_D_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
## <a name="appendix-d-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="008cd-683">Apéndice D: publicar una aplicación de ASP.NET MVC 4 mediante Web Deploy</span><span class="sxs-lookup"><span data-stu-id="008cd-683">Appendix D: Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

<span data-ttu-id="008cd-684">Este apéndice le mostrará cómo crear un nuevo sitio web del Portal de administración de Windows Azure y publicar la aplicación que obtuvo siguiendo el laboratorio, aprovechando la característica de publicación Web Deploy proporcionada por Windows Azure.</span><span class="sxs-lookup"><span data-stu-id="008cd-684">This appendix will show you how to create a new web site from the Windows Azure Management Portal and publish the application you obtained by following the lab, taking advantage of the Web Deploy publishing feature provided by Windows Azure.</span></span>

<a id="ApxDTask1"></a>

<a id="Task_1_-_Creating_a_New_Web_Site_from_the_Windows_Azure_Portal"></a>
#### <a name="task-1---creating-a-new-web-site-from-the-windows-azure-portal"></a><span data-ttu-id="008cd-685">Tarea 1: crear un nuevo sitio Web desde las ventanas de Portal de Azure</span><span class="sxs-lookup"><span data-stu-id="008cd-685">Task 1 - Creating a New Web Site from the Windows Azure Portal</span></span>

1. <span data-ttu-id="008cd-686">Vaya a la [Portal de administración de Windows Azure](https://manage.windowsazure.com/) e inicie sesión con las credenciales de Microsoft asociadas con su suscripción.</span><span class="sxs-lookup"><span data-stu-id="008cd-686">Go to the [Windows Azure Management Portal](https://manage.windowsazure.com/) and sign in using the Microsoft credentials associated with your subscription.</span></span>

    > [!NOTE]
    > <span data-ttu-id="008cd-687">Con Windows Azure puede hospedar 10 sitios Web de ASP.NET de forma gratuita y, a continuación, ajustar la escala a medida que crece el tráfico.</span><span class="sxs-lookup"><span data-stu-id="008cd-687">With Windows Azure you can host 10 ASP.NET Web Sites for free and then scale as your traffic grows.</span></span> <span data-ttu-id="008cd-688">Puede registrarse [aquí](http://aka.ms/aspnet-hol-azure).</span><span class="sxs-lookup"><span data-stu-id="008cd-688">You can sign up [here](http://aka.ms/aspnet-hol-azure).</span></span>

    <span data-ttu-id="008cd-689">![Inicie sesión en el portal de Windows Azure](whats-new-in-aspnet-mvc-4/_static/image61.png "inicie sesión en el portal de Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="008cd-689">![Log on to Windows Azure portal](whats-new-in-aspnet-mvc-4/_static/image61.png "Log on to Windows Azure portal")</span></span>

    <span data-ttu-id="008cd-690">*Inicie sesión en el Portal de administración de Azure*</span><span class="sxs-lookup"><span data-stu-id="008cd-690">*Log on to Windows Azure Management Portal*</span></span>
2. <span data-ttu-id="008cd-691">Haga clic en **New** en la barra de comandos.</span><span class="sxs-lookup"><span data-stu-id="008cd-691">Click **New** on the command bar.</span></span>

    <span data-ttu-id="008cd-692">![Crear un nuevo sitio Web](whats-new-in-aspnet-mvc-4/_static/image62.png "crear un nuevo sitio Web")</span><span class="sxs-lookup"><span data-stu-id="008cd-692">![Creating a new Web Site](whats-new-in-aspnet-mvc-4/_static/image62.png "Creating a new Web Site")</span></span>

    <span data-ttu-id="008cd-693">*Crear un nuevo sitio Web*</span><span class="sxs-lookup"><span data-stu-id="008cd-693">*Creating a new Web Site*</span></span>
3. <span data-ttu-id="008cd-694">Haga clic en **proceso** | **sitio Web**.</span><span class="sxs-lookup"><span data-stu-id="008cd-694">Click **Compute** | **Web Site**.</span></span> <span data-ttu-id="008cd-695">A continuación, seleccione **creación rápida** opción.</span><span class="sxs-lookup"><span data-stu-id="008cd-695">Then select **Quick Create** option.</span></span> <span data-ttu-id="008cd-696">Proporcione una dirección de URL disponible para el nuevo sitio web y haga clic en **crear sitio Web**.</span><span class="sxs-lookup"><span data-stu-id="008cd-696">Provide an available URL for the new web site and click **Create Web Site**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="008cd-697">Un sitio Web de Windows Azure es el host para una aplicación web que se ejecutan en la nube que puede controlar y administrar.</span><span class="sxs-lookup"><span data-stu-id="008cd-697">A Windows Azure Web Site is the host for a web application running in the cloud that you can control and manage.</span></span> <span data-ttu-id="008cd-698">La opción Creación rápida permite implementar una aplicación web completada al Windows Azure sitio Web desde fuera del portal.</span><span class="sxs-lookup"><span data-stu-id="008cd-698">The Quick Create option allows you to deploy a completed web application to the Windows Azure Web Site from outside the portal.</span></span> <span data-ttu-id="008cd-699">No se incluyen pasos para configurar una base de datos.</span><span class="sxs-lookup"><span data-stu-id="008cd-699">It does not include steps for setting up a database.</span></span>

    <span data-ttu-id="008cd-700">![Crear un nuevo sitio Web mediante Creación rápida](whats-new-in-aspnet-mvc-4/_static/image63.png "crear un nuevo sitio Web mediante Creación rápida")</span><span class="sxs-lookup"><span data-stu-id="008cd-700">![Creating a new Web Site using Quick Create](whats-new-in-aspnet-mvc-4/_static/image63.png "Creating a new Web Site using Quick Create")</span></span>

    <span data-ttu-id="008cd-701">*Crear un nuevo sitio Web mediante Creación rápida*</span><span class="sxs-lookup"><span data-stu-id="008cd-701">*Creating a new Web Site using Quick Create*</span></span>
4. <span data-ttu-id="008cd-702">Espere hasta que el nuevo **sitio Web** se crea.</span><span class="sxs-lookup"><span data-stu-id="008cd-702">Wait until the new **Web Site** is created.</span></span>
5. <span data-ttu-id="008cd-703">Una vez creado el sitio Web, haga clic en el vínculo situado bajo el **URL** columna.</span><span class="sxs-lookup"><span data-stu-id="008cd-703">Once the Web Site is created click the link under the **URL** column.</span></span> <span data-ttu-id="008cd-704">Compruebe que funciona el nuevo sitio Web.</span><span class="sxs-lookup"><span data-stu-id="008cd-704">Check that the new Web Site is working.</span></span>

    <span data-ttu-id="008cd-705">![En el nuevo sitio web](whats-new-in-aspnet-mvc-4/_static/image64.png "exploración al sitio web nuevo")</span><span class="sxs-lookup"><span data-stu-id="008cd-705">![Browsing to the new web site](whats-new-in-aspnet-mvc-4/_static/image64.png "Browsing to the new web site")</span></span>

    <span data-ttu-id="008cd-706">*Examinar el sitio web nuevo*</span><span class="sxs-lookup"><span data-stu-id="008cd-706">*Browsing to the new web site*</span></span>

    <span data-ttu-id="008cd-707">![Sitio Web que ejecute](whats-new-in-aspnet-mvc-4/_static/image65.png "sitio Web que se ejecuta")</span><span class="sxs-lookup"><span data-stu-id="008cd-707">![Web site running](whats-new-in-aspnet-mvc-4/_static/image65.png "Web site running")</span></span>

    <span data-ttu-id="008cd-708">*Sitio Web que se ejecuta*</span><span class="sxs-lookup"><span data-stu-id="008cd-708">*Web site running*</span></span>
6. <span data-ttu-id="008cd-709">Vuelva al portal y haga clic en el nombre del sitio web en el **nombre** columna para mostrar las páginas de administración.</span><span class="sxs-lookup"><span data-stu-id="008cd-709">Go back to the portal and click the name of the web site under the **Name** column to display the management pages.</span></span>

    <span data-ttu-id="008cd-710">![Abrir las páginas de administración del sitio web](whats-new-in-aspnet-mvc-4/_static/image66.png "abrir las páginas de administración del sitio web")</span><span class="sxs-lookup"><span data-stu-id="008cd-710">![Opening the web site management pages](whats-new-in-aspnet-mvc-4/_static/image66.png "Opening the web site management pages")</span></span>

    <span data-ttu-id="008cd-711">*Abrir las páginas de administración del sitio Web*</span><span class="sxs-lookup"><span data-stu-id="008cd-711">*Opening the Web Site management pages*</span></span>
7. <span data-ttu-id="008cd-712">En el **panel** página, en la **vista rápida** sección, haga clic en el **descargar perfil de publicación** vínculo.</span><span class="sxs-lookup"><span data-stu-id="008cd-712">In the **Dashboard** page, under the **quick glance** section, click the **Download publish profile** link.</span></span>

    > [!NOTE]
    > <span data-ttu-id="008cd-713">El *perfil de publicación* contiene toda la información necesaria para publicar una aplicación web en un sitio Web de Windows Azure para cada método de publicación habilitado.</span><span class="sxs-lookup"><span data-stu-id="008cd-713">The *publish profile* contains all of the information required to publish a web application to a Windows Azure website for each enabled publication method.</span></span> <span data-ttu-id="008cd-714">El perfil de publicación contiene las direcciones URL, las credenciales de usuario y las cadenas de base de datos necesarias para conectarse y autenticarse en cada uno de los puntos de conexión para el que está habilitado un método de publicación.</span><span class="sxs-lookup"><span data-stu-id="008cd-714">The publish profile contains the URLs, user credentials and database strings required to connect to and authenticate against each of the endpoints for which a publication method is enabled.</span></span> <span data-ttu-id="008cd-715">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express para Web** y **Microsoft Visual Studio 2012** admiten la lectura de perfiles de publicación para automatizar la configuración de estos programas para publicación de aplicaciones web a los sitios Web de Windows Azure.</span><span class="sxs-lookup"><span data-stu-id="008cd-715">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** and **Microsoft Visual Studio 2012** support reading publish profiles to automate configuration of these programs for publishing web applications to Windows Azure websites.</span></span>

    <span data-ttu-id="008cd-716">![Descargar el sitio web de perfil de publicación](whats-new-in-aspnet-mvc-4/_static/image67.png "descargar el sitio web de perfil de publicación")</span><span class="sxs-lookup"><span data-stu-id="008cd-716">![Downloading the web site publish profile](whats-new-in-aspnet-mvc-4/_static/image67.png "Downloading the web site publish profile")</span></span>

    <span data-ttu-id="008cd-717">*Descargar el sitio Web de perfil de publicación*</span><span class="sxs-lookup"><span data-stu-id="008cd-717">*Downloading the Web Site publish profile*</span></span>
8. <span data-ttu-id="008cd-718">Descargue el archivo de perfil de publicación en una ubicación conocida.</span><span class="sxs-lookup"><span data-stu-id="008cd-718">Download the publish profile file to a known location.</span></span> <span data-ttu-id="008cd-719">Aún más en este ejercicio verá cómo utilizar este archivo para publicar una aplicación web a un sitios Web de Windows Azure desde Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="008cd-719">Further in this exercise you will see how to use this file to publish a web application to a Windows Azure Web Sites from Visual Studio.</span></span>

    <span data-ttu-id="008cd-720">![Guardar el archivo de perfil de publicación](whats-new-in-aspnet-mvc-4/_static/image68.png "guardar el perfil de publicación")</span><span class="sxs-lookup"><span data-stu-id="008cd-720">![Saving the publish profile file](whats-new-in-aspnet-mvc-4/_static/image68.png "Saving the publish profile")</span></span>

    <span data-ttu-id="008cd-721">*Guardar el archivo de perfil de publicación*</span><span class="sxs-lookup"><span data-stu-id="008cd-721">*Saving the publish profile file*</span></span>

<a id="ApxDTask2"></a>

<a id="Task_2_-_Configuring_the_Database_Server"></a>
#### <a name="task-2---configuring-the-database-server"></a><span data-ttu-id="008cd-722">Tarea 2: configurar el servidor de base de datos</span><span class="sxs-lookup"><span data-stu-id="008cd-722">Task 2 - Configuring the Database Server</span></span>

<span data-ttu-id="008cd-723">Si la aplicación realiza el uso de SQL Server debe crear un servidor de base de datos SQL de bases de datos.</span><span class="sxs-lookup"><span data-stu-id="008cd-723">If your application makes use of SQL Server databases you will need to create a SQL Database server.</span></span> <span data-ttu-id="008cd-724">Si desea implementar una aplicación simple que no utiliza SQL Server, podría omitir esta tarea.</span><span class="sxs-lookup"><span data-stu-id="008cd-724">If you want to deploy a simple application that does not use SQL Server you might skip this task.</span></span>

1. <span data-ttu-id="008cd-725">Necesitará un servidor de base de datos SQL para almacenar la base de datos de aplicación.</span><span class="sxs-lookup"><span data-stu-id="008cd-725">You will need a SQL Database server for storing the application database.</span></span> <span data-ttu-id="008cd-726">Puede ver los servidores de base de datos SQL de la suscripción en el portal de administración de Windows Azure en **bases de datos Sql** | **servidores** | **del servidor Panel**.</span><span class="sxs-lookup"><span data-stu-id="008cd-726">You can view the SQL Database servers from your subscription in the Windows Azure Management portal at **Sql Databases** | **Servers** | **Server's Dashboard**.</span></span> <span data-ttu-id="008cd-727">Si no tiene un servidor que creó, puede crear uno mediante la **agregar** botón en la barra de comandos.</span><span class="sxs-lookup"><span data-stu-id="008cd-727">If you do not have a server created, you can create one using the **Add** button on the command bar.</span></span> <span data-ttu-id="008cd-728">Tome nota de la **nombre del servidor y la dirección URL, nombre de inicio de sesión de administrador y contraseña**, tal y como se va a utilizar en las siguientes tareas.</span><span class="sxs-lookup"><span data-stu-id="008cd-728">Take note of the **server name and URL, administrator login name and password**, as you will use them in the next tasks.</span></span> <span data-ttu-id="008cd-729">No cree la base de datos, tal y como se creará en una fase posterior.</span><span class="sxs-lookup"><span data-stu-id="008cd-729">Do not create the database yet, as it will be created in a later stage.</span></span>

    <span data-ttu-id="008cd-730">![Panel de servidor de base de datos SQL](whats-new-in-aspnet-mvc-4/_static/image69.png "panel de base de datos SQL Server")</span><span class="sxs-lookup"><span data-stu-id="008cd-730">![SQL Database Server Dashboard](whats-new-in-aspnet-mvc-4/_static/image69.png "SQL Database Server Dashboard")</span></span>

    <span data-ttu-id="008cd-731">*Panel de base de datos SQL Server*</span><span class="sxs-lookup"><span data-stu-id="008cd-731">*SQL Database Server Dashboard*</span></span>
2. <span data-ttu-id="008cd-732">En la siguiente tarea probará la conexión de base de datos de Visual Studio, por ese motivo debe incluir la dirección IP local en la lista del servidor de **direcciones IP permitidas**.</span><span class="sxs-lookup"><span data-stu-id="008cd-732">In the next task you will test the database connection from Visual Studio, for that reason you need to include your local IP address in the server's list of **Allowed IP Addresses**.</span></span> <span data-ttu-id="008cd-733">Para ello, haga clic en **configurar**, seleccione la dirección IP de **dirección IP del cliente actual** y péguela en el **dirección IP inicial** y **ladirecciónIPfinal** cuadros de texto y haga clic en el ![add-client-ip-address-ok-button](whats-new-in-aspnet-mvc-4/_static/image70.png) botón.</span><span class="sxs-lookup"><span data-stu-id="008cd-733">To do that, click **Configure**, select the IP address from **Current Client IP Address** and paste it on the **Start IP Address** and **End IP Address** text boxes and click the ![add-client-ip-address-ok-button](whats-new-in-aspnet-mvc-4/_static/image70.png) button.</span></span>

    ![Agregar dirección IP del cliente](whats-new-in-aspnet-mvc-4/_static/image71.png)

    <span data-ttu-id="008cd-735">*Agregar dirección IP del cliente*</span><span class="sxs-lookup"><span data-stu-id="008cd-735">*Adding Client IP Address*</span></span>
3. <span data-ttu-id="008cd-736">Una vez el **dirección IP del cliente** se agrega a las direcciones IP permitidas lista, haga clic en **guardar** para confirmar los cambios.</span><span class="sxs-lookup"><span data-stu-id="008cd-736">Once the **Client IP Address** is added to the allowed IP addresses list, click on **Save** to confirm the changes.</span></span>

    ![Confirmar cambios](whats-new-in-aspnet-mvc-4/_static/image72.png)

    <span data-ttu-id="008cd-738">*Confirmar cambios*</span><span class="sxs-lookup"><span data-stu-id="008cd-738">*Confirm Changes*</span></span>

<a id="ApxDTask3"></a>

<a id="Task_3_-_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
#### <a name="task-3---publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="008cd-739">Tarea 3: publicar una aplicación de ASP.NET MVC 4 mediante Web Deploy</span><span class="sxs-lookup"><span data-stu-id="008cd-739">Task 3 - Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

1. <span data-ttu-id="008cd-740">Vuelva a la solución de ASP.NET MVC 4.</span><span class="sxs-lookup"><span data-stu-id="008cd-740">Go back to the ASP.NET MVC 4 solution.</span></span> <span data-ttu-id="008cd-741">En el **el Explorador de soluciones**, haga clic en el proyecto de sitio web y seleccione **publicar**.</span><span class="sxs-lookup"><span data-stu-id="008cd-741">In the **Solution Explorer**, right-click the web site project and select **Publish**.</span></span>

    <span data-ttu-id="008cd-742">![Publicar la aplicación](whats-new-in-aspnet-mvc-4/_static/image73.png "publicar la aplicación")</span><span class="sxs-lookup"><span data-stu-id="008cd-742">![Publishing the Application](whats-new-in-aspnet-mvc-4/_static/image73.png "Publishing the Application")</span></span>

    <span data-ttu-id="008cd-743">*Publicar el sitio web*</span><span class="sxs-lookup"><span data-stu-id="008cd-743">*Publishing the web site*</span></span>
2. <span data-ttu-id="008cd-744">Importar el perfil de publicación que se ha guardado en la primera tarea.</span><span class="sxs-lookup"><span data-stu-id="008cd-744">Import the publish profile you saved in the first task.</span></span>

    <span data-ttu-id="008cd-745">![Importar el perfil de publicación](whats-new-in-aspnet-mvc-4/_static/image74.png "importar el perfil de publicación")</span><span class="sxs-lookup"><span data-stu-id="008cd-745">![Importing the publish profile](whats-new-in-aspnet-mvc-4/_static/image74.png "Importing the publish profile")</span></span>

    <span data-ttu-id="008cd-746">*Importar perfil de publicación*</span><span class="sxs-lookup"><span data-stu-id="008cd-746">*Importing publish profile*</span></span>
3. <span data-ttu-id="008cd-747">Haga clic en **validar conexión**.</span><span class="sxs-lookup"><span data-stu-id="008cd-747">Click **Validate Connection**.</span></span> <span data-ttu-id="008cd-748">Una vez completada la validación, haga clic en **siguiente**.</span><span class="sxs-lookup"><span data-stu-id="008cd-748">Once Validation is complete click **Next**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="008cd-749">Validación está completa cuando aparece una marca de verificación verde junto al botón Validar conexión.</span><span class="sxs-lookup"><span data-stu-id="008cd-749">Validation is complete once you see a green checkmark appear next to the Validate Connection button.</span></span>

    <span data-ttu-id="008cd-750">![Validación de la conexión](whats-new-in-aspnet-mvc-4/_static/image75.png "validación de la conexión")</span><span class="sxs-lookup"><span data-stu-id="008cd-750">![Validating connection](whats-new-in-aspnet-mvc-4/_static/image75.png "Validating connection")</span></span>

    <span data-ttu-id="008cd-751">*Validación de la conexión*</span><span class="sxs-lookup"><span data-stu-id="008cd-751">*Validating connection*</span></span>
4. <span data-ttu-id="008cd-752">En el **configuración** página, en la **bases de datos** sección, haga clic en el botón situado junto al cuadro de texto de la conexión de la base de datos (es decir, **DefaultConnection**).</span><span class="sxs-lookup"><span data-stu-id="008cd-752">In the **Settings** page, under the **Databases** section, click the button next to your database connection's textbox (i.e. **DefaultConnection**).</span></span>

    <span data-ttu-id="008cd-753">![Configuración de Web deploy](whats-new-in-aspnet-mvc-4/_static/image76.png "configuración de Web deploy")</span><span class="sxs-lookup"><span data-stu-id="008cd-753">![Web deploy configuration](whats-new-in-aspnet-mvc-4/_static/image76.png "Web deploy configuration")</span></span>

    <span data-ttu-id="008cd-754">*Configuración de Web deploy*</span><span class="sxs-lookup"><span data-stu-id="008cd-754">*Web deploy configuration*</span></span>
5. <span data-ttu-id="008cd-755">Configure la conexión de base de datos de la manera siguiente:</span><span class="sxs-lookup"><span data-stu-id="008cd-755">Configure the database connection as follows:</span></span>

    - <span data-ttu-id="008cd-756">En el **nombre del servidor** escriba la dirección URL de base de datos de SQL server mediante la *tcp:* prefijo.</span><span class="sxs-lookup"><span data-stu-id="008cd-756">In the **Server name** type your SQL Database server URL using the *tcp:* prefix.</span></span>
    - <span data-ttu-id="008cd-757">En **nombre de usuario** escriba el nombre de inicio de sesión del Administrador de servidor.</span><span class="sxs-lookup"><span data-stu-id="008cd-757">In **User name** type your server administrator login name.</span></span>
    - <span data-ttu-id="008cd-758">En **contraseña** escriba la contraseña de inicio de sesión de administrador de servidor.</span><span class="sxs-lookup"><span data-stu-id="008cd-758">In **Password** type your server administrator login password.</span></span>
    - <span data-ttu-id="008cd-759">Escriba un nuevo nombre de base de datos, por ejemplo: *MVC4SampleDB*.</span><span class="sxs-lookup"><span data-stu-id="008cd-759">Type a new database name, for example: *MVC4SampleDB*.</span></span>

    <span data-ttu-id="008cd-760">![Configurar la cadena de conexión de destino](whats-new-in-aspnet-mvc-4/_static/image77.png "configurar la cadena de conexión de destino")</span><span class="sxs-lookup"><span data-stu-id="008cd-760">![Configuring destination connection string](whats-new-in-aspnet-mvc-4/_static/image77.png "Configuring destination connection string")</span></span>

    <span data-ttu-id="008cd-761">*Configurar la cadena de conexión de destino*</span><span class="sxs-lookup"><span data-stu-id="008cd-761">*Configuring destination connection string*</span></span>
6. <span data-ttu-id="008cd-762">A continuación, haga clic en **Aceptar**.</span><span class="sxs-lookup"><span data-stu-id="008cd-762">Then click **OK**.</span></span> <span data-ttu-id="008cd-763">Cuando se le solicite para crear la base de datos, haga clic en **Sí**.</span><span class="sxs-lookup"><span data-stu-id="008cd-763">When prompted to create the database click **Yes**.</span></span>

    <span data-ttu-id="008cd-764">![Crear la base de datos](whats-new-in-aspnet-mvc-4/_static/image78.png "crear la cadena de la base de datos")</span><span class="sxs-lookup"><span data-stu-id="008cd-764">![Creating the database](whats-new-in-aspnet-mvc-4/_static/image78.png "Creating the database string")</span></span>

    <span data-ttu-id="008cd-765">*Crear la base de datos*</span><span class="sxs-lookup"><span data-stu-id="008cd-765">*Creating the database*</span></span>
7. <span data-ttu-id="008cd-766">La cadena de conexión que se va a usar para conectarse a la base de datos de SQL en Windows Azure se muestra en el cuadro de texto de conexión predeterminado.</span><span class="sxs-lookup"><span data-stu-id="008cd-766">The connection string you will use to connect to SQL Database in Windows Azure is shown within Default Connection textbox.</span></span> <span data-ttu-id="008cd-767">Después, haga clic en **Siguiente**.</span><span class="sxs-lookup"><span data-stu-id="008cd-767">Then click **Next**.</span></span>

    <span data-ttu-id="008cd-768">![Cadena de conexión que apunte a la base de datos SQL](whats-new-in-aspnet-mvc-4/_static/image79.png "cadena de conexión que apunte a la base de datos SQL")</span><span class="sxs-lookup"><span data-stu-id="008cd-768">![Connection string pointing to SQL Database](whats-new-in-aspnet-mvc-4/_static/image79.png "Connection string pointing to SQL Database")</span></span>

    <span data-ttu-id="008cd-769">*Cadena de conexión que apunte a la base de datos SQL*</span><span class="sxs-lookup"><span data-stu-id="008cd-769">*Connection string pointing to SQL Database*</span></span>
8. <span data-ttu-id="008cd-770">En el **vista previa** página, haga clic en **publicar**.</span><span class="sxs-lookup"><span data-stu-id="008cd-770">In the **Preview** page, click **Publish**.</span></span>

    <span data-ttu-id="008cd-771">![Publicar la aplicación web](whats-new-in-aspnet-mvc-4/_static/image80.png "publicar la aplicación web")</span><span class="sxs-lookup"><span data-stu-id="008cd-771">![Publishing the web application](whats-new-in-aspnet-mvc-4/_static/image80.png "Publishing the web application")</span></span>

    <span data-ttu-id="008cd-772">*Publicar la aplicación web*</span><span class="sxs-lookup"><span data-stu-id="008cd-772">*Publishing the web application*</span></span>
9. <span data-ttu-id="008cd-773">Una vez que finalice el proceso de publicación, el explorador predeterminado abrirá el sitio web publicado.</span><span class="sxs-lookup"><span data-stu-id="008cd-773">Once the publishing process finishes, your default browser will open the published web site.</span></span>

    <span data-ttu-id="008cd-774">![Publica la aplicación en Windows Azure](whats-new-in-aspnet-mvc-4/_static/image81.png "aplicación se publicó en Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="008cd-774">![Application published to Windows Azure](whats-new-in-aspnet-mvc-4/_static/image81.png "Application published to Windows Azure")</span></span>

    <span data-ttu-id="008cd-775">*Aplicación que se publican en Windows Azure*</span><span class="sxs-lookup"><span data-stu-id="008cd-775">*Application published to Windows Azure*</span></span>
