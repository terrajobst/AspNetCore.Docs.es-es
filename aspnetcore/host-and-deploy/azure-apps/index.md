...
## <a name="deploy-an-aspnet-core-app-that-uses-a-net-core-preview"></a>Implementación de una aplicación ASP.NET Core que usa una versión preliminar de .NET Core
