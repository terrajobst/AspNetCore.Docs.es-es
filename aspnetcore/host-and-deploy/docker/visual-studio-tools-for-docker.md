...
[Visual Studio 2017](https://www.visualstudio.com/) permite compilar, depurar y ejecutar aplicaciones de ASP.NET Core para .NET Framework o .NET Core. Se admiten contenedores de Windows y Linux.
