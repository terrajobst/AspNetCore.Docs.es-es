# <a name="aspnet-core-windows-service-sample-framework-dependent-deployment"></a>Ejemplo de servicio de Windows de ASP.NET Core (implementación dependiente del marco)
