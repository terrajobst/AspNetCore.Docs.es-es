...
## [Creación de una aplicación web de páginas de Razor en Windows](xref:tutorials/razor-pages/index)
...
### [Agregar un controlador](tutorials/first-mvc-app-mac/adding-controller.md)
### [Agregar una vista](tutorials/first-mvc-app-mac/adding-view.md)
### [Agregar un modelo](tutorials/first-mvc-app-mac/adding-model.md)
...
### [Agregar una validación](tutorials/first-mvc-app-mac/validation.md)
### [Inspección de los métodos Details y Delete](tutorials/first-mvc-app/details.md)
...
## [Depuración de instantáneas](https://docs.microsoft.com/azure/application-insights/app-insights-snapshot-debugger)
...
### [Autorización basada en vistas](xref:security/authorization/views)
