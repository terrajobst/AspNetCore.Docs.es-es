...
---
# <a name="use-the-single-page-application-templates-preview"></a>Uso de las plantillas de aplicación de una sola página (versión preliminar)
...
Ejecute el comando siguiente para instalar la versión **preliminar** de las plantillas ASP.NET Core para Angular, React y React con Redux:
