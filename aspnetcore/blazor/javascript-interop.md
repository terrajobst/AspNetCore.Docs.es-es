...
* La aplicación de servidor de Blazor procesa varias solicitudes de usuario. No llame a `JSRuntime.Current` en un componente para invocar funciones de JavaScript.
