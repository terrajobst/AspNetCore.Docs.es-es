...
---
# <a name="custom-formatters-in-aspnet-core-mvc-web-apis"></a>Formateadores personalizados en las API web de ASP.NET Core MVC
...
[Vea o descargue el ejemplo de GitHub](https://github.com/aspnet/Docs/tree/master/aspnetcore/mvc/advanced/custom-formatters/sample).

## <a name="when-to-use-custom-formatters"></a>Cuándo usar formateadores personalizados

Utilice un formateador personalizado cuando quiera que el proceso de [negociación de contenido](xref:mvc/models/formatting) admita un tipo de contenido que no es compatible con los formateadores integrados (JSON, XML y texto sin formato).
...
* Agregue instancias de los formateadores a las colecciones `InputFormatters` y `OutputFormatters` en [MvcOptions](https://docs.microsoft.com/aspnet/core/api/microsoft.aspnetcore.mvc.mvcoptions).
...
Para los tipos binarios, se deriva de la clase base [InputFormatter](https://docs.microsoft.com/aspnet/core/api/microsoft.aspnetcore.mvc.formatters.inputformatter) o [OutputFormatter](https://docs.microsoft.com/aspnet/core/api/microsoft.aspnetcore.mvc.formatters.outputformatter).
...
Consulte la [aplicación de ejemplo](https://github.com/aspnet/Docs/tree/master/aspnetcore/mvc/advanced/custom-formatters/sample), en la que se implementan formateadores de entrada y salida de vCard.  La aplicación lee y escribe tarjetas vCard que tienen un aspecto similar al siguiente:
