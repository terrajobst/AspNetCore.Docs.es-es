...
---
# <a name="author-tag-helpers-in-aspnet-core-a-walkthrough-with-samples"></a>Tutorial con ejemplos sobre la creación de aplicaciones auxiliares de etiquetas en ASP.NET Core
...
2.  Para hacer que la clase `EmailTagHelper` esté disponible para todas nuestras vistas de Razor, agregue la directiva `addTagHelper` al archivo *Views/_ViewImports.cshtml*: [!code-html[Main](../../../mvc/views/tag-helpers/authoring/sample/AuthoringTagHelpers/src/AuthoringTagHelpers/Views/_ViewImportsCopyEmail.cshtml?highlight=2,3)]
...
Nota: Al igual que las etiquetas y atributos HTML, las etiquetas, los nombres de clase y los atributos de Razor y C# no distinguen mayúsculas de minúsculas.
...
1.  Actualice el marcado del archivo *Views/Home/Contact.cshtml* con estos cambios: [!code-html[Main](../../../mvc/views/tag-helpers/authoring/sample/AuthoringTagHelpers/src/AuthoringTagHelpers/Views/Home/ContactCopy.cshtml?highlight=15,16)]
