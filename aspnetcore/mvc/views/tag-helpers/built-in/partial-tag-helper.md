...
* [Datos con establecimiento flexible de tipos (ViewData, atributo ViewData y ViewBag)](xref:mvc/views/overview#weakly-typed-data-viewdata-viewdata-attribute-and-viewbag)
