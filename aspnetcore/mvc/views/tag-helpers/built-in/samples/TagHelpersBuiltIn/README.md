# <a name="aspnet-core-built-in-tag-helpers-sample"></a>Ejemplo de aplicaciones auxiliares de etiquetas integradas de ASP.NET Core

En este ejemplo se muestran las variaciones de las aplicaciones auxiliares de etiquetas integradas tanto en MVC como en páginas de Razor:

- [Aplicación auxiliar de etiquetas de delimitador](https://docs.microsoft.com/aspnet/core/mvc/views/tag-helpers/built-in/anchor-tag-helper)
...
- [Aplicación auxiliar de etiquetas parciales](https://docs.microsoft.com/aspnet/core/mvc/views/tag-helpers/built-in/partial-tag-helper)
