...
Almacenamiento en caché se analiza en varias partes de este documento. Para obtener más información, consulte [almacenar en caché las respuestas en ASP.NET Core](xref:performance/caching/index).
