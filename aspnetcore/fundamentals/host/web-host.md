...
* Carga la [IConfiguration](/dotnet/api/microsoft.extensions.configuration.iconfiguration) opcional de los siguientes elementos:
  * *appsettings.json*.
