...
## <a name="security"></a><span data-ttu-id="487c4-145">Seguridad</span><span class="sxs-lookup"><span data-stu-id="487c4-145">Security</span></span>
...
<span data-ttu-id="487c4-157">En el siguiente archivo JSON, hay cuatro claves en una estructura jerárquica de dos secciones:</span><span class="sxs-lookup"><span data-stu-id="487c4-157">In the following JSON file, four keys exist in a structured hierarchy of two sections:</span></span>
...
<span data-ttu-id="487c4-184">Los valores de configuración adoptan las convenciones siguientes:</span><span class="sxs-lookup"><span data-stu-id="487c4-184">Configuration values adopt the following conventions:</span></span>
...
| [<span data-ttu-id="487c4-213">Proveedor de configuración personalizada</span><span class="sxs-lookup"><span data-stu-id="487c4-213">Custom configuration provider</span></span>](#custom-configuration-provider) | <span data-ttu-id="487c4-214">Origen personalizado</span><span class="sxs-lookup"><span data-stu-id="487c4-214">Custom source</span></span> |
...
<span data-ttu-id="487c4-240">Esta es una secuencia típica de proveedores de configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-240">A typical sequence of configuration providers is:</span></span>
...
<span data-ttu-id="487c4-256">Para activar la configuración de línea de comandos, se llama al método de extensión <xref:Microsoft.Extensions.Configuration.CommandLineConfigurationExtensions.AddCommandLine*> en una instancia de <xref:Microsoft.Extensions.Configuration.ConfigurationBuilder>.</span><span class="sxs-lookup"><span data-stu-id="487c4-256">To activate command-line configuration, the <xref:Microsoft.Extensions.Configuration.CommandLineConfigurationExtensions.AddCommandLine*> extension method is called on an instance of <xref:Microsoft.Extensions.Configuration.ConfigurationBuilder>.</span></span>
...
<span data-ttu-id="487c4-303">Reglas de clave del diccionario de asignaciones de modificador:</span><span class="sxs-lookup"><span data-stu-id="487c4-303">Switch mappings dictionary key rules:</span></span>
...
| <span data-ttu-id="487c4-320">Key</span><span class="sxs-lookup"><span data-stu-id="487c4-320">Key</span></span>               | <span data-ttu-id="487c4-321">Valor</span><span class="sxs-lookup"><span data-stu-id="487c4-321">Value</span></span>    |
| ----------------- | -------- |
...
<span data-ttu-id="487c4-331">`CreateDefaultBuilder` también carga:</span><span class="sxs-lookup"><span data-stu-id="487c4-331">`CreateDefaultBuilder` also loads:</span></span>
...
<span data-ttu-id="487c4-340">Al crear directamente un <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder>, llame a <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> con la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-340">When creating a <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> directly, call <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> with the configuration:</span></span>
...
<span data-ttu-id="487c4-345">Al crear directamente un <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder>, llame a <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> con la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-345">When creating a <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> directly, call <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> with the configuration:</span></span>
...
* <span data-ttu-id="487c4-404">Si el archivo es opcional.</span><span class="sxs-lookup"><span data-stu-id="487c4-404">Whether the file is optional.</span></span>
...
<span data-ttu-id="487c4-413">El archivo de configuración anterior carga las siguientes claves con `value`:</span><span class="sxs-lookup"><span data-stu-id="487c4-413">The previous configuration file loads the following keys with `value`:</span></span>

* <span data-ttu-id="487c4-414">section0:key0</span><span class="sxs-lookup"><span data-stu-id="487c4-414">section0:key0</span></span>
* <span data-ttu-id="487c4-415">section0:key1</span><span class="sxs-lookup"><span data-stu-id="487c4-415">section0:key1</span></span>
* <span data-ttu-id="487c4-416">section1:subsection:key</span><span class="sxs-lookup"><span data-stu-id="487c4-416">section1:subsection:key</span></span>
* <span data-ttu-id="487c4-417">section2:subsection0:key</span><span class="sxs-lookup"><span data-stu-id="487c4-417">section2:subsection0:key</span></span>
* <span data-ttu-id="487c4-418">section2:subsection1:key</span><span class="sxs-lookup"><span data-stu-id="487c4-418">section2:subsection1:key</span></span>

### <a name="json-configuration-provider"></a><span data-ttu-id="487c4-419">Proveedor de configuración JSON</span><span class="sxs-lookup"><span data-stu-id="487c4-419">JSON Configuration Provider</span></span>

<span data-ttu-id="487c4-420"><xref:Microsoft.Extensions.Configuration.Json.JsonConfigurationProvider> carga la configuración desde pares clave-valor de archivos JSON en tiempo de ejecución.</span><span class="sxs-lookup"><span data-stu-id="487c4-420">The <xref:Microsoft.Extensions.Configuration.Json.JsonConfigurationProvider> loads configuration from JSON file key-value pairs during runtime.</span></span>

<span data-ttu-id="487c4-421">Para activar la configuración de archivo JSON, llame al método de extensión <xref:Microsoft.Extensions.Configuration.JsonConfigurationExtensions.AddJsonFile*> en una instancia de <xref:Microsoft.Extensions.Configuration.ConfigurationBuilder>.</span><span class="sxs-lookup"><span data-stu-id="487c4-421">To activate JSON file configuration, call the <xref:Microsoft.Extensions.Configuration.JsonConfigurationExtensions.AddJsonFile*> extension method on an instance of <xref:Microsoft.Extensions.Configuration.ConfigurationBuilder>.</span></span>

<span data-ttu-id="487c4-422">Las sobrecargas permiten especificar:</span><span class="sxs-lookup"><span data-stu-id="487c4-422">Overloads permit specifying:</span></span>

* <span data-ttu-id="487c4-423">Si el archivo es opcional.</span><span class="sxs-lookup"><span data-stu-id="487c4-423">Whether the file is optional.</span></span>
* <span data-ttu-id="487c4-424">Si la configuración se recarga si el archivo cambia.</span><span class="sxs-lookup"><span data-stu-id="487c4-424">Whether the configuration is reloaded if the file changes.</span></span>
* <span data-ttu-id="487c4-425"><xref:Microsoft.Extensions.FileProviders.IFileProvider> que se usa para acceder al archivo.</span><span class="sxs-lookup"><span data-stu-id="487c4-425">The <xref:Microsoft.Extensions.FileProviders.IFileProvider> used to access the file.</span></span>

::: moniker range=">= aspnetcore-2.0"

<span data-ttu-id="487c4-426">`AddJsonFile` se llama automáticamente dos veces al inicializar un nuevo <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> con <xref:Microsoft.AspNetCore.WebHost.CreateDefaultBuilder*>.</span><span class="sxs-lookup"><span data-stu-id="487c4-426">`AddJsonFile` is automatically called twice when you initialize a new <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> with <xref:Microsoft.AspNetCore.WebHost.CreateDefaultBuilder*>.</span></span> <span data-ttu-id="487c4-427">Se llama al método para cargar la configuración desde:</span><span class="sxs-lookup"><span data-stu-id="487c4-427">The method is called to load configuration from:</span></span>

* <span data-ttu-id="487c4-428">*appsettings.json* &ndash; Este archivo se lee primero.</span><span class="sxs-lookup"><span data-stu-id="487c4-428">*appsettings.json* &ndash; This file is read first.</span></span> <span data-ttu-id="487c4-429">La versión del entorno del archivo puede invalidar los valores que proporciona el archivo *appsettings.json*.</span><span class="sxs-lookup"><span data-stu-id="487c4-429">The environment version of the file can override the values provided by the *appsettings.json* file.</span></span>
* <span data-ttu-id="487c4-430">*appsettings.{Environment}.json* &ndash; La versión del entorno del archivo se carga en función de [IHostingEnvironment.EnvironmentName](xref:Microsoft.Extensions.Hosting.IHostingEnvironment.EnvironmentName*).</span><span class="sxs-lookup"><span data-stu-id="487c4-430">*appsettings.{Environment}.json* &ndash; The environment version of the file is loaded based on the [IHostingEnvironment.EnvironmentName](xref:Microsoft.Extensions.Hosting.IHostingEnvironment.EnvironmentName*).</span></span>

<span data-ttu-id="487c4-431">Para más información, consulte [Host web: Configuración de un host](xref:fundamentals/host/web-host#set-up-a-host).</span><span class="sxs-lookup"><span data-stu-id="487c4-431">For more information, see [Web Host: Set up a host](xref:fundamentals/host/web-host#set-up-a-host).</span></span>

<span data-ttu-id="487c4-432">`CreateDefaultBuilder` también carga:</span><span class="sxs-lookup"><span data-stu-id="487c4-432">`CreateDefaultBuilder` also loads:</span></span>

* <span data-ttu-id="487c4-433">Variables de entorno.</span><span class="sxs-lookup"><span data-stu-id="487c4-433">Environment variables.</span></span>
* <span data-ttu-id="487c4-434">[Secretos de usuario (Administrador de secretos)](xref:security/app-secrets) (en el entorno de desarrollo).</span><span class="sxs-lookup"><span data-stu-id="487c4-434">[User secrets (Secret Manager)](xref:security/app-secrets) (in the Development environment).</span></span>
* <span data-ttu-id="487c4-435">Argumentos de la línea de comandos.</span><span class="sxs-lookup"><span data-stu-id="487c4-435">Command-line arguments.</span></span>

<span data-ttu-id="487c4-436">El proveedor de configuración de JSON se establece en primer lugar.</span><span class="sxs-lookup"><span data-stu-id="487c4-436">The JSON Configuration Provider is established first.</span></span> <span data-ttu-id="487c4-437">Por tanto, los secretos de usuario, las variables de entorno y los argumentos de la línea de comandos invalidan la configuración establecida por los archivos *appsettings*.</span><span class="sxs-lookup"><span data-stu-id="487c4-437">Therefore, user secrets, environment variables, and command-line arguments override configuration set by the *appsettings* files.</span></span>

::: moniker-end

::: moniker range=">= aspnetcore-2.1"

<span data-ttu-id="487c4-438">Llame a <xref:Microsoft.Extensions.Hosting.HostBuilder.ConfigureAppConfiguration*> al crear el host para especificar la configuración de la aplicación para archivos distintos de *appsettings.json* y *appsettings.{Environment}.json*:</span><span class="sxs-lookup"><span data-stu-id="487c4-438">Call <xref:Microsoft.Extensions.Hosting.HostBuilder.ConfigureAppConfiguration*> when building the host to specify the app's configuration for files other than *appsettings.json* and *appsettings.{Environment}.json*:</span></span>
...
<span data-ttu-id="487c4-439">Al crear directamente un <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder>, llame a <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> con la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-439">When creating a <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> directly, call <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> with the configuration:</span></span>

::: moniker-end

::: moniker range="= aspnetcore-2.0"

<span data-ttu-id="487c4-440">Puede llamar directamente al método de extensión `AddJsonFile` en una instancia de <xref:Microsoft.Extensions.Configuration.ConfigurationBuilder>.</span><span class="sxs-lookup"><span data-stu-id="487c4-440">You can also directly call the `AddJsonFile` extension method on an instance of <xref:Microsoft.Extensions.Configuration.ConfigurationBuilder>.</span></span>

<span data-ttu-id="487c4-441">Al llamar a `CreateDefaultBuilder`, llame a <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> con la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-441">When calling `CreateDefaultBuilder`, call <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> with the configuration:</span></span>
...
<span data-ttu-id="487c4-442">Al crear directamente un <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder>, llame a <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> con la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-442">When creating a <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> directly, call <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> with the configuration:</span></span>

::: moniker-end

::: moniker range="< aspnetcore-2.0"

<span data-ttu-id="487c4-443">Aplique la configuración a <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> con el método <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*>:</span><span class="sxs-lookup"><span data-stu-id="487c4-443">Apply the configuration to <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> with the <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> method:</span></span>
...
<span data-ttu-id="487c4-444">**Ejemplo**</span><span class="sxs-lookup"><span data-stu-id="487c4-444">**Example**</span></span>

::: moniker range=">= aspnetcore-2.0"

<span data-ttu-id="487c4-445">La aplicación de ejemplo 2.x aprovecha el método de conveniencia estático `CreateDefaultBuilder` para crear el host, que incluye dos llamadas a `AddJsonFile`.</span><span class="sxs-lookup"><span data-stu-id="487c4-445">The 2.x sample app takes advantage of the static convenience method `CreateDefaultBuilder` to build the host, which includes two calls to `AddJsonFile`.</span></span> <span data-ttu-id="487c4-446">La configuración se carga desde *appsettings.json* y *appsettings.{Environment}.json*.</span><span class="sxs-lookup"><span data-stu-id="487c4-446">Configuration is loaded from *appsettings.json* and *appsettings.{Environment}.json*.</span></span>

::: moniker-end

::: moniker range="< aspnetcore-2.0"

<span data-ttu-id="487c4-447">La aplicación de ejemplo 1.x llama a `AddJsonFile` dos veces en un `ConfigurationBuilder`.</span><span class="sxs-lookup"><span data-stu-id="487c4-447">The 1.x sample app calls `AddJsonFile` twice on a `ConfigurationBuilder`.</span></span> <span data-ttu-id="487c4-448">La configuración se carga desde *appsettings.json* y *appsettings.{Environment}.json*.</span><span class="sxs-lookup"><span data-stu-id="487c4-448">Configuration is loaded from *appsettings.json* and *appsettings.{Environment}.json*.</span></span>

::: moniker-end

1. <span data-ttu-id="487c4-449">Ejecute la aplicación de ejemplo.</span><span class="sxs-lookup"><span data-stu-id="487c4-449">Run the sample app.</span></span> <span data-ttu-id="487c4-450">Abra un explorador a la aplicación en `http://localhost:5000`.</span><span class="sxs-lookup"><span data-stu-id="487c4-450">Open a browser to the app at `http://localhost:5000`.</span></span>
1. <span data-ttu-id="487c4-451">Observe que la salida contiene los pares clave-valor para la configuración que se muestra en la tabla según el entorno.</span><span class="sxs-lookup"><span data-stu-id="487c4-451">Observe that the output contains key-value pairs for the configuration shown in the table depending on the environment.</span></span> <span data-ttu-id="487c4-452">Las claves de configuración de registro usan dos puntos (`:`) como separador jerárquico.</span><span class="sxs-lookup"><span data-stu-id="487c4-452">Logging configuration keys use the colon (`:`) as a hierarchical separator.</span></span>

| <span data-ttu-id="487c4-453">Key</span><span class="sxs-lookup"><span data-stu-id="487c4-453">Key</span></span>                        | <span data-ttu-id="487c4-454">Valor de desarrollo</span><span class="sxs-lookup"><span data-stu-id="487c4-454">Development Value</span></span> | <span data-ttu-id="487c4-455">Valor de producción</span><span class="sxs-lookup"><span data-stu-id="487c4-455">Production Value</span></span> |
| -------------------------- | :---------------: | :--------------: |
| <span data-ttu-id="487c4-456">Logging:LogLevel:System</span><span class="sxs-lookup"><span data-stu-id="487c4-456">Logging:LogLevel:System</span></span>    | <span data-ttu-id="487c4-457">Información</span><span class="sxs-lookup"><span data-stu-id="487c4-457">Information</span></span>       | <span data-ttu-id="487c4-458">Información</span><span class="sxs-lookup"><span data-stu-id="487c4-458">Information</span></span>      |
| <span data-ttu-id="487c4-459">Logging:LogLevel:Microsoft</span><span class="sxs-lookup"><span data-stu-id="487c4-459">Logging:LogLevel:Microsoft</span></span> | <span data-ttu-id="487c4-460">Información</span><span class="sxs-lookup"><span data-stu-id="487c4-460">Information</span></span>       | <span data-ttu-id="487c4-461">Información</span><span class="sxs-lookup"><span data-stu-id="487c4-461">Information</span></span>      |
| <span data-ttu-id="487c4-462">Logging:LogLevel:Default</span><span class="sxs-lookup"><span data-stu-id="487c4-462">Logging:LogLevel:Default</span></span>   | <span data-ttu-id="487c4-463">Depuración</span><span class="sxs-lookup"><span data-stu-id="487c4-463">Debug</span></span>             | <span data-ttu-id="487c4-464">Error</span><span class="sxs-lookup"><span data-stu-id="487c4-464">Error</span></span>            |
| <span data-ttu-id="487c4-465">AllowedHosts</span><span class="sxs-lookup"><span data-stu-id="487c4-465">AllowedHosts</span></span>               | *                 | *                |

### <a name="xml-configuration-provider"></a><span data-ttu-id="487c4-466">Proveedor de configuración XML</span><span class="sxs-lookup"><span data-stu-id="487c4-466">XML Configuration Provider</span></span>

<span data-ttu-id="487c4-467"><xref:Microsoft.Extensions.Configuration.Xml.XmlConfigurationProvider> carga la configuración desde pares clave-valor de archivo XML en tiempo de ejecución.</span><span class="sxs-lookup"><span data-stu-id="487c4-467">The <xref:Microsoft.Extensions.Configuration.Xml.XmlConfigurationProvider> loads configuration from XML file key-value pairs at runtime.</span></span>

<span data-ttu-id="487c4-468">Para activar la configuración de archivo XML, llame al método de extensión <xref:Microsoft.Extensions.Configuration.XmlConfigurationExtensions.AddXmlFile*> en una instancia de <xref:Microsoft.Extensions.Configuration.ConfigurationBuilder>.</span><span class="sxs-lookup"><span data-stu-id="487c4-468">To activate XML file configuration, call the <xref:Microsoft.Extensions.Configuration.XmlConfigurationExtensions.AddXmlFile*> extension method on an instance of <xref:Microsoft.Extensions.Configuration.ConfigurationBuilder>.</span></span>

<span data-ttu-id="487c4-469">Las sobrecargas permiten especificar:</span><span class="sxs-lookup"><span data-stu-id="487c4-469">Overloads permit specifying:</span></span>

* <span data-ttu-id="487c4-470">Si el archivo es opcional.</span><span class="sxs-lookup"><span data-stu-id="487c4-470">Whether the file is optional.</span></span>
* <span data-ttu-id="487c4-471">Si la configuración se recarga si el archivo cambia.</span><span class="sxs-lookup"><span data-stu-id="487c4-471">Whether the configuration is reloaded if the file changes.</span></span>
* <span data-ttu-id="487c4-472"><xref:Microsoft.Extensions.FileProviders.IFileProvider> que se usa para acceder al archivo.</span><span class="sxs-lookup"><span data-stu-id="487c4-472">The <xref:Microsoft.Extensions.FileProviders.IFileProvider> used to access the file.</span></span>

<span data-ttu-id="487c4-473">El nodo raíz del archivo de configuración se omite cuando se crean los pares clave-valor de configuración.</span><span class="sxs-lookup"><span data-stu-id="487c4-473">The root node of the configuration file is ignored when the configuration key-value pairs are created.</span></span> <span data-ttu-id="487c4-474">No especifique una definición de tipo de documento (DTD) ni el espacio de nombres en el archivo.</span><span class="sxs-lookup"><span data-stu-id="487c4-474">Don't specify a Document Type Definition (DTD) or namespace in the file.</span></span>

::: moniker range=">= aspnetcore-2.1"

<span data-ttu-id="487c4-475">Llame a <xref:Microsoft.Extensions.Hosting.HostBuilder.ConfigureAppConfiguration*> cuando cree el host para especificar la configuración de la aplicación:</span><span class="sxs-lookup"><span data-stu-id="487c4-475">Call <xref:Microsoft.Extensions.Hosting.HostBuilder.ConfigureAppConfiguration*> when building the host to specify the app's configuration:</span></span>
...
<span data-ttu-id="487c4-476">Al crear directamente un <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder>, llame a <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> con la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-476">When creating a <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> directly, call <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> with the configuration:</span></span>

::: moniker-end

::: moniker range="= aspnetcore-2.0"

<span data-ttu-id="487c4-477">Al llamar a `CreateDefaultBuilder`, llame a <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> con la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-477">When calling `CreateDefaultBuilder`, call <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> with the configuration:</span></span>
...
<span data-ttu-id="487c4-478">Al crear directamente un <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder>, llame a <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> con la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-478">When creating a <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> directly, call <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> with the configuration:</span></span>

::: moniker-end

::: moniker range="< aspnetcore-2.0"

<span data-ttu-id="487c4-479">Aplique la configuración a <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> con el método <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*>:</span><span class="sxs-lookup"><span data-stu-id="487c4-479">Apply the configuration to <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> with the <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> method:</span></span>
...
<span data-ttu-id="487c4-480">Los archivos de configuración XML pueden usar distintos nombres de elemento para las secciones repetidas:</span><span class="sxs-lookup"><span data-stu-id="487c4-480">XML configuration files can use distinct element names for repeating sections:</span></span>
...
<span data-ttu-id="487c4-481">El archivo de configuración anterior carga las siguientes claves con `value`:</span><span class="sxs-lookup"><span data-stu-id="487c4-481">The previous configuration file loads the following keys with `value`:</span></span>

* <span data-ttu-id="487c4-482">section0:key0</span><span class="sxs-lookup"><span data-stu-id="487c4-482">section0:key0</span></span>
* <span data-ttu-id="487c4-483">section0:key1</span><span class="sxs-lookup"><span data-stu-id="487c4-483">section0:key1</span></span>
* <span data-ttu-id="487c4-484">section1:key0</span><span class="sxs-lookup"><span data-stu-id="487c4-484">section1:key0</span></span>
* <span data-ttu-id="487c4-485">section1:key1</span><span class="sxs-lookup"><span data-stu-id="487c4-485">section1:key1</span></span>

<span data-ttu-id="487c4-486">Los elementos de repetición que usan el mismo nombre de elemento funcionan si el atributo `name` se usa para distinguir los elementos:</span><span class="sxs-lookup"><span data-stu-id="487c4-486">Repeating elements that use the same element name work if the `name` attribute is used to distinguish the elements:</span></span>
...
<span data-ttu-id="487c4-487">El archivo de configuración anterior carga las siguientes claves con `value`:</span><span class="sxs-lookup"><span data-stu-id="487c4-487">The previous configuration file loads the following keys with `value`:</span></span>

* <span data-ttu-id="487c4-488">section:section0:key:key0</span><span class="sxs-lookup"><span data-stu-id="487c4-488">section:section0:key:key0</span></span>
* <span data-ttu-id="487c4-489">section:section0:key:key1</span><span class="sxs-lookup"><span data-stu-id="487c4-489">section:section0:key:key1</span></span>
* <span data-ttu-id="487c4-490">section:section1:key:key0</span><span class="sxs-lookup"><span data-stu-id="487c4-490">section:section1:key:key0</span></span>
* <span data-ttu-id="487c4-491">section:section1:key:key1</span><span class="sxs-lookup"><span data-stu-id="487c4-491">section:section1:key:key1</span></span>

<span data-ttu-id="487c4-492">Los atributos se pueden usar para suministrar valores:</span><span class="sxs-lookup"><span data-stu-id="487c4-492">Attributes can be used to supply values:</span></span>
...
<span data-ttu-id="487c4-493">El archivo de configuración anterior carga las siguientes claves con `value`:</span><span class="sxs-lookup"><span data-stu-id="487c4-493">The previous configuration file loads the following keys with `value`:</span></span>

* <span data-ttu-id="487c4-494">key:attribute</span><span class="sxs-lookup"><span data-stu-id="487c4-494">key:attribute</span></span>
* <span data-ttu-id="487c4-495">section:key:attribute</span><span class="sxs-lookup"><span data-stu-id="487c4-495">section:key:attribute</span></span>

::: moniker range=">= aspnetcore-2.1"

## <a name="key-per-file-configuration-provider"></a><span data-ttu-id="487c4-496">Proveedor de configuración de clave por archivo</span><span class="sxs-lookup"><span data-stu-id="487c4-496">Key-per-file Configuration Provider</span></span>

<span data-ttu-id="487c4-497"><xref:Microsoft.Extensions.Configuration.KeyPerFile.KeyPerFileConfigurationProvider> usa los archivos de un directorio como pares clave-valor de configuración.</span><span class="sxs-lookup"><span data-stu-id="487c4-497">The <xref:Microsoft.Extensions.Configuration.KeyPerFile.KeyPerFileConfigurationProvider> uses a directory's files as configuration key-value pairs.</span></span> <span data-ttu-id="487c4-498">La clave es el nombre de archivo.</span><span class="sxs-lookup"><span data-stu-id="487c4-498">The key is the file name.</span></span> <span data-ttu-id="487c4-499">El valor contiene el contenido del archivo.</span><span class="sxs-lookup"><span data-stu-id="487c4-499">The value contains the file's contents.</span></span> <span data-ttu-id="487c4-500">El proveedor de configuración de clave por archivo se usa en escenarios de hospedaje de Docker.</span><span class="sxs-lookup"><span data-stu-id="487c4-500">The Key-per-file Configuration Provider is used in Docker hosting scenarios.</span></span>

<span data-ttu-id="487c4-501">Para activar la configuración de clave por archivo, llame al método de extensión <xref:Microsoft.Extensions.Configuration.KeyPerFileConfigurationBuilderExtensions.AddKeyPerFile*> en una instancia de <xref:Microsoft.Extensions.Configuration.ConfigurationBuilder>.</span><span class="sxs-lookup"><span data-stu-id="487c4-501">To activate key-per-file configuration, call the <xref:Microsoft.Extensions.Configuration.KeyPerFileConfigurationBuilderExtensions.AddKeyPerFile*> extension method on an instance of <xref:Microsoft.Extensions.Configuration.ConfigurationBuilder>.</span></span> <span data-ttu-id="487c4-502">La ruta de acceso `directoryPath` a los archivos debe ser una ruta de acceso absoluta.</span><span class="sxs-lookup"><span data-stu-id="487c4-502">The `directoryPath` to the files must be an absolute path.</span></span>

<span data-ttu-id="487c4-503">Las sobrecargas permiten especificar:</span><span class="sxs-lookup"><span data-stu-id="487c4-503">Overloads permit specifying:</span></span>

* <span data-ttu-id="487c4-504">Un delegado `Action<KeyPerFileConfigurationSource>` que configura el origen.</span><span class="sxs-lookup"><span data-stu-id="487c4-504">An `Action<KeyPerFileConfigurationSource>` delegate that configures the source.</span></span>
* <span data-ttu-id="487c4-505">Si el directorio es opcional y la ruta de acceso al directorio.</span><span class="sxs-lookup"><span data-stu-id="487c4-505">Whether the directory is optional and the path to the directory.</span></span>

<span data-ttu-id="487c4-506">Llame a <xref:Microsoft.Extensions.Hosting.HostBuilder.ConfigureAppConfiguration*> cuando cree el host para especificar la configuración de la aplicación:</span><span class="sxs-lookup"><span data-stu-id="487c4-506">Call <xref:Microsoft.Extensions.Hosting.HostBuilder.ConfigureAppConfiguration*> when building the host to specify the app's configuration:</span></span>
...
<span data-ttu-id="487c4-507">Al crear directamente un <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder>, llame a <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> con la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-507">When creating a <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> directly, call <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> with the configuration:</span></span>
...
## <a name="memory-configuration-provider"></a><span data-ttu-id="487c4-508">Proveedor de configuración de memoria</span><span class="sxs-lookup"><span data-stu-id="487c4-508">Memory Configuration Provider</span></span>

<span data-ttu-id="487c4-509"><xref:Microsoft.Extensions.Configuration.Memory.MemoryConfigurationProvider> usa una colección en memoria como pares clave-valor de configuración.</span><span class="sxs-lookup"><span data-stu-id="487c4-509">The <xref:Microsoft.Extensions.Configuration.Memory.MemoryConfigurationProvider> uses an in-memory collection as configuration key-value pairs.</span></span>

<span data-ttu-id="487c4-510">Para activar la configuración de colección en memoria, llame al método de extensión <xref:Microsoft.Extensions.Configuration.MemoryConfigurationBuilderExtensions.AddInMemoryCollection*> en una instancia de <xref:Microsoft.Extensions.Configuration.ConfigurationBuilder>.</span><span class="sxs-lookup"><span data-stu-id="487c4-510">To activate in-memory collection configuration, call the <xref:Microsoft.Extensions.Configuration.MemoryConfigurationBuilderExtensions.AddInMemoryCollection*> extension method on an instance of <xref:Microsoft.Extensions.Configuration.ConfigurationBuilder>.</span></span>

<span data-ttu-id="487c4-511">El proveedor de configuración se puede inicializar con un `IEnumerable<KeyValuePair<String,String>>`.</span><span class="sxs-lookup"><span data-stu-id="487c4-511">The configuration provider can be initialized with an `IEnumerable<KeyValuePair<String,String>>`.</span></span>

::: moniker range=">= aspnetcore-2.1"

<span data-ttu-id="487c4-512">Llame a <xref:Microsoft.Extensions.Hosting.HostBuilder.ConfigureAppConfiguration*> cuando cree el host para especificar la configuración de la aplicación:</span><span class="sxs-lookup"><span data-stu-id="487c4-512">Call <xref:Microsoft.Extensions.Hosting.HostBuilder.ConfigureAppConfiguration*> when building the host to specify the app's configuration:</span></span>
...
<span data-ttu-id="487c4-513">Al crear directamente un <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder>, llame a <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> con la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-513">When creating a <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> directly, call <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> with the configuration:</span></span>

::: moniker-end

::: moniker range="= aspnetcore-2.0"

<span data-ttu-id="487c4-514">Al llamar a `CreateDefaultBuilder`, llame a <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> con la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-514">When calling `CreateDefaultBuilder`, call <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> with the configuration:</span></span>
...
<span data-ttu-id="487c4-515">Al crear directamente un <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder>, llame a <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> con la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-515">When creating a <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> directly, call <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> with the configuration:</span></span>

::: moniker-end

::: moniker range="< aspnetcore-2.0"

<span data-ttu-id="487c4-516">Aplique la configuración a <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> con el método <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*>:</span><span class="sxs-lookup"><span data-stu-id="487c4-516">Apply the configuration to <xref:Microsoft.AspNetCore.Hosting.WebHostBuilder> with the <xref:Microsoft.AspNetCore.Hosting.HostingAbstractionsWebHostBuilderExtensions.UseConfiguration*> method:</span></span>
...
## <a name="getvalue"></a><span data-ttu-id="487c4-517">GetValue</span><span class="sxs-lookup"><span data-stu-id="487c4-517">GetValue</span></span>

<span data-ttu-id="487c4-518">[ConfigurationBinder.GetValue&lt;T&gt;](xref:Microsoft.Extensions.Configuration.ConfigurationBinder.GetValue*) extrae un valor de la configuración con una clave especificada y lo convierte al tipo especificado.</span><span class="sxs-lookup"><span data-stu-id="487c4-518">[ConfigurationBinder.GetValue&lt;T&gt;](xref:Microsoft.Extensions.Configuration.ConfigurationBinder.GetValue*) extracts a value from configuration with a specified key and converts it to the specified type.</span></span> <span data-ttu-id="487c4-519">Una sobrecarga permite proporcionar un valor predeterminado si no se encuentra la clave.</span><span class="sxs-lookup"><span data-stu-id="487c4-519">An overload permits you to provide a default value if the key isn't found.</span></span>

<span data-ttu-id="487c4-520">El ejemplo siguiente extrae el valor de cadena desde la configuración con la clave `NumberKey`, escribe el valor como `int` y almacena el valor en la variable `intValue`.</span><span class="sxs-lookup"><span data-stu-id="487c4-520">The following example extracts the string value from configuration with the key `NumberKey`, types the value as an `int`, and stores the value in the variable `intValue`.</span></span> <span data-ttu-id="487c4-521">Si `NumberKey` no se encuentra en las claves de configuración, `intValue` recibe el valor predeterminado de `99`:</span><span class="sxs-lookup"><span data-stu-id="487c4-521">If `NumberKey` isn't found in the configuration keys, `intValue` receives the default value of `99`:</span></span>

```csharp
var intValue = config.GetValue<int>("NumberKey", 99);
```

## <a name="getsection-getchildren-and-exists"></a><span data-ttu-id="487c4-522">GetSection, GetChildren y Exists</span><span class="sxs-lookup"><span data-stu-id="487c4-522">GetSection, GetChildren, and Exists</span></span>

<span data-ttu-id="487c4-523">Para los ejemplos siguientes, considere el siguiente archivo JSON.</span><span class="sxs-lookup"><span data-stu-id="487c4-523">For the examples that follow, consider the following JSON file.</span></span> <span data-ttu-id="487c4-524">Se encuentran cuatro claves en dos secciones, una de las cuales incluye un par de subsecciones:</span><span class="sxs-lookup"><span data-stu-id="487c4-524">Four keys are found across two sections, one of which includes a pair of subsections:</span></span>
...
<span data-ttu-id="487c4-525">Cuando el archivo se lee en la configuración, se crean las siguientes claves jerárquicas únicas para contener los valores de configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-525">When the file is read into configuration, the following unique hierarchical keys are created to hold the configuration values:</span></span>

* <span data-ttu-id="487c4-526">section0:key0</span><span class="sxs-lookup"><span data-stu-id="487c4-526">section0:key0</span></span>
* <span data-ttu-id="487c4-527">section0:key1</span><span class="sxs-lookup"><span data-stu-id="487c4-527">section0:key1</span></span>
* <span data-ttu-id="487c4-528">section1:key0</span><span class="sxs-lookup"><span data-stu-id="487c4-528">section1:key0</span></span>
* <span data-ttu-id="487c4-529">section1:key1</span><span class="sxs-lookup"><span data-stu-id="487c4-529">section1:key1</span></span>
* <span data-ttu-id="487c4-530">section2:subsection0:key0</span><span class="sxs-lookup"><span data-stu-id="487c4-530">section2:subsection0:key0</span></span>
* <span data-ttu-id="487c4-531">section2:subsection0:key1</span><span class="sxs-lookup"><span data-stu-id="487c4-531">section2:subsection0:key1</span></span>
* <span data-ttu-id="487c4-532">section2:subsection1:key0</span><span class="sxs-lookup"><span data-stu-id="487c4-532">section2:subsection1:key0</span></span>
* <span data-ttu-id="487c4-533">section2:subsection1:key1</span><span class="sxs-lookup"><span data-stu-id="487c4-533">section2:subsection1:key1</span></span>

### <a name="getsection"></a><span data-ttu-id="487c4-534">GetSection</span><span class="sxs-lookup"><span data-stu-id="487c4-534">GetSection</span></span>

<span data-ttu-id="487c4-535">[IConfiguration.GetSection](xref:Microsoft.Extensions.Configuration.IConfiguration.GetSection*) extrae una subsección de la configuración con la clave de subsección especificada.</span><span class="sxs-lookup"><span data-stu-id="487c4-535">[IConfiguration.GetSection](xref:Microsoft.Extensions.Configuration.IConfiguration.GetSection*) extracts a configuration subsection with the specified subsection key.</span></span>

<span data-ttu-id="487c4-536">Para devolver un <xref:Microsoft.Extensions.Configuration.IConfigurationSection> que contiene los pares clave-valor en `section1`, llame a `GetSection` y suministre el nombre de la sección:</span><span class="sxs-lookup"><span data-stu-id="487c4-536">To return an <xref:Microsoft.Extensions.Configuration.IConfigurationSection> containing only the key-value pairs in `section1`, call `GetSection` and supply the section name:</span></span>

```csharp
var configSection = _config.GetSection("section1");
```

<span data-ttu-id="487c4-537">De forma similar, para obtener los valores de las claves de `section2:subsection0`, llame a `GetSection` y suministre la ruta de acceso a la sección:</span><span class="sxs-lookup"><span data-stu-id="487c4-537">Similarly, to obtain the values for keys in `section2:subsection0`, call `GetSection` and supply the section path:</span></span>

```csharp
var configSection = _config.GetSection("section2:subsection0");
```

<span data-ttu-id="487c4-538">`GetSection` nunca devuelve `null`.</span><span class="sxs-lookup"><span data-stu-id="487c4-538">`GetSection` never returns `null`.</span></span> <span data-ttu-id="487c4-539">Si no se encuentra una sección que coincida, se devuelve una `IConfigurationSection` vacía.</span><span class="sxs-lookup"><span data-stu-id="487c4-539">If a matching section isn't found, an empty `IConfigurationSection` is returned.</span></span>

### <a name="getchildren"></a><span data-ttu-id="487c4-540">GetChildren</span><span class="sxs-lookup"><span data-stu-id="487c4-540">GetChildren</span></span>

<span data-ttu-id="487c4-541">Una llamada a [IConfiguration.GetChildren](xref:Microsoft.Extensions.Configuration.IConfiguration.GetChildren*) en `section2` obtiene una `IEnumerable<IConfigurationSection>` que incluye:</span><span class="sxs-lookup"><span data-stu-id="487c4-541">A call to [IConfiguration.GetChildren](xref:Microsoft.Extensions.Configuration.IConfiguration.GetChildren*) on `section2` obtains an `IEnumerable<IConfigurationSection>` that includes:</span></span>
...
### <a name="exists"></a><span data-ttu-id="487c4-542">Existe</span><span class="sxs-lookup"><span data-stu-id="487c4-542">Exists</span></span>

<span data-ttu-id="487c4-543">Use [ConfigurationExtensions.Exists](xref:Microsoft.Extensions.Configuration.ConfigurationExtensions.Exists*) para determinar si existe una sección de configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-543">Use [ConfigurationExtensions.Exists](xref:Microsoft.Extensions.Configuration.ConfigurationExtensions.Exists*) to determine if a configuration section exists:</span></span>

```csharp
var sectionExists = _config.GetSection("section2:subsection2").Exists();
```

<span data-ttu-id="487c4-544">Dados los datos de ejemplo, `sectionExists` es `false` porque no hay una sección `section2:subsection2` en los datos de configuración.</span><span class="sxs-lookup"><span data-stu-id="487c4-544">Given the example data, `sectionExists` is `false` because there isn't a `section2:subsection2` section in the configuration data.</span></span>

::: moniker-end

## <a name="bind-to-a-class"></a><span data-ttu-id="487c4-545">Enlace a una clase</span><span class="sxs-lookup"><span data-stu-id="487c4-545">Bind to a class</span></span>

<span data-ttu-id="487c4-546">La configuración se puede enlazar a clases que representan grupos de configuraciones relacionadas a través del *patrón de opciones*.</span><span class="sxs-lookup"><span data-stu-id="487c4-546">Configuration can be bound to classes that represent groups of related settings using the *options pattern*.</span></span> <span data-ttu-id="487c4-547">Para obtener más información, vea <xref:fundamentals/configuration/options>.</span><span class="sxs-lookup"><span data-stu-id="487c4-547">For more information, see <xref:fundamentals/configuration/options>.</span></span>

<span data-ttu-id="487c4-548">Los valores de configuración se devuelven como cadenas, pero llamar a <xref:Microsoft.Extensions.Configuration.ConfigurationBinder.Bind*> permite la construcción de objetos [POCO](https://wikipedia.org/wiki/Plain_Old_CLR_Object).</span><span class="sxs-lookup"><span data-stu-id="487c4-548">Configuration values are returned as strings, but calling <xref:Microsoft.Extensions.Configuration.ConfigurationBinder.Bind*> enables the construction of [POCO](https://wikipedia.org/wiki/Plain_Old_CLR_Object) objects.</span></span>

<span data-ttu-id="487c4-549">La aplicación de ejemplo contiene un modelo `Starship` (*Models/Starship.cs*):</span><span class="sxs-lookup"><span data-stu-id="487c4-549">The sample app contains a `Starship` model (*Models/Starship.cs*):</span></span>
...
<span data-ttu-id="487c4-550">La sección `starship` del archivo *starship.json* crea la configuración cuando la aplicación de ejemplo usa el proveedor de configuración JSON para cargar la configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-550">The `starship` section of the *starship.json* file creates the configuration when the sample app uses the JSON Configuration Provider to load the configuration:</span></span>
...
<span data-ttu-id="487c4-551">Se crean los siguientes pares clave-valor de configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-551">The following configuration key-value pairs are created:</span></span>

| <span data-ttu-id="487c4-552">Key</span><span class="sxs-lookup"><span data-stu-id="487c4-552">Key</span></span>                   | <span data-ttu-id="487c4-553">Valor</span><span class="sxs-lookup"><span data-stu-id="487c4-553">Value</span></span>                                             |
| --------------------- | ------------------------------------------------- |
| <span data-ttu-id="487c4-554">starship:name</span><span class="sxs-lookup"><span data-stu-id="487c4-554">starship:name</span></span>         | <span data-ttu-id="487c4-555">USS Enterprise</span><span class="sxs-lookup"><span data-stu-id="487c4-555">USS Enterprise</span></span>                                    |
| <span data-ttu-id="487c4-556">starship:registry</span><span class="sxs-lookup"><span data-stu-id="487c4-556">starship:registry</span></span>     | <span data-ttu-id="487c4-557">NCC-1701</span><span class="sxs-lookup"><span data-stu-id="487c4-557">NCC-1701</span></span>                                          |
| <span data-ttu-id="487c4-558">starship:class</span><span class="sxs-lookup"><span data-stu-id="487c4-558">starship:class</span></span>        | <span data-ttu-id="487c4-559">Constitution</span><span class="sxs-lookup"><span data-stu-id="487c4-559">Constitution</span></span>                                      |
| <span data-ttu-id="487c4-560">starship:length</span><span class="sxs-lookup"><span data-stu-id="487c4-560">starship:length</span></span>       | <span data-ttu-id="487c4-561">304.8</span><span class="sxs-lookup"><span data-stu-id="487c4-561">304.8</span></span>                                             |
| <span data-ttu-id="487c4-562">starship:commissioned</span><span class="sxs-lookup"><span data-stu-id="487c4-562">starship:commissioned</span></span> | <span data-ttu-id="487c4-563">False</span><span class="sxs-lookup"><span data-stu-id="487c4-563">False</span></span>                                             |
| <span data-ttu-id="487c4-564">trademark</span><span class="sxs-lookup"><span data-stu-id="487c4-564">trademark</span></span>             | <span data-ttu-id="487c4-565">Paramount Pictures Corp. http://www.paramount.com</span><span class="sxs-lookup"><span data-stu-id="487c4-565">Paramount Pictures Corp. http://www.paramount.com</span></span> |

<span data-ttu-id="487c4-566">La aplicación de ejemplo llama a `GetSection` con la clave `starship`.</span><span class="sxs-lookup"><span data-stu-id="487c4-566">The sample app calls `GetSection` with the `starship` key.</span></span> <span data-ttu-id="487c4-567">Los pares clave-valor `starship` están aislados.</span><span class="sxs-lookup"><span data-stu-id="487c4-567">The `starship` key-value pairs are isolated.</span></span> <span data-ttu-id="487c4-568">El método `Bind` se llama en la subsección que pasa una instancia de la clase `Starship`.</span><span class="sxs-lookup"><span data-stu-id="487c4-568">The `Bind` method is called on the subsection passing in an instance of the `Starship` class.</span></span> <span data-ttu-id="487c4-569">Después de enlazar los valores de instancia, la instancia está asignada a una propiedad para la representación:</span><span class="sxs-lookup"><span data-stu-id="487c4-569">After binding the instance values, the instance is assigned to a property for rendering:</span></span>
...
## <a name="bind-to-an-object-graph"></a><span data-ttu-id="487c4-570">Enlazar a un gráfico de objetos</span><span class="sxs-lookup"><span data-stu-id="487c4-570">Bind to an object graph</span></span>

<span data-ttu-id="487c4-571"><xref:Microsoft.Extensions.Configuration.ConfigurationBinder.Bind*> es capaz de enlazar todo un gráfico de objetos POCO.</span><span class="sxs-lookup"><span data-stu-id="487c4-571"><xref:Microsoft.Extensions.Configuration.ConfigurationBinder.Bind*> is capable of binding an entire POCO object graph.</span></span>

<span data-ttu-id="487c4-572">El ejemplo contiene un modelo `TvShow` cuyo gráfico de objetos incluye las clases `Metadata` y `Actors` (*Models/TvShow.cs*):</span><span class="sxs-lookup"><span data-stu-id="487c4-572">The sample contains a `TvShow` model whose object graph includes `Metadata` and `Actors` classes (*Models/TvShow.cs*):</span></span>
...
<span data-ttu-id="487c4-573">La aplicación de ejemplo tiene un archivo *tvshow.xml* que contiene los datos de configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-573">The sample app has a *tvshow.xml* file containing the configuration data:</span></span>
...
<span data-ttu-id="487c4-574">Configuración está enlazada a todo el gráfico de objetos `TvShow`con el método `Bind`.</span><span class="sxs-lookup"><span data-stu-id="487c4-574">Configuration is bound to the entire `TvShow` object graph with the `Bind` method.</span></span> <span data-ttu-id="487c4-575">La instancia enlazada se asigna a una propiedad para la representación:</span><span class="sxs-lookup"><span data-stu-id="487c4-575">The bound instance is assigned to a property for rendering:</span></span>
...
<span data-ttu-id="487c4-576">[ConfigurationBinder.Get&lt;T&gt; ](xref:Microsoft.Extensions.Configuration.ConfigurationBinder.Get*) enlaza y devuelve el tipo especificado.</span><span class="sxs-lookup"><span data-stu-id="487c4-576">[ConfigurationBinder.Get&lt;T&gt;](xref:Microsoft.Extensions.Configuration.ConfigurationBinder.Get*) binds and returns the specified type.</span></span> <span data-ttu-id="487c4-577">`Get<T>` es más conveniente que usar `Bind`.</span><span class="sxs-lookup"><span data-stu-id="487c4-577">`Get<T>` is more convenient than using `Bind`.</span></span> <span data-ttu-id="487c4-578">El código siguiente muestra cómo usar `Get<T>` con el ejemplo anterior, lo que permite que la instancia enlazada se asigne directamente a la propiedad que se usa para la representación:</span><span class="sxs-lookup"><span data-stu-id="487c4-578">The following code shows how to use `Get<T>` with the preceding example, which allows the bound instance to be directly assigned to the property used for rendering:</span></span>
...
## <a name="bind-an-array-to-a-class"></a><span data-ttu-id="487c4-579">Enlace de una matriz a una clase</span><span class="sxs-lookup"><span data-stu-id="487c4-579">Bind an array to a class</span></span>

<span data-ttu-id="487c4-580">*La aplicación de ejemplo muestra los conceptos que se explican en esta sección.*</span><span class="sxs-lookup"><span data-stu-id="487c4-580">*The sample app demonstrates the concepts explained in this section.*</span></span>

<span data-ttu-id="487c4-581"><xref:Microsoft.Extensions.Configuration.ConfigurationBinder.Bind*> admite enlazar matrices a objetos con los índices de matriz en las claves de configuración.</span><span class="sxs-lookup"><span data-stu-id="487c4-581">The <xref:Microsoft.Extensions.Configuration.ConfigurationBinder.Bind*> supports binding arrays to objects using array indices in configuration keys.</span></span> <span data-ttu-id="487c4-582">Cualquier formato de matriz que expone un segmento de clave numérica (`:0:`, `:1:`, &hellip; `:{n}:`) es capaz de enlazar una matriz a una matriz de clase POCO.</span><span class="sxs-lookup"><span data-stu-id="487c4-582">Any array format that exposes a numeric key segment (`:0:`, `:1:`, &hellip; `:{n}:`) is capable of array binding to a POCO class array.</span></span>

> [!NOTE]
> <span data-ttu-id="487c4-583">El enlace se proporciona por convención.</span><span class="sxs-lookup"><span data-stu-id="487c4-583">Binding is provided by convention.</span></span> <span data-ttu-id="487c4-584">Los proveedores de configuración personalizados no son necesarios para implementar el enlace de matriz.</span><span class="sxs-lookup"><span data-stu-id="487c4-584">Custom configuration providers aren't required to implement array binding.</span></span>

<span data-ttu-id="487c4-585">**Procesamiento de matriz en memoria**</span><span class="sxs-lookup"><span data-stu-id="487c4-585">**In-memory array processing**</span></span>

<span data-ttu-id="487c4-586">Considere los valores y las claves de configuración que se muestran en esta tabla.</span><span class="sxs-lookup"><span data-stu-id="487c4-586">Consider the configuration keys and values shown in the following table.</span></span>

| <span data-ttu-id="487c4-587">Key</span><span class="sxs-lookup"><span data-stu-id="487c4-587">Key</span></span>     | <span data-ttu-id="487c4-588">Valor</span><span class="sxs-lookup"><span data-stu-id="487c4-588">Value</span></span>  |
| :-----: | :----: |
| <span data-ttu-id="487c4-589">array:0</span><span class="sxs-lookup"><span data-stu-id="487c4-589">array:0</span></span> | <span data-ttu-id="487c4-590">value0</span><span class="sxs-lookup"><span data-stu-id="487c4-590">value0</span></span> |
| <span data-ttu-id="487c4-591">array:1</span><span class="sxs-lookup"><span data-stu-id="487c4-591">array:1</span></span> | <span data-ttu-id="487c4-592">value1</span><span class="sxs-lookup"><span data-stu-id="487c4-592">value1</span></span> |
| <span data-ttu-id="487c4-593">array:2</span><span class="sxs-lookup"><span data-stu-id="487c4-593">array:2</span></span> | <span data-ttu-id="487c4-594">value2</span><span class="sxs-lookup"><span data-stu-id="487c4-594">value2</span></span> |
| <span data-ttu-id="487c4-595">array:4</span><span class="sxs-lookup"><span data-stu-id="487c4-595">array:4</span></span> | <span data-ttu-id="487c4-596">value4</span><span class="sxs-lookup"><span data-stu-id="487c4-596">value4</span></span> |
| <span data-ttu-id="487c4-597">array:5</span><span class="sxs-lookup"><span data-stu-id="487c4-597">array:5</span></span> | <span data-ttu-id="487c4-598">value5</span><span class="sxs-lookup"><span data-stu-id="487c4-598">value5</span></span> |

<span data-ttu-id="487c4-599">Estas claves y valores se cargan en la aplicación de ejemplo a través del proveedor de configuración de memoria:</span><span class="sxs-lookup"><span data-stu-id="487c4-599">These keys and values are loaded in the sample app using the Memory Configuration Provider:</span></span>
...
<span data-ttu-id="487c4-600">La matriz omite un valor de índice &num;3.</span><span class="sxs-lookup"><span data-stu-id="487c4-600">The array skips a value for index &num;3.</span></span> <span data-ttu-id="487c4-601">El enlazador de configuración no es capaz de enlazar los valores NULL ni de crear entradas NULL en los objetos enlazados, lo que queda claro cuando se muestra el resultado de enlazar esta matriz a un objeto.</span><span class="sxs-lookup"><span data-stu-id="487c4-601">The configuration binder isn't capable of binding null values or creating null entries in bound objects, which becomes clear in a moment when the result of binding this array to an object is demonstrated.</span></span>

<span data-ttu-id="487c4-602">En la aplicación de ejemplo, hay disponible una clase POCO para almacenar los datos de configuración enlazados:</span><span class="sxs-lookup"><span data-stu-id="487c4-602">In the sample app, a POCO class is available to hold the bound configuration data:</span></span>
...
<span data-ttu-id="487c4-603">Los datos de configuración están enlazados al objeto:</span><span class="sxs-lookup"><span data-stu-id="487c4-603">The configuration data is bound to the object:</span></span>
...
<span data-ttu-id="487c4-604">También se puede usar la sintaxis de [ConfigurationBinder.Get&lt;T&gt; ](xref:Microsoft.Extensions.Configuration.ConfigurationBinder.Get*), lo que genera un código más compacto:</span><span class="sxs-lookup"><span data-stu-id="487c4-604">[ConfigurationBinder.Get&lt;T&gt;](xref:Microsoft.Extensions.Configuration.ConfigurationBinder.Get*) syntax can also be used, which results in more compact code:</span></span>
...
<span data-ttu-id="487c4-605">El objeto enlazado, una instancia de `ArrayExample`, recibe los datos de la matriz desde la configuración.</span><span class="sxs-lookup"><span data-stu-id="487c4-605">The bound object, an instance of `ArrayExample`, receives the array data from configuration.</span></span>

| <span data-ttu-id="487c4-606">Índice de `ArrayExamples.Entries`</span><span class="sxs-lookup"><span data-stu-id="487c4-606">`ArrayExamples.Entries` Index</span></span> | <span data-ttu-id="487c4-607">Valor de `ArrayExamples.Entries`</span><span class="sxs-lookup"><span data-stu-id="487c4-607">`ArrayExamples.Entries` Value</span></span> |
| :---------------------------: | :---------------------------: |
| <span data-ttu-id="487c4-608">0</span><span class="sxs-lookup"><span data-stu-id="487c4-608">0</span></span>                             | <span data-ttu-id="487c4-609">value0</span><span class="sxs-lookup"><span data-stu-id="487c4-609">value0</span></span>                        |
| <span data-ttu-id="487c4-610">1</span><span class="sxs-lookup"><span data-stu-id="487c4-610">1</span></span>                             | <span data-ttu-id="487c4-611">value1</span><span class="sxs-lookup"><span data-stu-id="487c4-611">value1</span></span>                        |
| <span data-ttu-id="487c4-612">2</span><span class="sxs-lookup"><span data-stu-id="487c4-612">2</span></span>                             | <span data-ttu-id="487c4-613">value2</span><span class="sxs-lookup"><span data-stu-id="487c4-613">value2</span></span>                        |
| <span data-ttu-id="487c4-614">3</span><span class="sxs-lookup"><span data-stu-id="487c4-614">3</span></span>                             | <span data-ttu-id="487c4-615">value4</span><span class="sxs-lookup"><span data-stu-id="487c4-615">value4</span></span>                        |
| <span data-ttu-id="487c4-616">4</span><span class="sxs-lookup"><span data-stu-id="487c4-616">4</span></span>                             | <span data-ttu-id="487c4-617">value5</span><span class="sxs-lookup"><span data-stu-id="487c4-617">value5</span></span>                        |

<span data-ttu-id="487c4-618">El índice &num;3 en el objeto enlazado contiene los datos de configuración para la clave de configuración `array:4` y su valor de `value4`.</span><span class="sxs-lookup"><span data-stu-id="487c4-618">Index &num;3 in the bound object holds the configuration data for the `array:4` configuration key and its value of `value4`.</span></span> <span data-ttu-id="487c4-619">Cuando se enlazan datos de configuración que contienen una matriz, los índices de la matriz en las claves de configuración solo se usan para iterar los datos de configuración al crear el objeto.</span><span class="sxs-lookup"><span data-stu-id="487c4-619">When configuration data containing an array is bound, the array indices in the configuration keys are merely used to iterate the configuration data when creating the object.</span></span> <span data-ttu-id="487c4-620">No se puede conservar un valor NULL en los datos de configuración y no se crea una entrada con valores NULL en un objeto enlazado cuando una matriz en las claves de configuración omite uno o más índices.</span><span class="sxs-lookup"><span data-stu-id="487c4-620">A null value can't be retained in configuration data, and a null-valued entry isn't created in a bound object when an array in configuration keys skip one or more indices.</span></span>

<span data-ttu-id="487c4-621">El elemento de configuración omitido para el índice &num;3 se puede proporcionar antes del enlace a la instancia `ArrayExamples` por cualquier proveedor de configuración que genera el par clave-valor correcto en la configuración.</span><span class="sxs-lookup"><span data-stu-id="487c4-621">The missing configuration item for index &num;3 can be supplied before binding to the `ArrayExamples` instance by any configuration provider that produces the correct key-value pair in configuration.</span></span> <span data-ttu-id="487c4-622">Si el ejemplo incluía un proveedor de configuración JSON adicional con el par clave-valor omitido, `ArrayExamples.Entries` coincide con la matriz de configuración completa:</span><span class="sxs-lookup"><span data-stu-id="487c4-622">If the sample included an additional JSON Configuration Provider with the missing key-value pair, the `ArrayExamples.Entries` matches the complete configuration array:</span></span>

<span data-ttu-id="487c4-623">*missing_value.json*:</span><span class="sxs-lookup"><span data-stu-id="487c4-623">*missing_value.json*:</span></span>
...
<span data-ttu-id="487c4-624">En <xref:Microsoft.Extensions.Hosting.HostBuilder.ConfigureAppConfiguration*>:</span><span class="sxs-lookup"><span data-stu-id="487c4-624">In <xref:Microsoft.Extensions.Hosting.HostBuilder.ConfigureAppConfiguration*>:</span></span>
...
<span data-ttu-id="487c4-625">En el constructor `Startup`:</span><span class="sxs-lookup"><span data-stu-id="487c4-625">In the `Startup` constructor:</span></span>
...
<span data-ttu-id="487c4-626">El par clave-valor que se muestra en la tabla se carga en la configuración.</span><span class="sxs-lookup"><span data-stu-id="487c4-626">The key-value pair shown in the table is loaded into configuration.</span></span>

| <span data-ttu-id="487c4-627">Key</span><span class="sxs-lookup"><span data-stu-id="487c4-627">Key</span></span>             | <span data-ttu-id="487c4-628">Valor</span><span class="sxs-lookup"><span data-stu-id="487c4-628">Value</span></span>  |
| :-------------: | :----: |
| <span data-ttu-id="487c4-629">array:entries:3</span><span class="sxs-lookup"><span data-stu-id="487c4-629">array:entries:3</span></span> | <span data-ttu-id="487c4-630">value3</span><span class="sxs-lookup"><span data-stu-id="487c4-630">value3</span></span> |

<span data-ttu-id="487c4-631">Si la instancia de clase `ArrayExamples` se enlaza después de que el proveedor de configuración JSON incluye la entrada para el índice &num;3, la matriz `ArrayExamples.Entries` incluye el valor.</span><span class="sxs-lookup"><span data-stu-id="487c4-631">If the `ArrayExamples` class instance is bound after the JSON Configuration Provider includes the entry for index &num;3, the `ArrayExamples.Entries` array includes the value.</span></span>

| <span data-ttu-id="487c4-632">Índice de `ArrayExamples.Entries`</span><span class="sxs-lookup"><span data-stu-id="487c4-632">`ArrayExamples.Entries` Index</span></span> | <span data-ttu-id="487c4-633">Valor de `ArrayExamples.Entries`</span><span class="sxs-lookup"><span data-stu-id="487c4-633">`ArrayExamples.Entries` Value</span></span> |
| :---------------------------: | :---------------------------: |
| <span data-ttu-id="487c4-634">0</span><span class="sxs-lookup"><span data-stu-id="487c4-634">0</span></span>                             | <span data-ttu-id="487c4-635">value0</span><span class="sxs-lookup"><span data-stu-id="487c4-635">value0</span></span>                        |
| <span data-ttu-id="487c4-636">1</span><span class="sxs-lookup"><span data-stu-id="487c4-636">1</span></span>                             | <span data-ttu-id="487c4-637">value1</span><span class="sxs-lookup"><span data-stu-id="487c4-637">value1</span></span>                        |
| <span data-ttu-id="487c4-638">2</span><span class="sxs-lookup"><span data-stu-id="487c4-638">2</span></span>                             | <span data-ttu-id="487c4-639">value2</span><span class="sxs-lookup"><span data-stu-id="487c4-639">value2</span></span>                        |
| <span data-ttu-id="487c4-640">3</span><span class="sxs-lookup"><span data-stu-id="487c4-640">3</span></span>                             | <span data-ttu-id="487c4-641">value3</span><span class="sxs-lookup"><span data-stu-id="487c4-641">value3</span></span>                        |
| <span data-ttu-id="487c4-642">4</span><span class="sxs-lookup"><span data-stu-id="487c4-642">4</span></span>                             | <span data-ttu-id="487c4-643">value4</span><span class="sxs-lookup"><span data-stu-id="487c4-643">value4</span></span>                        |
| <span data-ttu-id="487c4-644">5</span><span class="sxs-lookup"><span data-stu-id="487c4-644">5</span></span>                             | <span data-ttu-id="487c4-645">value5</span><span class="sxs-lookup"><span data-stu-id="487c4-645">value5</span></span>                        |

<span data-ttu-id="487c4-646">**Procesamiento de matriz JSON**</span><span class="sxs-lookup"><span data-stu-id="487c4-646">**JSON array processing**</span></span>

<span data-ttu-id="487c4-647">Si un archivo JSON contiene una matriz, se crean claves de configuración para los elementos de la matriz con un índice de sección basado en cero.</span><span class="sxs-lookup"><span data-stu-id="487c4-647">If a JSON file contains an array, configuration keys are created for the array elements with a zero-based section index.</span></span> <span data-ttu-id="487c4-648">En el siguiente archivo de configuración, `subsection` es una matriz:</span><span class="sxs-lookup"><span data-stu-id="487c4-648">In the following configuration file, `subsection` is an array:</span></span>
...
<span data-ttu-id="487c4-649">El proveedor de configuración JSON lee los datos de configuración en los siguientes pares clave-valor:</span><span class="sxs-lookup"><span data-stu-id="487c4-649">The JSON Configuration Provider reads the configuration data into the following key-value pairs:</span></span>

| <span data-ttu-id="487c4-650">Key</span><span class="sxs-lookup"><span data-stu-id="487c4-650">Key</span></span>                     | <span data-ttu-id="487c4-651">Valor</span><span class="sxs-lookup"><span data-stu-id="487c4-651">Value</span></span>  |
| ----------------------- | :----: |
| <span data-ttu-id="487c4-652">json_array:key</span><span class="sxs-lookup"><span data-stu-id="487c4-652">json_array:key</span></span>          | <span data-ttu-id="487c4-653">valueA</span><span class="sxs-lookup"><span data-stu-id="487c4-653">valueA</span></span> |
| <span data-ttu-id="487c4-654">json_array:subsection:0</span><span class="sxs-lookup"><span data-stu-id="487c4-654">json_array:subsection:0</span></span> | <span data-ttu-id="487c4-655">valueB</span><span class="sxs-lookup"><span data-stu-id="487c4-655">valueB</span></span> |
| <span data-ttu-id="487c4-656">json_array:subsection:1</span><span class="sxs-lookup"><span data-stu-id="487c4-656">json_array:subsection:1</span></span> | <span data-ttu-id="487c4-657">valueC</span><span class="sxs-lookup"><span data-stu-id="487c4-657">valueC</span></span> |
| <span data-ttu-id="487c4-658">json_array:subsection:2</span><span class="sxs-lookup"><span data-stu-id="487c4-658">json_array:subsection:2</span></span> | <span data-ttu-id="487c4-659">valueD</span><span class="sxs-lookup"><span data-stu-id="487c4-659">valueD</span></span> |

<span data-ttu-id="487c4-660">En la aplicación de ejemplo, la clase POCO siguiente está disponible para enlazar los pares clave-valor de configuración:</span><span class="sxs-lookup"><span data-stu-id="487c4-660">In the sample app, the following POCO class is available to bind the configuration key-value pairs:</span></span>
...
<span data-ttu-id="487c4-661">Después del enlace, `JsonArrayExample.Key` contiene el valor `valueA`.</span><span class="sxs-lookup"><span data-stu-id="487c4-661">After binding, `JsonArrayExample.Key` holds the value `valueA`.</span></span> <span data-ttu-id="487c4-662">Los valores de la subsección se almacenan en la propiedad de la matriz POCO, `Subsection`.</span><span class="sxs-lookup"><span data-stu-id="487c4-662">The subsection values are stored in the POCO array property, `Subsection`.</span></span>

| <span data-ttu-id="487c4-663">Índice de `JsonArrayExample.Subsection`</span><span class="sxs-lookup"><span data-stu-id="487c4-663">`JsonArrayExample.Subsection` Index</span></span> | <span data-ttu-id="487c4-664">Valor de `JsonArrayExample.Subsection`</span><span class="sxs-lookup"><span data-stu-id="487c4-664">`JsonArrayExample.Subsection` Value</span></span> |
| :---------------------------------: | :---------------------------------: |
| <span data-ttu-id="487c4-665">0</span><span class="sxs-lookup"><span data-stu-id="487c4-665">0</span></span>                                   | <span data-ttu-id="487c4-666">valueB</span><span class="sxs-lookup"><span data-stu-id="487c4-666">valueB</span></span>                              |
| <span data-ttu-id="487c4-667">1</span><span class="sxs-lookup"><span data-stu-id="487c4-667">1</span></span>                                   | <span data-ttu-id="487c4-668">valueC</span><span class="sxs-lookup"><span data-stu-id="487c4-668">valueC</span></span>                              |
| <span data-ttu-id="487c4-669">2</span><span class="sxs-lookup"><span data-stu-id="487c4-669">2</span></span>                                   | <span data-ttu-id="487c4-670">valueD</span><span class="sxs-lookup"><span data-stu-id="487c4-670">valueD</span></span>                              |

## <a name="custom-configuration-provider"></a><span data-ttu-id="487c4-671">Proveedores de configuración personalizada</span><span class="sxs-lookup"><span data-stu-id="487c4-671">Custom configuration provider</span></span>

<span data-ttu-id="487c4-672">La aplicación de ejemplo muestra cómo crear un proveedor de configuración básica que lee los pares clave-valor de configuración desde una base de datos mediante [Entity Framework (EF)](/ef/core/).</span><span class="sxs-lookup"><span data-stu-id="487c4-672">The sample app demonstrates how to create a basic configuration provider that reads configuration key-value pairs from a database using [Entity Framework (EF)](/ef/core/).</span></span>

<span data-ttu-id="487c4-673">El proveedor tiene las siguientes características:</span><span class="sxs-lookup"><span data-stu-id="487c4-673">The provider has the following characteristics:</span></span>

* <span data-ttu-id="487c4-674">La base de datos en memoria de EF se usa para fines de demostración.</span><span class="sxs-lookup"><span data-stu-id="487c4-674">The EF in-memory database is used for demonstration purposes.</span></span> <span data-ttu-id="487c4-675">Para usar una base de datos que requiere una cadena de conexión, implemente un `ConfigurationBuilder` secundario para suministrar la cadena de conexión desde otro proveedor de configuración.</span><span class="sxs-lookup"><span data-stu-id="487c4-675">To use a database that requires a connection string, implement a secondary `ConfigurationBuilder` to supply the connection string from another configuration provider.</span></span>
* <span data-ttu-id="487c4-676">El proveedor lee una tabla de base de datos en la configuración en el inicio.</span><span class="sxs-lookup"><span data-stu-id="487c4-676">The provider reads a database table into configuration at startup.</span></span> <span data-ttu-id="487c4-677">El proveedor no consulta la base de datos por clave.</span><span class="sxs-lookup"><span data-stu-id="487c4-677">The provider doesn't query the database on a per-key basis.</span></span>
* <span data-ttu-id="487c4-678">La función de recarga en cambio no se implementa, por lo que actualizar la base de datos después del inicio de la aplicación no afecta a la configuración de la aplicación.</span><span class="sxs-lookup"><span data-stu-id="487c4-678">Reload-on-change isn't implemented, so updating the database after the app starts has no effect on the app's configuration.</span></span>

<span data-ttu-id="487c4-679">Defina una entidad `EFConfigurationValue` para almacenar los valores de configuración en la base de datos.</span><span class="sxs-lookup"><span data-stu-id="487c4-679">Define an `EFConfigurationValue` entity for storing configuration values in the database.</span></span>

<span data-ttu-id="487c4-680">*Models/EFConfigurationValue.cs*:</span><span class="sxs-lookup"><span data-stu-id="487c4-680">*Models/EFConfigurationValue.cs*:</span></span>
...
<span data-ttu-id="487c4-681">Agregue un `EFConfigurationContext` para almacenar y tener acceso a los valores configurados.</span><span class="sxs-lookup"><span data-stu-id="487c4-681">Add an `EFConfigurationContext` to store and access the configured values.</span></span>

<span data-ttu-id="487c4-682">*EFConfigurationProvider/EFConfigurationContext.cs*:</span><span class="sxs-lookup"><span data-stu-id="487c4-682">*EFConfigurationProvider/EFConfigurationContext.cs*:</span></span>
...
<span data-ttu-id="487c4-683">Cree una clase que implemente <xref:Microsoft.Extensions.Configuration.IConfigurationSource>.</span><span class="sxs-lookup"><span data-stu-id="487c4-683">Create a class that implements <xref:Microsoft.Extensions.Configuration.IConfigurationSource>.</span></span>

<span data-ttu-id="487c4-684">*EFConfigurationProvider/EFConfigurationSource.cs*:</span><span class="sxs-lookup"><span data-stu-id="487c4-684">*EFConfigurationProvider/EFConfigurationSource.cs*:</span></span>
...
<span data-ttu-id="487c4-685">Cree el proveedor de configuración personalizado heredando de <xref:Microsoft.Extensions.Configuration.ConfigurationProvider>.</span><span class="sxs-lookup"><span data-stu-id="487c4-685">Create the custom configuration provider by inheriting from <xref:Microsoft.Extensions.Configuration.ConfigurationProvider>.</span></span> <span data-ttu-id="487c4-686">El proveedor de configuración inicializa la base de datos cuando está vacía.</span><span class="sxs-lookup"><span data-stu-id="487c4-686">The configuration provider initializes the database when it's empty.</span></span>

<span data-ttu-id="487c4-687">*EFConfigurationProvider/EFConfigurationProvider.cs*:</span><span class="sxs-lookup"><span data-stu-id="487c4-687">*EFConfigurationProvider/EFConfigurationProvider.cs*:</span></span>
...
<span data-ttu-id="487c4-688">Un método de extensión `AddEFConfiguration` permite agregar el origen de configuración a un `ConfigurationBuilder`.</span><span class="sxs-lookup"><span data-stu-id="487c4-688">An `AddEFConfiguration` extension method permits adding the configuration source to a `ConfigurationBuilder`.</span></span>

<span data-ttu-id="487c4-689">*Extensions/EntityFrameworkExtensions.cs*:</span><span class="sxs-lookup"><span data-stu-id="487c4-689">*Extensions/EntityFrameworkExtensions.cs*:</span></span>
...
<span data-ttu-id="487c4-690">En el código siguiente se muestra cómo puede usar el `EFConfigurationProvider` personalizado en *Program.cs*:</span><span class="sxs-lookup"><span data-stu-id="487c4-690">The following code shows how to use the custom `EFConfigurationProvider` in *Program.cs*:</span></span>
...
## <a name="access-configuration-during-startup"></a><span data-ttu-id="487c4-691">Acceso a la configuración durante el inicio</span><span class="sxs-lookup"><span data-stu-id="487c4-691">Access configuration during startup</span></span>

<span data-ttu-id="487c4-692">Inserte `IConfiguration` en el constructor `Startup` para acceder a los valores de configuración en `Startup.ConfigureServices`.</span><span class="sxs-lookup"><span data-stu-id="487c4-692">Inject `IConfiguration` into the `Startup` constructor to access configuration values in `Startup.ConfigureServices`.</span></span> <span data-ttu-id="487c4-693">Para acceder a la configuración en `Startup.Configure`, inserte `IConfiguration` directamente en el método o use la instancia desde el constructor:</span><span class="sxs-lookup"><span data-stu-id="487c4-693">To access configuration in `Startup.Configure`, either inject `IConfiguration` directly into the method or use the instance from the constructor:</span></span>
...
<span data-ttu-id="487c4-694">Para un ejemplo de cómo acceder a la configuración a través de métodos de conveniencia de inicio, consulte [Inicio de la aplicación: Métodos de conveniencia](xref:fundamentals/startup#convenience-methods).</span><span class="sxs-lookup"><span data-stu-id="487c4-694">For an example of accessing configuration using startup convenience methods, see [App startup: Convenience methods](xref:fundamentals/startup#convenience-methods).</span></span>

## <a name="access-configuration-in-a-razor-pages-page-or-mvc-view"></a><span data-ttu-id="487c4-695">Acceso a la configuración en una página de Razor Pages o en una vista de MVC.</span><span class="sxs-lookup"><span data-stu-id="487c4-695">Access configuration in a Razor Pages page or MVC view</span></span>

<span data-ttu-id="487c4-696">Para obtener acceso a los valores de configuración en una página de Razor Pages o una vista de MVC, agregue una [directiva using](xref:mvc/views/razor#using) ([referencia de C#: directiva using](/dotnet/csharp/language-reference/keywords/using-directive)) para el [espacio de nombres Microsoft.Extensions.Configuration](xref:Microsoft.Extensions.Configuration) e inyecte <xref:Microsoft.Extensions.Configuration.IConfiguration> en la página o en la vista.</span><span class="sxs-lookup"><span data-stu-id="487c4-696">To access configuration settings in a Razor Pages page or an MVC view, add a [using directive](xref:mvc/views/razor#using) ([C# reference: using directive](/dotnet/csharp/language-reference/keywords/using-directive)) for the [Microsoft.Extensions.Configuration namespace](xref:Microsoft.Extensions.Configuration) and inject <xref:Microsoft.Extensions.Configuration.IConfiguration> into the page or view.</span></span>

<span data-ttu-id="487c4-697">En una página de las páginas de Razor:</span><span class="sxs-lookup"><span data-stu-id="487c4-697">In a Razor Pages page:</span></span>
...
<span data-ttu-id="487c4-698">En una vista de MVC:</span><span class="sxs-lookup"><span data-stu-id="487c4-698">In an MVC view:</span></span>
...
## <a name="add-configuration-from-an-external-assembly"></a><span data-ttu-id="487c4-699">Agregar configuración a partir de un ensamblado externo</span><span class="sxs-lookup"><span data-stu-id="487c4-699">Add configuration from an external assembly</span></span>

<span data-ttu-id="487c4-700">Una implementación de <xref:Microsoft.AspNetCore.Hosting.IHostingStartup> permite agregar mejoras a una aplicación al iniciarla a partir de un ensamblado externo fuera de la clase `Startup` de esta.</span><span class="sxs-lookup"><span data-stu-id="487c4-700">An <xref:Microsoft.AspNetCore.Hosting.IHostingStartup> implementation allows adding enhancements to an app at startup from an external assembly outside of the app's `Startup` class.</span></span> <span data-ttu-id="487c4-701">Para obtener más información, vea <xref:fundamentals/configuration/platform-specific-configuration>.</span><span class="sxs-lookup"><span data-stu-id="487c4-701">For more information, see <xref:fundamentals/configuration/platform-specific-configuration>.</span></span>

## <a name="additional-resources"></a><span data-ttu-id="487c4-702">Recursos adicionales</span><span class="sxs-lookup"><span data-stu-id="487c4-702">Additional resources</span></span>

* <xref:fundamentals/configuration/options>
* <span data-ttu-id="487c4-703">[Deep Dive into Microsoft Configuration](https://www.paraesthesia.com/archive/2018/06/20/microsoft-extensions-configuration-deep-dive/) (Profundización en la configuración de Microsoft)</span><span class="sxs-lookup"><span data-stu-id="487c4-703">[Deep Dive into Microsoft Configuration](https://www.paraesthesia.com/archive/2018/06/20/microsoft-extensions-configuration-deep-dive/)</span></span>
