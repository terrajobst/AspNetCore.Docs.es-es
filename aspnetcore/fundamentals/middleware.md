...
Por [Rick Anderson](https://twitter.com/RickAndMSFT) y [Steve Smith](http://ardalis.com)

[Ver o descargar el código de ejemplo](https://github.com/aspnet/Docs/tree/master/aspnetcore/fundamentals/middleware/sample)
...
| [Las respuestas en caché](xref:performance/caching/middleware) | Proporciona compatibilidad para almacenar en caché las respuestas. |
...
* [Migrar módulos HTTP de middleware](../migration/http-modules.md)
* [Inicio de aplicaciones](startup.md)
* [Características de solicitud](request-features.md)
