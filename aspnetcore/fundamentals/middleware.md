...
---
# <a name="aspnet-core-middleware-fundamentals"></a>Conceptos básicos del middleware de ASP.NET Core
...
En [Migrating HTTP Modules to Middleware](../migration/http-modules.md) (Migración de módulos HTTP a middleware) se explica la diferencia entre las canalizaciones de solicitudes en ASP.NET Core y versiones anteriores, y se proporcionan más ejemplos de middleware.
...
* [Ejemplo de código usado en este documento](https://github.com/aspnet/Docs/tree/master/aspnetcore/fundamentals/middleware/sample)
