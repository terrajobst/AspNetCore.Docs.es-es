...
En este artículo se da por supuesto que el lector está familiarizado con los temas tratados en [Introducción](xref:signalr/get-started).
...
* [Primeros pasos](xref:signalr/get-started)
