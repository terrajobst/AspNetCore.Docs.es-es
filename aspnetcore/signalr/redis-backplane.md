...
* En la aplicación de SignalR, instale el `Microsoft.AspNetCore.SignalR.Redis` paquete NuGet.
...
* En la aplicación de SignalR, instale el `Microsoft.AspNetCore.SignalR.StackExchangeRedis` paquete NuGet.
