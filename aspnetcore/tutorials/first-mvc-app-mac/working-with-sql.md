---
title: Trabajar con SQLite y ASP.NET Core MVC
...
<span data-ttu-id="82cff-104">[Anterior: Agregar un modelo](adding-model.md)
[Siguiente: Vistas y métodos de controlador](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="82cff-104">[Previous - Add a model](adding-model.md)
