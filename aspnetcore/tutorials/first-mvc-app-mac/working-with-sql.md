...
<span data-ttu-id="f62b2-104">[Anterior: Agregar un modelo](adding-model.md)
[Siguiente: Vistas y métodos de controlador](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="f62b2-104">[Previous - Add a model](adding-model.md)
