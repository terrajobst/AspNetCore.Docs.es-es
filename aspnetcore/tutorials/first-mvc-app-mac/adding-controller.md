...
---
# <a name="adding-a-controller-to-an-aspnet-core-mvc-app-with-visual-studio-for-mac"></a>Adición de un controlador a una aplicación de ASP.NET Core MVC con Visual Studio para Mac
