...
> <span data-ttu-id="cbfc3-103">[Anterior: Agregar un campo](new-field.md)
> [Siguiente: Examinar los métodos Details y Delete](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="cbfc3-103">[Previous - Add a field](new-field.md)
