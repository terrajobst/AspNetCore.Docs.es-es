...
> <span data-ttu-id="00247-103">[Anterior: Agregar un campo](new-field.md)
> [Siguiente: Examinar los métodos Details y Delete](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="00247-103">[Previous - Add a field](new-field.md)
