...
ms.locfileid: "30895043"
---
[!INCLUDE [adding-model](../../includes/mvc-intro/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="ce720-103">[Anterior: Agregar un modelo](adding-model.md)
> [Siguiente: Vistas y métodos de controlador](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="ce720-103">[Previous - Add a model](adding-model.md)
