...
ms.locfileid: "36960728"
---
[!INCLUDE [adding-model](../../includes/mvc-intro/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="92746-103">[Anterior: Agregar un modelo](adding-model.md)
> [Siguiente: Vistas y métodos de controlador](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="92746-103">[Previous - Add a model](adding-model.md)
