...
Descargue la [aplicación de ejemplo](https://github.com/aspnet/Docs/tree/master/aspnetcore/tutorials/dotnet-watch/sample). Consta de dos proyectos: *WebApp* (una ASP.NET Core Web API) y *WebAppTests* (pruebas unitarias para la API web).
...
`dotnet-watch` forma parte del [repositorio de DotNetTools](https://github.com/aspnet/DotNetTools/tree/master/src/dotnet-watch) de GitHub.
