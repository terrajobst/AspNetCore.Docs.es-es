...
> <span data-ttu-id="8991b-103">[Anterior: Trabajar con SQLite](xref:tutorials/razor-pages-mac/sql)
> [Agregar búsqueda](xref:tutorials/razor-pages-mac/search)</span><span class="sxs-lookup"><span data-stu-id="8991b-103">[Previous: Work with SQLlite](xref:tutorials/razor-pages-mac/sql)
