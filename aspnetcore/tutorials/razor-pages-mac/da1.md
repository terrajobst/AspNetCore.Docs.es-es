...
> <span data-ttu-id="88be2-103">[Anterior: Trabajar con SQLite](xref:tutorials/razor-pages-mac/sql)
> [Agregar búsqueda](xref:tutorials/razor-pages-mac/search)</span><span class="sxs-lookup"><span data-stu-id="88be2-103">[Previous: Work with SQLlite](xref:tutorials/razor-pages-mac/sql)
