...
<span data-ttu-id="57eef-103">[Anterior: Trabajar con SQLite](xref:tutorials/razor-pages-mac/sql)
[Adición de búsqueda](xref:tutorials/razor-pages-mac/search)</span><span class="sxs-lookup"><span data-stu-id="57eef-103">[Previous: Working with SQLlite](xref:tutorials/razor-pages-mac/sql)
