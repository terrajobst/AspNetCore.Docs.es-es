...
ms.openlocfilehash: d298acf167661c6cdd009fac29937f80eeb933dc
...
En esta serie, se explican los conceptos básicos de la creación de una aplicación web de páginas de Razor con ASP.NET Core.

1. [Introducción a las páginas de Razor](xref:tutorials/razor-pages/razor-pages-start)
1. [Adición de un modelo a una aplicación de páginas de Razor](xref:tutorials/razor-pages/modelz)
...
1. [Actualización de las páginas generadas](xref:tutorials/razor-pages/da1)
