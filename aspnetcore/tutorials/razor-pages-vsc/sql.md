...
<span data-ttu-id="7f230-103">[Anterior: Adición de un modelo](xref:tutorials/razor-pages-vsc/model)
[Siguiente: Actualización de páginas](xref:tutorials/razor-pages-vsc/da1)</span><span class="sxs-lookup"><span data-stu-id="7f230-103">[Previous: Adding a model](xref:tutorials/razor-pages-vsc/model)
