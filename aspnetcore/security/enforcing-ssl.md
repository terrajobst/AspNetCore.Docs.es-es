...
`UseHsts` no se recomienda en el desarrollo porque el encabezado HSTS es alta almacenable en caché exploradores. De forma predeterminada, `UseHsts` excluye la dirección de bucle invertido local.
