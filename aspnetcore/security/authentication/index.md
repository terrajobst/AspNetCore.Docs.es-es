...
La autorización llama a una acción de prohibición del esquema de autenticación cuando un usuario autenticado intenta tener acceso a un recurso para el que no tiene permiso de acceso. Vea `HttpContext.ForbidAsync`. Ejemplos de prohibición de autenticación:
