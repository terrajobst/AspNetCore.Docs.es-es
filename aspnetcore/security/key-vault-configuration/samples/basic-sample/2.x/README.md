# <a name="key-vault-configuration-provider-sample-application-aspnet-core-2x"></a>Aplicación de ejemplo de proveedor de configuración de almacén de claves (ASP.NET Core 2.x)

Este ejemplo ilustra el uso del proveedor de configuración de almacén de claves de Azure para ASP.NET Core 2.x. Para obtener el ejemplo de 1.x ASP.NET Core, vea [aplicación de ejemplo de proveedor de configuración de almacén de claves (ASP.NET Core 1.x)](https://github.com/aspnet/Docs/tree/master/aspnetcore/security/key-vault-configuration/samples/basic-sample/1.x).
