# <a name="prefix-key-vault-configuration-provider-sample-application-aspnet-core-1x"></a>Aplicación de ejemplo de proveedor de configuración de almacén de claves del prefijo (ASP.NET Core 1.x)
