...
Si desea especificar los esquemas deseados en [directiva](xref:security/authorization/policies#security-authorization-policies-based), puede establecer el `AuthenticationSchemes` colección cuando se agrega la directiva:
