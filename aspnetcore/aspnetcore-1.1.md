...
- [Middleware de reescritura de dirección URL](https://docs.microsoft.com/aspnet/core/fundamentals/url-rewriting)
- [Middleware de almacenamiento en caché de respuestas](https://docs.microsoft.com/aspnet/core/performance/caching/middleware)
...
- [Proveedor TempData basado en cookies](xref:fundamentals/app-state#cookie-based-tempdata-provider )
- [Proveedor de registros de Azure App Service](xref:fundamentals/logging#appservice)
...
- Si quiere estar en contacto con el progreso y los planes del equipo de desarrollo de ASP.NET Core, sintonice [ASP.NET Community Standup](https://live.asp.net/) cada semana.
