...
Un *marco compartido* es un conjunto de ensamblados (*.dll* archivos) que no están en carpetas de la aplicación. El marco de trabajo compartido debe instalarse en el equipo para ejecutar la aplicación. Para obtener más información, consulte [marco compartido](https://natemcmaster.com/blog/2018/08/29/netcore-primitives-2/).
