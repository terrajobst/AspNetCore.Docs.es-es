...
En 3,0, la compilación en tiempo de ejecución es un escenario de participación. Para habilitar la compilación en tiempo de ejecución, vea <xref:mvc/views/view-compilation#runtime-compilation>.
