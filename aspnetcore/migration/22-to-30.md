...
* se quitó <xref:Microsoft.AspNetCore.Server.Kestrel.Transport.Abstractions.Internal.SchedulingMode> de <xref:Microsoft.AspNetCore.Server.Kestrel.KestrelServerOptions>.
...
Hay disponibles tres nuevos métodos de extensión de nivel superior relacionados con los escenarios MVC en `IServiceCollection`. Las plantillas usan estos nuevos métodos en lugar de `UseMvc`. Sin embargo, `AddMvc` continúa comportándose como tiene en las versiones anteriores.
