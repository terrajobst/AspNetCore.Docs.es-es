...
El sistema de validación en .NET Core 3,0 y versiones posteriores trata los parámetros que no aceptan valores NULL o las propiedades enlazadas como si tuvieran un atributo `[Required]`. Para obtener más información, vea el [atributo [required]](xref:mvc/models/validation?view=aspnetcore-3.1#required-attribute).
