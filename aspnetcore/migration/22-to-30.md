...
También se pueden personalizar las directivas. Basándose en el ejemplo anterior, el `DefaultPolicy` se configura para requerir autenticación y un ámbito específico:
