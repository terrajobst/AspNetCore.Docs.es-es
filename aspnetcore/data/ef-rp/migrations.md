...
Para el desarrollo inicial, el `EnsureCreated` se utilizó el comando. En este tutorial, se usa las migraciones. `EnsureCreated`tiene la limatitions siguientes:
