...
Ejecutar la aplicación, seleccione la **estudiantes** ficha y haga clic en el **Last Name** y **fecha de inscripción** funciona encabezados de columna para comprobar que la ordenación.
...
Ejecute la aplicación y vaya a la página de los alumnos.
...
Ejecute la aplicación y vaya a la página acerca de. El número de alumnos para cada fecha de inscripción se muestra en una tabla.
