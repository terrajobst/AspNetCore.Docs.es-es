<span data-ttu-id="f69a0-101">Ejecute los siguientes comandos CLI de .NET Core:</span><span class="sxs-lookup"><span data-stu-id="f69a0-101">Run the following .NET Core CLI commands:</span></span>
