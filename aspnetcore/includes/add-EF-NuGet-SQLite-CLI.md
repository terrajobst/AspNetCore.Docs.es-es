<span data-ttu-id="ed4e4-101">Ejecute los siguientes comandos CLI de .NET Core:</span><span class="sxs-lookup"><span data-stu-id="ed4e4-101">Run the following .NET Core CLI commands:</span></span>
