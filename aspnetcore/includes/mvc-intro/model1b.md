<span data-ttu-id="3f353-101">Agregue las propiedades siguientes a la clase `Movie`:</span><span class="sxs-lookup"><span data-stu-id="3f353-101">Add the following properties to the `Movie` class:</span></span>
