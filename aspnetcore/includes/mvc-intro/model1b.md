<span data-ttu-id="f59d1-101">Agregue las propiedades siguientes a la clase `Movie`:</span><span class="sxs-lookup"><span data-stu-id="f59d1-101">Add the following properties to the `Movie` class:</span></span>
