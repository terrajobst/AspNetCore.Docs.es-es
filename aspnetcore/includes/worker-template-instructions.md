# <a name="visual-studiotabvisual-studio"></a>[<span data-ttu-id="6b3ff-101">Visual Studio</span><span class="sxs-lookup"><span data-stu-id="6b3ff-101">Visual Studio</span></span>](#tab/visual-studio)
