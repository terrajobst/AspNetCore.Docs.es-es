<span data-ttu-id="48470-101">Agregue las propiedades siguientes a la clase `Movie`:</span><span class="sxs-lookup"><span data-stu-id="48470-101">Add the following properties to the `Movie` class:</span></span>
