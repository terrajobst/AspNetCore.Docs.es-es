...
Haga clic con el botón derecho en una línea ondulada roja > **Acciones rápidas y refactorizaciones** en el atributo `[Column]` y seleccione `using System.ComponentModel.DataAnnotations.Schema;`.
