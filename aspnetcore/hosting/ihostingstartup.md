...
[Vea o descargue el código de ejemplo](https://github.com/aspnet/Docs/tree/master/aspnetcore/hosting/ihostingstartup/sample/) ([cómo descargarlo](xref:tutorials/index#how-to-download-a-sample))
...
El [aplicación de ejemplo](https://github.com/aspnet/Docs/tree/master/aspnetcore/hosting/ihostingstartup/sample/) ([cómo descargar](xref:tutorials/index#how-to-download-a-sample)) usa `IHostingStartup` para crear una herramienta de diagnóstico. La herramienta agrega dos middlewares a la aplicación en el inicio que proporcionan información de diagnóstico:
