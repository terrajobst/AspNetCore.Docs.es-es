...
Pase el registrador para la conexión para iniciar el registro. Herramientas de desarrollo de explorador normalmente contienen una consola que muestra los mensajes.
