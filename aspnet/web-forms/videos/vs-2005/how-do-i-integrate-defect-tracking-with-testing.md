...
---
<a name="how-do-i-integrate-defect-tracking-with-testing"></a>[¿Cómo lo hago?:] ¿Integrar el seguimiento de defectos con las pruebas?
====================
por [Chris Menegay](https://twitter.com/CMenegay)

En este vídeo, echamos un vistazo a los puntos de integración entre las pruebas de marco de trabajo de Visual Studio Team System y el sistema de seguimiento de elemento de trabajo.
