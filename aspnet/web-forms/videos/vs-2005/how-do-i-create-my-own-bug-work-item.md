...
ms.locfileid: "30896275"
---
<a name="how-do-i-create-my-own-bug-work-item"></a>[¿Cómo I:] ¿Crear mi propio elemento de trabajo?
====================
por [Chris Menegay](https://twitter.com/CMenegay)

Este vídeo muestra cómo crear su propia definición de elemento de trabajo de error para su uso en Visual Studio Team System. Veremos cómo se define un elemento de trabajo mediante un archivo XML que se puede modificar manualmente con el fin de agregar, quitar o modificar los campos, los flujos de trabajo y los formularios asociados a un determinado tipo de elemento de trabajo.
