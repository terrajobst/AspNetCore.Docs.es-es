...
---
<a name="troubleshooting-production-aspnet-apps"></a>Solución de problemas de producción las aplicaciones ASP.NET
====================
por [Joe Stagner](https://github.com/JoeStagner)

Este vídeo proporciona un inventario rápido de herramientas para solucionar problemas de las aplicaciones de ASP.NET de producción.
