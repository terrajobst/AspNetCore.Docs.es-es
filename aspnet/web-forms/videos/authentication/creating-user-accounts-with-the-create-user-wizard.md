...
ms.locfileid: "30884547"
---
<a name="creating-user-accounts-with-the-create-user-wizard"></a>Crear cuentas de usuario con el Asistente para crear usuario
====================
por [Joe Stagner](https://github.com/JoeStagner)

En este vídeo, Joe Stagner muestra cómo crear usuarios con el Asistente para crear usuario incluido en la colección de controles de inicio de sesión de ASP.NET y Visual Studio. Para obtener información adicional acerca de este vídeo, lea el tutorial de seguridad "Crear cuentas de usuario" ([C#](../../overview/older-versions-security/membership/creating-user-accounts-cs.md), [VB](../../overview/older-versions-security/membership/creating-user-accounts-vb.md)).
