...
El control del extensor AutoComplete de ASP.NET AJAX Control Toolkit proporciona sugerencias en tiempo real para el usuario como tipos piensan en un cuadro de texto en la página Web, donde se obtiene la lista de sugerencias por una llamada asincrónica a un servicio Web en el servidor.
