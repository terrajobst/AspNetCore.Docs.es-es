...
---
<a name="how-do-i-get-started-with-the-aspnet-ajax-animation-extender-control"></a>[¿Cómo I:] ¿Empezar a trabajar con el Control extensor ASP.NET AJAX animación?
====================
por [Joe Stagner](https://github.com/JoeStagner)

Este vídeo presenta el control extensor de animación de ASP.NET AJAX Control Toolkit, que proporciona a los desarrolladores un marco de trabajo totalmente extensible para agregar efectos de animación a una página Web ASP.NET.
