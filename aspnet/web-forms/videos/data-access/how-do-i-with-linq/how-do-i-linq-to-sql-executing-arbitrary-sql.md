...
---
<a name="how-do-i-linq-to-sql-executing-arbitrary-sql"></a>¿Cómo lo hago?: LINQ to SQL: ejecutar SQL arbitrario
====================
por [Scott Stanfield](https://github.com/scottstanfield)

Este vídeo muestra cómo ejecutar SQL arbitrario mediante la sintaxis de ExecuteCommand y encapsular el código a través de la clase parcial de DataContext.
