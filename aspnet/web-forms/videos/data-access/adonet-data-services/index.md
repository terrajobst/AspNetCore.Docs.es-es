...
====================
> Estos vídeos enseña cómo crear una capa de acceso a datos mediante un conjunto de datos con tipo para una aplicación ASP.NET simple.


- [Niveles de acceso a datos en aplicaciones ASP.NET](data-access-layers-in-aspnet-applications.md)
- [Enlazar manualmente un conjunto de datos a un control Datagrid](how-to-manually-bind-a-dataset-to-a-datagrid.md)
- [Trabajar con conjuntos de datos y los filtros de una aplicación ASP](how-to-work-with-datasets-and-filters-from-an-asp-application.md)
