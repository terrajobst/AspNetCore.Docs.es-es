...
ms.locfileid: "41835706"
---
<a name="tailspin-spyworks---adding-user-product-reviews"></a>Tailspin Spyworks - agregar reseñas de productos de usuario
====================
por [Joe Stagner](https://github.com/JoeStagner)

Joe Stagner agrega las revisiones de los clientes a la página de detalles del producto en la aplicación de formularios Web Forms de ejemplo Tailspin Spyworks.

[&#9654;Vea el vídeo (41 minutos)](https://channel9.msdn.com/Blogs/ASP-NET-Site-Videos/tailspin-spyworks-adding-user-product-reviews)
