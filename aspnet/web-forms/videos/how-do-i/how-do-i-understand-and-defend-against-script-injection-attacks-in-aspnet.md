...
---
<a name="how-do-i-understand-and-defend-against-script-injection-attacks-in-aspnet"></a>Cómo entender y defenderse contra la inyección de Script ataques en ASP.NET
====================
por [Joe Stagner](https://github.com/JoeStagner)

Cross Site Scripting (XSS) es quizás el problema de seguridad más problemático para los desarrolladores web a abordar hoy en día. En este vídeo, Joe Stagner de Microsoft proporciona algunos ejemplos de cómo peligroso XSS pueden ser realmente y cómo ASP.NET le ayuda a defenderse fácilmente XSS en sus aplicaciones Web.
