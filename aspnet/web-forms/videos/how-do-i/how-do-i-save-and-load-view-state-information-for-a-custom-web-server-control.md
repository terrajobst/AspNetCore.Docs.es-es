...
En este vídeo Chris Pels mostrará cómo conservar y restaurar la información en el estado de vista de un control de usuario personalizado. En primer lugar, obtenga información acerca de cómo conservar valores simples que contiene los tipos primitivos de .NET como etcetera Boolean, String, Int32. A continuación, consulte how to conservar tipos complejos como clases que contienen propiedades de almacenamiento de información. También se describe la secuencia de procesamiento de información de estado de vista durante el ciclo de vida de una página ASP.NET.
