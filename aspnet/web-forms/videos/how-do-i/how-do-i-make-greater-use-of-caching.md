...
---
<a name="how-do-i-make-greater-use-of-caching"></a>[¿Cómo I:] ¿Hacer un uso mayor de almacenamiento en caché?
====================
por [Microsoft](https://github.com/microsoft)

Ver una demostración de la caché de resultados parcial de página, seguido de una descripción general de la API de caché que se muestra cómo enlazar eficazmente un control de presentación de datos en un archivo XML.
