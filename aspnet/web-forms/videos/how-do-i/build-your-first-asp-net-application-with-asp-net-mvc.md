...
---
<a name="build-your-first-aspnet-application-with-aspnet-mvc"></a>Cree su primera aplicación de ASP.NET con ASP.NET MVC
====================
por [Laurence Moroney de Microsoft](https://github.com/lmoroney)

Microsoft Laurence Moroney muestra cómo crear su primera aplicación de ASP.NET con ASP.NET MVC.
