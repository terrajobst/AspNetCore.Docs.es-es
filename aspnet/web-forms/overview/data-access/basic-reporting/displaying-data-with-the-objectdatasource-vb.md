...
ms.locfileid: "37400673"
---
<a name="displaying-data-with-the-objectdatasource-vb"></a>Visualización de datos con ObjectDataSource (VB)
====================
...
**Figura 6**: un control GridView se ha agregado a la página y se enlaza a ObjectDataSource ([haga clic aquí para ver imagen en tamaño completo](displaying-data-with-the-objectdatasource-vb/_static/image16.png))
...
**Figura 8**: se han personalizado el control GridView BoundFields ([haga clic aquí para ver imagen en tamaño completo](displaying-data-with-the-objectdatasource-vb/_static/image22.png))
...
**Figura 10**: permitir que Visual Studio crea el `App_Theme` carpeta ([haga clic aquí para ver imagen en tamaño completo](displaying-data-with-the-objectdatasource-vb/_static/image28.png))
...
**Figura 12**: GridView muestra el nombre, categoría, proveedor, precio y no incluye información del producto ([haga clic aquí para ver imagen en tamaño completo](displaying-data-with-the-objectdatasource-vb/_static/image32.png))
...
**Figura 16**: con paginación habilitado, DetailsView permite al usuario ver cualquiera de los productos ([haga clic aquí para ver imagen en tamaño completo](displaying-data-with-the-objectdatasource-vb/_static/image44.png))
...
**Figura 17**: The FormView debe incluir un `ItemTemplate` ([haga clic aquí para ver imagen en tamaño completo](displaying-data-with-the-objectdatasource-vb/_static/image47.png))
