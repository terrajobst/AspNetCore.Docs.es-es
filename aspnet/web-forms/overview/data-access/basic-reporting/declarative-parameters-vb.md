...
**Figura 4**: A Hard-Coded parámetro de valor de 5 se utilizará para el `productID` parámetro ([haga clic aquí para ver imagen en tamaño completo](declarative-parameters-vb/_static/image12.png))
...
**Figura 6**: agregar un cuadro de texto a la página con `ID` `CountryName` ([haga clic aquí para ver imagen en tamaño completo](declarative-parameters-vb/_static/image18.png))
