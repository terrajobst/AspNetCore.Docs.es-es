...
**Figura 1**: objeto GridView edición interfaz incluye DropDownLists y botones de opción ([haga clic aquí para ver imagen en tamaño completo](customizing-the-data-modification-interface-vb/_static/image3.png))
...
**Figura 4**: interfaz de solo lectura del objeto GridView es Complete ([haga clic aquí para ver imagen en tamaño completo](customizing-the-data-modification-interface-vb/_static/image12.png))
...
**Figura 9**: se selecciona el primer elemento de la lista desplegable se muestran de forma predeterminada ([haga clic aquí para ver imagen en tamaño completo](customizing-the-data-modification-interface-vb/_static/image27.png))
...
**Figura 11**: The editado del producto categoría actual y los valores del proveedor se seleccionan de forma predeterminada ([haga clic aquí para ver imagen en tamaño completo](customizing-the-data-modification-interface-vb/_static/image33.png))
...
**Figura 13**: agregar activas y no incluye opciones para RadioButtonList ([haga clic aquí para ver imagen en tamaño completo](customizing-the-data-modification-interface-vb/_static/image39.png))
...
**Figura 14**: The no incluye las casillas de verificación se reemplazaron por pares de botón de Radio ([haga clic aquí para ver imagen en tamaño completo](customizing-the-data-modification-interface-vb/_static/image42.png))
