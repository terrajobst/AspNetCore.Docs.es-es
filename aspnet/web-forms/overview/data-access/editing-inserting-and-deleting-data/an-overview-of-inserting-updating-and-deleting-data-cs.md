...
**Figura 1**: el origen ObjectDataSource `Insert()`, `Update()`, y `Delete()` métodos actuar como un Proxy en la capa BLL ([haga clic aquí para ver imagen en tamaño completo](an-overview-of-inserting-updating-and-deleting-data-cs/_static/image3.png))
...
**Figura 8**: asignar de ObjectDataSource `Insert()` método a la `ProductBLL` Add de la clase `Product` método ([haga clic aquí para ver imagen en tamaño completo](an-overview-of-inserting-updating-and-deleting-data-cs/_static/image20.png))
...
**Figura 14**: eliminar todos los registros de la `Order Details` tabla ([haga clic aquí para ver imagen en tamaño completo](an-overview-of-inserting-updating-and-deleting-data-cs/_static/image36.png))
...
**Figura 16**: s Chai haciendo clic en botón Editar muestra la fila en modo de edición ([haga clic aquí para ver imagen en tamaño completo](an-overview-of-inserting-updating-and-deleting-data-cs/_static/image40.png))
...
**Figura 22**: The FormView predeterminada `ItemTemplate` enumera cada producto campo junto con nuevo, editar y eliminar botones ([haga clic aquí para ver imagen en tamaño completo](an-overview-of-inserting-updating-and-deleting-data-cs/_static/image56.png))
