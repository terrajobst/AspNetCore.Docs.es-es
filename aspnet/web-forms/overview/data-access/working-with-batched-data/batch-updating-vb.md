...
Primero se realiza una llamada a `BatchUpdate`. Después, el [ `ClientScript` propiedad](https://msdn.microsoft.com/en-us/library/system.web.ui.page.clientscript(VS.80).aspx) se utiliza para insertar código JavaScript que se mostrará un cuadro de mensajes que lee los productos se han actualizado.
