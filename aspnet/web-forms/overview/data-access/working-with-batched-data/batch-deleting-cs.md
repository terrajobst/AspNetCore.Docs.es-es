...
**Figura 5**: los productos eliminado `ProductID` valores son aparecen bajo la GridView ([haga clic aquí para ver la imagen a tamaño completo](batch-deleting-cs/_static/image10.png))
