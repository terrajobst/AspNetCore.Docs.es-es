...
ms.locfileid: "37829064"
---
<a name="batch-inserting-c"></a>Lote de inserción (C#)
====================
...
**Figura 2**: arrastrar un Panel desde el cuadro de herramientas hasta el diseñador ([haga clic aquí para ver imagen en tamaño completo](batch-inserting-cs/_static/image6.png))
...
**Figura 6**: la interfaz de la inserción se compone de una tabla de una fila de siete de cuatro columnas ([haga clic aquí para ver imagen en tamaño completo](batch-inserting-cs/_static/image18.png))
...
**Figura 8**: mostrar la `CompanyName` campo de datos y Use `SupplierID` como el valor ([haga clic aquí para ver imagen en tamaño completo](batch-inserting-cs/_static/image24.png))
...
**Figura 12**: la interfaz de la inserción se muestra al hacer clic en el botón de envío del producto de proceso ([haga clic aquí para ver imagen en tamaño completo](batch-inserting-cs/_static/image36.png))
