...
ms.locfileid: "30880172"
---
<a name="adding-a-gridview-column-of-checkboxes-c"></a>Agregar una columna de GridView de casillas de verificación (C#)
====================
por [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Descargar la aplicación de ejemplo](http://download.microsoft.com/download/4/a/7/4a7a3b18-d80e-4014-8e53-a6a2427f0d93/ASPNET_Data_Tutorial_52_CS.exe) o [descarga de PDF](adding-a-gridview-column-of-checkboxes-cs/_static/datatutorial52cs1.pdf)
...
**Figura 1**: cada fila del producto incluye una casilla de verificación ([haga clic aquí para ver la imagen a tamaño completo](adding-a-gridview-column-of-checkboxes-cs/_static/image2.png))
...
**Figura 2**: crear un nuevo ObjectDataSource denominado `ProductsDataSource` ([haga clic aquí para ver la imagen a tamaño completo](adding-a-gridview-column-of-checkboxes-cs/_static/image4.png))


[![Configurar el ObjectDataSource para recuperar datos mediante el método GetProducts()](adding-a-gridview-column-of-checkboxes-cs/_static/image3.gif)](adding-a-gridview-column-of-checkboxes-cs/_static/image5.png)

**Figura 3**: configurar el ObjectDataSource para recuperar datos mediante el `GetProducts()` método ([haga clic aquí para ver la imagen a tamaño completo](adding-a-gridview-column-of-checkboxes-cs/_static/image6.png))


[![Establece las listas de lista desplegable en la actualización, INSERCIÓN y eliminar las pestañas en (ninguno)](adding-a-gridview-column-of-checkboxes-cs/_static/image4.gif)](adding-a-gridview-column-of-checkboxes-cs/_static/image7.png)

**Figura 4**: establecer las listas de lista desplegable en la actualización, INSERCIÓN y eliminar pestañas en (ninguno) ([haga clic aquí para ver la imagen a tamaño completo](adding-a-gridview-column-of-checkboxes-cs/_static/image8.png))
...
[![Se muestran el nombre, la categoría y el precio de los diez primeros productos](adding-a-gridview-column-of-checkboxes-cs/_static/image5.gif)](adding-a-gridview-column-of-checkboxes-cs/_static/image9.png)

**Figura 5**: se enumeran el nombre, categoría y precio de los diez primeros productos ([haga clic aquí para ver la imagen a tamaño completo](adding-a-gridview-column-of-checkboxes-cs/_static/image10.png))
...
**Figura 6**: agregar un Control de casilla de verificación Web denominado `ProductSelector` para las operaciones de asignación TemplateField `ItemTemplate` ([haga clic aquí para ver la imagen a tamaño completo](adding-a-gridview-column-of-checkboxes-cs/_static/image12.png))
...
**Figura 7**: cada fila del producto ahora incluye una casilla de verificación ([haga clic aquí para ver la imagen a tamaño completo](adding-a-gridview-column-of-checkboxes-cs/_static/image14.png))
...
[![Cuando se hace clic en el botón Eliminar productos de seleccionado se enumeran el ProductID de productos seleccionado](adding-a-gridview-column-of-checkboxes-cs/_static/image8.gif)](adding-a-gridview-column-of-checkboxes-cs/_static/image15.png)

**Figura 8**: cuando la selecciona productos botón Eliminar se hace clic en los productos seleccionados `ProductID` se enumeran ([haga clic aquí para ver la imagen a tamaño completo](adding-a-gridview-column-of-checkboxes-cs/_static/image16.png))
...
[![Haga clic en la comprobación de que todos los botones selecciona todas las casillas](adding-a-gridview-column-of-checkboxes-cs/_static/image9.gif)](adding-a-gridview-column-of-checkboxes-cs/_static/image17.png)

**Figura 9**: haga clic en la comprobación de todos los botón selecciona todas las casillas ([haga clic aquí para ver la imagen a tamaño completo](adding-a-gridview-column-of-checkboxes-cs/_static/image18.png))
