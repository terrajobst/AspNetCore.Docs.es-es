...
title: Páginas maestras y navegación del sitio (C#) | Documentos de Microsoft
...
[Descargar la aplicación de ejemplo](http://download.microsoft.com/download/4/6/3/463cf87c-4724-4cbc-b7b5-3f866f43ba50/ASPNET_Data_Tutorial_3_CS.exe) o [descarga de PDF](master-pages-and-site-navigation-cs/_static/datatutorial03cs1.pdf)
...
[![Agregar una nueva página maestra al sitio Web](master-pages-and-site-navigation-cs/_static/image6.png)](master-pages-and-site-navigation-cs/_static/image5.png)

**Figura 3**: agregar una nueva página maestra al sitio Web ([haga clic aquí para ver la imagen a tamaño completo](master-pages-and-site-navigation-cs/_static/image7.png))
...
[![La página principal, cuando se ven a través de la vista de diseño](master-pages-and-site-navigation-cs/_static/image9.png)](master-pages-and-site-navigation-cs/_static/image8.png)

**Figura 4**: la página maestra, al ver a través de la vista de diseño ([haga clic aquí para ver la imagen a tamaño completo](master-pages-and-site-navigation-cs/_static/image10.png))
...
[![Agregue un nuevo formulario Web, la comprobación de la casilla de verificación Seleccionar la página principal](master-pages-and-site-navigation-cs/_static/image12.png)](master-pages-and-site-navigation-cs/_static/image11.png)

**Figura 5**: agregar un nuevo formulario Web, la comprobación de la casilla de verificación Seleccionar la página maestra ([haga clic aquí para ver la imagen a tamaño completo](master-pages-and-site-navigation-cs/_static/image13.png))
...
**Figura 6**: elija la página principal de este uso debería de página de ASP.NET ([haga clic aquí para ver la imagen a tamaño completo](master-pages-and-site-navigation-cs/_static/image16.png))
...
[![La vista de diseño de la página ASP.NET muestra las regiones editables y no editables](master-pages-and-site-navigation-cs/_static/image18.png)](master-pages-and-site-navigation-cs/_static/image17.png)

**Figura 7**: la vista de diseño para el ASP.NET página muestra tanto el Editable y no Editable regiones ([haga clic aquí para ver la imagen a tamaño completo](master-pages-and-site-navigation-cs/_static/image19.png))
...
**Figura 9**: agregar un mapa del sitio para el proyecto ([haga clic aquí para ver la imagen a tamaño completo](master-pages-and-site-navigation-cs/_static/image23.png))
...
[![El mapa del sitio representa una estructura jerárquica de navegación](master-pages-and-site-navigation-cs/_static/image25.png)](master-pages-and-site-navigation-cs/_static/image24.png)

**Figura 10**: el mapa del sitio representa una estructura jerárquica de navegación ([haga clic aquí para ver la imagen a tamaño completo](master-pages-and-site-navigation-cs/_static/image26.png))
...
![Menú formado por dos repetidores y varios estilos CSS](master-pages-and-site-navigation-cs/_static/image27.png)
...
![La ruta de navegación muestra la página actual y sus antecesores en el sitio de la jerarquía del mapa](master-pages-and-site-navigation-cs/_static/image28.png)
...
[![Agregar un nuevo Control de usuario Web a la carpeta de controles de usuario](master-pages-and-site-navigation-cs/_static/image30.png)](master-pages-and-site-navigation-cs/_static/image29.png)

**Figura 13**: agregar un nuevo Control de usuario Web para la `UserControls` carpeta ([haga clic aquí para ver la imagen a tamaño completo](master-pages-and-site-navigation-cs/_static/image31.png))
...
[![El Control de usuario tiene que ha agregado a Default.aspx](master-pages-and-site-navigation-cs/_static/image33.png)](master-pages-and-site-navigation-cs/_static/image32.png)

**Figura 14**: el Control de usuario se ha agregado a `Default.aspx` ([haga clic aquí para ver la imagen a tamaño completo](master-pages-and-site-navigation-cs/_static/image34.png))
...
**Figura 15**: se enumeran los tutoriales de Reporting básico ([haga clic aquí para ver la imagen a tamaño completo](master-pages-and-site-navigation-cs/_static/image37.png))
...
Una vez completada la capa de acceso a datos y la capa de lógica empresarial y tener una página coherente diseño y exploración del sitio definido, estamos preparados empezar a explorar patrones comunes de creación de informes. En el [siguiente](../basic-reporting/displaying-data-with-the-objectdatasource-cs.md) tres tutoriales siguientes analizaremos las tareas básicas de informes muestra los datos recuperados de BLL en GridView, DetailsView, y controla de FormView.
