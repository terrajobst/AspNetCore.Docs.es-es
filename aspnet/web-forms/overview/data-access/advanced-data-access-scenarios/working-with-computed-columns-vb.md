...
**Figura 6**: ejecutar el Asistente para configuración para actualizar las columnas de DataTable s s de TableAdapter ([haga clic aquí para ver imagen en tamaño completo](working-with-computed-columns-vb/_static/image18.png))
...
**Figura 10**: el nombre de los métodos de TableAdapter `FillBySupplierID` y `GetSupplierBySupplierID` ([haga clic aquí para ver imagen en tamaño completo](working-with-computed-columns-vb/_static/image30.png))
