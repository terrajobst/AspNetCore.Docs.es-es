...
**Figura 5**: cada distribuidor en el control DataList es Editable ([haga clic aquí para ver imagen en tamaño completo](performing-batch-updates-cs/_static/image15.png))
