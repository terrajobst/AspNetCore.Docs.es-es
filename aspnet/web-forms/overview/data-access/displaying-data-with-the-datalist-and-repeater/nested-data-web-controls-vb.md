...
**Figura 4**: s nombre de cada categoría y descripción se muestra, separados por una regla Horizontal ([haga clic aquí para ver imagen en tamaño completo](nested-data-web-controls-vb/_static/image12.png))
...
**Figura 5**: The externa Repeater enumera cada categoría; las listas de uno interno los productos de esa categoría ([haga clic aquí para ver imagen en tamaño completo](nested-data-web-controls-vb/_static/image15.png))
