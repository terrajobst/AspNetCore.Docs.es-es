...
ms.locfileid: "41836350"
---
<a name="efficiently-paging-through-large-amounts-of-data-vb"></a>Página de forma eficaz a través de grandes cantidades de datos (VB)
====================
...
**Figura 2**: configuración de la consulta para utilizar una instrucción SELECT que devuelve un valor único
...
**Figura 4**: el nombre de la TotalNumberOfProducts DAL (método)
...
**Figura 14**: deja los orígenes de parámetro de entrada como ninguno
...
**Figura 15**: GridView no es aparece
...
**Figura 17**: los datos, ordenado por el producto, nombre de es paginado usando paginación personalizada ([haga clic aquí para ver imagen en tamaño completo](efficiently-paging-through-large-amounts-of-data-vb/_static/image21.png))
