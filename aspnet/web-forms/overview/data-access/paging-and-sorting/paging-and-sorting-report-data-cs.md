...
ms.locfileid: "37401927"
---
<a name="paging-and-sorting-report-data-c"></a>Paginación y ordenación de datos de informe (C#)
====================
...
**Figura 6**: se enumeran cada uno de los productos ([haga clic aquí para ver imagen en tamaño completo](paging-and-sorting-report-data-cs/_static/image8.png))
...
**Figura 8**: con paginación habilitado, se muestran solo un subconjunto de los registros a la vez ([haga clic aquí para ver imagen en tamaño completo](paging-and-sorting-report-data-cs/_static/image14.png))
...
**Figura 10**: el número de página actual y el número Total de páginas se muestran ([haga clic aquí para ver imagen en tamaño completo](paging-and-sorting-report-data-cs/_static/image20.png))
...
**Figura 14**: mediante la eliminación de la propiedad SortExpression, los usuarios ya No pueden ordenar los productos por precio ([haga clic aquí para ver imagen en tamaño completo](paging-and-sorting-report-data-cs/_static/image30.png))
