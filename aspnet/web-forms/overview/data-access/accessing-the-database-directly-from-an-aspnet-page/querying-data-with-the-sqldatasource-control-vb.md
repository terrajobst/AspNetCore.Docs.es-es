...
ms.locfileid: "37830537"
---
<a name="querying-data-with-the-sqldatasource-control-vb"></a>Consulta de datos con el Control SqlDataSource (VB)
====================
...
> [!NOTE]
> En este tutorial, nos centraremos en recuperar los datos de la base de datos. En el [Insertar, actualizar y eliminar el datos con el SqlDataSource Control](inserting-updating-and-deleting-data-with-the-sqldatasource-vb.md) tutorial, veremos cómo configurar SqlDataSource para admitir la inserción, actualización y eliminación.
...
**Figura 11**: The GridView muestra cada producto s `ProductID`, `ProductName`, y `UnitPrice` valores ([haga clic aquí para ver imagen en tamaño completo](querying-data-with-the-sqldatasource-control-vb/_static/image17.gif))
...
**Figura 15**: The GridView muestra cada s Id. del producto, nombre y nombre de la categoría asociada ([haga clic aquí para ver imagen en tamaño completo](querying-data-with-the-sqldatasource-control-vb/_static/image23.gif))
