...
**Figura 10**: la etiqueta de InvalidCredentialsMessage es muestran al escribir las credenciales no válidas ([haga clic aquí para ver imagen en tamaño completo](an-overview-of-forms-authentication-cs/_static/image26.png))
...
**Figura 11**: aparece cuando se visita forma anónima, un vínculo de registro


![Los usuarios autenticados se muestran el](an-overview-of-forms-authentication-cs/_static/image28.png)

**Figura 12**: usuarios autenticados se muestran la "Bienvenido de nuevo!" Mensaje
...
**Figura 13**: incluye actualmente ha iniciado el mensaje de bienvenida en el nombre del usuario
