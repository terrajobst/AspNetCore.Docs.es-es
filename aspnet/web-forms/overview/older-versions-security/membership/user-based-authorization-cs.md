...
> [!NOTE]
> El `DirectoryInfo` y `FileInfo` clases se encuentran en el [ `System.IO` espacio de nombres](https://msdn.microsoft.com/library/system.io.aspx). Por lo tanto, necesitará preceder estos nombres de clase con sus nombres de espacio de nombres o hacer que el espacio de nombres importado en el archivo de clase (a través de `using System.IO`).
