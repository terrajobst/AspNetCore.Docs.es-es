...
- Un control Web Label para mostrar el nombre del usuario seleccionado. Establecer esta etiqueta `ID` a `UserNameLabel` y borre su propiedad Text.
...
## <a name="step-3-approving-users-by-verifying-their-email-address"></a>Paso 3: Aprobar a los usuarios mediante la comprobación de su dirección de correo electrónico
...
**Figura 7**: cuenta de usuario la nueva es aprobado ahora ([haga clic aquí para ver imagen en tamaño completo](unlocking-and-approving-user-accounts-vb/_static/image21.png))
