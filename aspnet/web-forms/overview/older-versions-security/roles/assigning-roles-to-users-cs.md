...
ms.locfileid: "37820135"
---
<a name="assigning-roles-to-users-c"></a>Asignar Roles a usuarios (C#)
====================
...
**Figura 6**: The GridView se enumeran los usuarios que pertenecen al rol seleccionado ([haga clic aquí para ver imagen en tamaño completo](assigning-roles-to-users-cs/_static/image18.png))
...
**Figura 10**: Tito es, una vez más, un Supervisor!  ([Haga clic aquí para ver imagen en tamaño completo](assigning-roles-to-users-cs/_static/image30.png))
...
**Figura 11**: agregue "Especificar Roles" `WizardStep` a CreateUserWizard ([haga clic aquí para ver imagen en tamaño completo](assigning-roles-to-users-cs/_static/image33.png))
