...
> - <span data-ttu-id="ce6d3-114">Escribir entradas en un archivo de registro personalizado.</span><span class="sxs-lookup"><span data-stu-id="ce6d3-114">Write entries to a custom log file.</span></span>
