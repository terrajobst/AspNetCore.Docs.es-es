...
title: Los usuarios y Roles en el sitio Web de producción (VB) | Documentos de Microsoft
...
[Descarga de PDF](http://download.microsoft.com/download/5/C/5/5C57DB8C-5DEA-4B3A-92CA-4405544D313B/aspnet_tutorial16_CustomAWAT_vb.pdf)
...
([Haga clic aquí para ver la imagen a tamaño completo](users-and-roles-on-the-production-website-vb/_static/image6.png))
...
([Haga clic aquí para ver la imagen a tamaño completo](users-and-roles-on-the-production-website-vb/_static/image9.png))
...
([Haga clic aquí para ver la imagen a tamaño completo](users-and-roles-on-the-production-website-vb/_static/image12.png))
...
En el [ *configurar un sitio Web que utiliza servicios de aplicación* tutorial](configuring-a-website-that-uses-application-services-vb.md) se ha agregado una página a la `Admin` carpeta denominada `CreateAccount.aspx`. Esta página permite a un administrador para agregar una nueva cuenta de usuario para el sitio y especificar si es o no el usuario recién creado en el rol de administrador (consulte **figura 5**).
...
([Haga clic aquí para ver la imagen a tamaño completo](users-and-roles-on-the-production-website-vb/_static/image15.png))
