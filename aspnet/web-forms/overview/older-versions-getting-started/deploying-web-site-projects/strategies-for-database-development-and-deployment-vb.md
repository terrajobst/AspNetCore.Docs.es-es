...
**Figura 3**: usar el Asistente para la sincronización para sincronizar los esquemas de bases de datos ([haga clic aquí para ver imagen en tamaño completo](strategies-for-database-development-and-deployment-vb/_static/image9.jpg))
