...
ms.locfileid: "37387717"
---
<a name="control-id-naming-in-content-pages-vb"></a>Id. de control de nomenclatura en las páginas de contenido (VB)
====================
...
**Figura 03**: la página incluye tres controles Web: un cuadro de texto, un botón y una etiqueta ([haga clic aquí para ver imagen en tamaño completo](control-id-naming-in-content-pages-vb/_static/image5.png))
...
**Figura 06**: edad del usuario se muestra en la etiqueta ([haga clic aquí para ver imagen en tamaño completo](control-id-naming-in-content-pages-vb/_static/image12.png))
