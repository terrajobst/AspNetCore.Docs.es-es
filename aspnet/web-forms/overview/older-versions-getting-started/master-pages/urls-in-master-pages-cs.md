...
title: "Las direcciones URL de páginas maestras (C#) | Documentos de Microsoft"
...
---
<a name="urls-in-master-pages-c"></a>Direcciones URL de páginas maestras (C#)
====================
por [Scott Mitchell](https://twitter.com/ScottOnWriting)

[Descargar código](http://download.microsoft.com/download/e/e/f/eef369f5-743a-4a52-908f-b6532c4ce0a4/ASPNET_MasterPages_Tutorial_04_CS.zip) o [descarga de PDF](http://download.microsoft.com/download/8/f/6/8f6349e4-6554-405a-bcd7-9b094ba5089a/ASPNET_MasterPages_Tutorial_04_CS.pdf)
...
![Una carpeta nueva y la página de ASP.NET que se agregaron al proyecto](urls-in-master-pages-cs/_static/image1.png)
...
[![No se puede encontrar el archivo de imagen PoweredByASPNET.gif](urls-in-master-pages-cs/_static/image3.png)](urls-in-master-pages-cs/_static/image2.png)

**Figura 02**: el `PoweredByASPNET.gif` imagen no se encuentra el archivo ([haga clic aquí para ver la imagen a tamaño completo](urls-in-master-pages-cs/_static/image4.png))
...
El `Control` la clase [ `ResolveClientUrl` método](https://msdn.microsoft.com/en-us/library/system.web.ui.control.resolveclienturl.aspx) toma una dirección URL y modifica a una dirección URL relativa adecuada para la página web en el que reside el control. Por ejemplo, al llamar a `ResolveClientUrl("~/Images/PoweredByASPNET.gif")` de `About.aspx` devuelve `Images/PoweredByASPNET.gif`. Llamarlo desde `~/Admin/Default.aspx`, sin embargo, se devuelve `../Images/PoweredByASPNET.gif`.
...
[Siguiente](control-id-naming-in-content-pages-cs.md)
