...
- [Información general](overview/index.md)
    ...
    - [Introducción](overview/introduction/index.md)
        ...
        - [¿Saber una biblioteca distinta de cobertura?](overview/introduction/other-libraries.md)
    - [Templates](overview/templates/index.md) (Plantillas [C++])

        - [Plantilla de la red troncal](overview/templates/backbonejs-template.md)
        - [Plantilla de facilísima/Angular](overview/templates/breezeangular-template.md)
        - [Plantilla de facilísima/Knockout](overview/templates/breezeknockout-template.md)
        - [Plantilla de EmberJS](overview/templates/emberjs-template.md)
        - [Plantilla de toallas activa](overview/templates/hottowel-template.md)
