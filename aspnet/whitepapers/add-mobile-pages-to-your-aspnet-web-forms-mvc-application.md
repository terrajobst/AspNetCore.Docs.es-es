...
Ahora el error irá ubicación y la dirección URL http://<em>su sitio</em>/ llegará a la página principal de escritorio y http://<em>su sitio</em>/mobile/ llegará a la página principal de mobile.
