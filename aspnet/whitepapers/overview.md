...
[ASP.NET 2.0 de instrumentar aplicaciones para la seguridad](https://msdn.microsoft.com/en-us/library/ms998325.aspx)
...
[Realizar una revisión de la implementación de seguridad para ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998367.aspx)
...
[Usar a ADAM para Roles en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998331.aspx)
...
[Use el Administrador de autorización (AzMan) con ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998336.aspx)
...
[Utilizar la pertenencia en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998347.aspx)
...
[Use el Administrador de roles en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998314.aspx)
...
[Utilizar autenticación de Windows en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998358.aspx)
...
[Realizar una revisión de código de seguridad para código administrado (actividad de la línea de base)](https://msdn.microsoft.com/en-us/library/ms998364.aspx)
...
[Implementar la delegación Kerberos para Windows 2000](https://msdn.microsoft.com/en-us/library/aa302400.aspx)
...
[Usar la suplantación y delegación en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998351.aspx)
...
[Crear un modelo de amenazas para una aplicación Web en tiempo de diseño](https://msdn.microsoft.com/en-us/library/ms978527.aspx)
...
[Proteger la autenticación de formularios en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998310.aspx)
...
[Utilizar autenticación por formularios con Active Directory en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998360.aspx)
...
[Utilizar autenticación por formularios con Active Directory en varios dominios en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998345.aspx)

Este cómo se muestra cómo utilizar la autenticación de formularios con el servicio de directorio de Microsoft® Active Directory® utilizando ActiveDirectoryMembershipProvider. El artículo se muestra cómo configurar el proveedor y crear y autenticar a los usuarios...

[Usar autenticación de formularios con SQL Server en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998317.aspx)
...
[Crear objetos GenericPrincipal con autenticación de formularios en ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302399.aspx)
...
[Utilizar autenticación por formularios con Active Directory en ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302397.aspx)
...
[Usar autenticación de formularios con SQL Server en ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302398.aspx)
...
[Impedir el Scripting entre sitios en ASP.NET](https://msdn.microsoft.com/en-us/library/ms998274.aspx)
...
[Proteger contra la inyección de SQL en ASP.NET](https://msdn.microsoft.com/en-us/library/ms998271.aspx)
...
[Utilizar expresiones regulares para restringir las entradas en ASP.NET](https://msdn.microsoft.com/en-us/library/ms998267.aspx)
...
[Utilizar la seguridad de acceso del código en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998326.aspx)
...
[Crear un permiso de cifrado personalizado](https://msdn.microsoft.com/en-us/library/aa302362.aspx)
...
[Usar la directiva de seguridad de acceso de código para restringir un ensamblado](https://msdn.microsoft.com/en-us/library/aa302361.aspx)
...
[Configurar SSL en un servidor Web](https://msdn.microsoft.com/en-us/library/aa302411.aspx)
...
[Configurar los certificados de cliente](https://msdn.microsoft.com/en-us/library/aa302412.aspx)
...
[Utilice IPSec para el filtrado de puertos y la autenticación](https://msdn.microsoft.com/en-us/library/aa302366.aspx)
...
[Utilice IPSec para proporcionar una comunicación segura entre dos servidores](https://msdn.microsoft.com/en-us/library/aa302413.aspx)
...
[Usar SSL para proteger la comunicación con SQL Server](https://msdn.microsoft.com/en-us/library/aa302414.aspx)
...
[Llamar a un servicio Web mediante certificados de cliente de ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302408.aspx)
...
[Llamar a un servicio Web mediante SSL desde ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302409.aspx)
...
[Crear una biblioteca DPAPI en .NET 1.1](https://msdn.microsoft.com/en-us/library/aa302402.aspx)
...
[Crear una biblioteca de cifrado en .NET 1.1](https://msdn.microsoft.com/en-us/library/aa302405.aspx)
...
[Almacenar una cadena de conexión cifrada en el registro de ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302406.aspx)
...
[Usar DPAPI (almacén del equipo) desde ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302403.aspx)
...
[Usar DPAPI (almacén de usuario) de ASP.NET 1.1 con Enterprise Services](https://msdn.microsoft.com/en-us/library/aa302404.aspx)
...
[Crear una cuenta de servicio para ASP.NET 2.0 aplicación](https://msdn.microsoft.com/en-us/library/ms998297.aspx)
...
[Mejorar la seguridad al hospedar varias aplicaciones en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/aa480478.aspx)
...
[Usar la cuenta de servicio de red para tener acceso a recursos en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998320.aspx)
...
[Use la transición del protocolo y delegación restringida en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998355.aspx)
...
[Crear una cuenta personalizada para ejecutar ASP.NET 1.1](https://msdn.microsoft.com/en-us/library/aa302396.aspx)
...
[Configurar la clave del equipo en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998288.aspx)
...
[Cifrar secciones de configuración en ASP.NET 2.0 mediante DPAPI](https://msdn.microsoft.com/en-us/library/ms998280.aspx)
...
[Cifrar secciones de configuración en ASP.NET 2.0 mediante RSA](https://msdn.microsoft.com/en-us/library/ms998283.aspx)
...
[Conectarse a SQL Server mediante autenticación de SQL en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998300.aspx)
...
[Conectarse a SQL Server mediante autenticación de Windows en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998292.aspx)
...
[Usar SSL para proteger la comunicación con SQL Server 2000](https://msdn.microsoft.com/en-us/library/aa302414.aspx)
...
[Usar la supervisión de estado en ASP.NET 2.0](https://msdn.microsoft.com/en-us/library/ms998306.aspx)
...
[Implementar la administración de revisión](https://msdn.microsoft.com/en-us/library/aa302364.aspx)
