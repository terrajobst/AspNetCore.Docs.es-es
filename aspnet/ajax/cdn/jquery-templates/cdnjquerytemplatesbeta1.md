...
title: las plantillas de versión Beta 1 de jQuery | Microsoft Docs
...
ms.locfileid: "41835709"
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="1dafe-102">las plantillas de versión Beta 1 de jQuery</span><span class="sxs-lookup"><span data-stu-id="1dafe-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="1dafe-103">El complemento de plantillas de jQuery incluye los siguientes archivos:</span><span class="sxs-lookup"><span data-stu-id="1dafe-103">The jQuery Templates plugin includes the following files:</span></span>
