...
ms.locfileid: "41829050"
---
<a name="jquery-datatables-182"></a><span data-ttu-id="92330-102">1.8.2 DataTables de jQuery</span><span class="sxs-lookup"><span data-stu-id="92330-102">jQuery DataTables 1.8.2</span></span>
====================
<span data-ttu-id="92330-103">Los siguientes archivos para lo complementos DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="92330-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
