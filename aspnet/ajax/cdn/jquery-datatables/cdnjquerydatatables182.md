...
ms.locfileid: "30078314"
---
<a name="jquery-datatables-182"></a><span data-ttu-id="b3967-102">jQuery DataTables 1.8.2</span><span class="sxs-lookup"><span data-stu-id="b3967-102">jQuery DataTables 1.8.2</span></span>
====================
<span data-ttu-id="b3967-103">Los siguientes archivos para los complementos de DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="b3967-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
