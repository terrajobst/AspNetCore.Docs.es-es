...
ms.locfileid: "30071199"
---
<a name="jquery-datatables-194"></a><span data-ttu-id="f66ba-102">jQuery DataTables 1.9.4</span><span class="sxs-lookup"><span data-stu-id="f66ba-102">jQuery DataTables 1.9.4</span></span>
====================
<span data-ttu-id="f66ba-103">Los siguientes archivos para los complementos de DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="f66ba-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
