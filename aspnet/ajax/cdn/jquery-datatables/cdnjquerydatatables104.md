...
ms.locfileid: "30071439"
---
<a name="jquery-datatables-1104"></a><span data-ttu-id="f383a-102">jQuery DataTables 1.10.4</span><span class="sxs-lookup"><span data-stu-id="f383a-102">jQuery DataTables 1.10.4</span></span>
====================
<span data-ttu-id="f383a-103">Los siguientes archivos para los complementos de DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="f383a-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
