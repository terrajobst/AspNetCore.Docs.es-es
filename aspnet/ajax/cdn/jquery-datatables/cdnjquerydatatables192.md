...
ms.locfileid: "41837326"
---
<a name="jquery-datatables-192"></a><span data-ttu-id="dcb4c-102">1.9.2 DataTables de jQuery</span><span class="sxs-lookup"><span data-stu-id="dcb4c-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="dcb4c-103">Los siguientes archivos para lo complementos DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="dcb4c-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
