...
ms.locfileid: "41829800"
---
<a name="jquery-datatables-191"></a><span data-ttu-id="464a0-102">1.9.1 DataTables de jQuery</span><span class="sxs-lookup"><span data-stu-id="464a0-102">jQuery DataTables 1.9.1</span></span>
====================
<span data-ttu-id="464a0-103">Los siguientes archivos para lo complementos DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="464a0-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
