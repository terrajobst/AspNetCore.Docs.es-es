...
ms.locfileid: "37377145"
---
<a name="jquery-datatables-190"></a><span data-ttu-id="5a146-102">jQuery DataTables 1.9.0</span><span class="sxs-lookup"><span data-stu-id="5a146-102">jQuery DataTables 1.9.0</span></span>
====================
<span data-ttu-id="5a146-103">Los siguientes archivos para lo complementos DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="5a146-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
