...
ms.locfileid: "41829397"
---
<a name="jquery-datatables-190"></a><span data-ttu-id="b8f3a-102">jQuery DataTables 1.9.0</span><span class="sxs-lookup"><span data-stu-id="b8f3a-102">jQuery DataTables 1.9.0</span></span>
====================
<span data-ttu-id="b8f3a-103">Los siguientes archivos para lo complementos DataTables de jQuery se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="b8f3a-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
