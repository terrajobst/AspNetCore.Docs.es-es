...
ms.locfileid: "30070789"
---
<a name="jquery-validation-1150"></a><span data-ttu-id="e0ad1-102">jQuery validación 1.15.0</span><span class="sxs-lookup"><span data-stu-id="e0ad1-102">jQuery Validation 1.15.0</span></span>
====================
<span data-ttu-id="e0ad1-103">Los siguientes archivos se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="e0ad1-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="e0ad1-104">Archivos de localización en https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages \_.js ## donde ## es el código de loc.</span><span class="sxs-lookup"><span data-stu-id="e0ad1-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.15.0/localization/messages\_##.js where ## is the loc code.</span></span>
