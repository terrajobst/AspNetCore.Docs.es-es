...
ms.locfileid: "37396723"
---
<a name="jquery-validation-1160"></a><span data-ttu-id="43885-102">1.16.0 de validación de jQuery</span><span class="sxs-lookup"><span data-stu-id="43885-102">jQuery Validation 1.16.0</span></span>
====================
<span data-ttu-id="43885-103">Los siguientes archivos se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="43885-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="43885-104">Archivos de localización en https://ajax.aspnetcdn.com/ajax/jquery.validate/1.16.0/localization/messages\_##.js donde ## es el código de loc.</span><span class="sxs-lookup"><span data-stu-id="43885-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.16.0/localization/messages\_##.js where ## is the loc code.</span></span>
