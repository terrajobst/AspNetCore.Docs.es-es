...
ms.locfileid: "30070490"
---
<a name="jquery-validation-1140"></a><span data-ttu-id="5b34f-102">jQuery validación 1.14.0</span><span class="sxs-lookup"><span data-stu-id="5b34f-102">jQuery Validation 1.14.0</span></span>
====================
<span data-ttu-id="5b34f-103">Los siguientes archivos se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="5b34f-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="5b34f-104">Archivos de localización en https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages \_.js ## donde ## es el código de loc.</span><span class="sxs-lookup"><span data-stu-id="5b34f-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.14.0/localization/messages\_##.js where ## is the loc code.</span></span>
