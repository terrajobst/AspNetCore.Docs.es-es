...
ms.locfileid: "30071303"
---
<a name="jquery-validation-1130"></a><span data-ttu-id="16535-102">jQuery validación 1.13.0</span><span class="sxs-lookup"><span data-stu-id="16535-102">jQuery Validation 1.13.0</span></span>
====================
<span data-ttu-id="16535-103">Los siguientes archivos se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="16535-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="16535-104">Archivos de localización en https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages \_.js ## donde ## es el código de loc.</span><span class="sxs-lookup"><span data-stu-id="16535-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.13.0/localization/messages\_##.js where ## is the loc code.</span></span>
