...
ms.locfileid: "41836013"
---
<a name="jquery-validation-1110"></a><span data-ttu-id="18d67-102">1.11.0 de validación de jQuery</span><span class="sxs-lookup"><span data-stu-id="18d67-102">jQuery Validation 1.11.0</span></span>
====================
<span data-ttu-id="18d67-103">Los siguientes archivos se hospedan en la red CDN:</span><span class="sxs-lookup"><span data-stu-id="18d67-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="18d67-104">Archivos de localización en https://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.0/localization/messages\_##.js donde ## es el código de loc.</span><span class="sxs-lookup"><span data-stu-id="18d67-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.0/localization/messages\_##.js where ## is the loc code.</span></span>
