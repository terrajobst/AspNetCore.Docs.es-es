...
Mads muestra Kristensen desactivar las características del editor de HTML en Visual Studio 2013, incluidas todas las características IntelliSense para los elementos HTML, todas las clases CSS e identificadores en el proyecto, HTML entidades, fragmentos enriquecidos, arrastrar y colocar para medios, compatibilidad con bibliotecas modernas como AngularJS, KnockoutJS y manillares y una variedad de etiquetas meta.
