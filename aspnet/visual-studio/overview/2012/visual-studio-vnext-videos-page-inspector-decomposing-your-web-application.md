...
En este vídeo, Jorge Gabuardi Gonzalez muestra cómo usar el Inspector de página en Visual Studio vNext para solucionar problemas de HTML y estilos en sus aplicaciones ASP.NET.
