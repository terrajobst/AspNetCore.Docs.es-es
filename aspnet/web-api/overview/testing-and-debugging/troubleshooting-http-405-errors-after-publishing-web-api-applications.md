...
| **PUT** | Este método se utiliza normalmente para los datos sin procesar para el identificador URI; PUT a menudo se usa para enviar los datos JSON o XML para las aplicaciones Web API. |
