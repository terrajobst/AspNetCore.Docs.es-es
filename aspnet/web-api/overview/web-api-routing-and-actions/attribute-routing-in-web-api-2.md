...
| --- | --- | --- |
| alfa | Coincidencias de mayúscula o minúscula de caracteres del alfabeto latino (, a-z, A-z) | {x: alfa} |
...
### <a name="custom-route-constraints"></a>Restricciones de ruta personalizados
