...
---
<a name="americas-next-top-model-view-controller-framework"></a>Marco de trabajo de América siguiente superior del modelo View Controller
====================
por [Phil Haack](https://github.com/Haacked)

Vea cómo crear una aplicación simple que se resalta algunas de las capacidades clave de ASP.NET MVC. Asimismo, aprenda a mejorar la productividad con algunas de las texturas herramientas nuevas características.
