...
---
<a name="aspnet-mvc-2---render-action"></a>ASP.NET MVC 2: acción de procesamiento
====================
por [Jon Galloway](https://github.com/jongalloway)

En este vídeo aprenderá a usar Html.RenderAction para escribir los resultados de una acción de controlador a una vista. Analizaremos cómo Html.RenderAction difiere de Html.RenderPartial y cómo Html.Action difiere de Html.RenderAction.
