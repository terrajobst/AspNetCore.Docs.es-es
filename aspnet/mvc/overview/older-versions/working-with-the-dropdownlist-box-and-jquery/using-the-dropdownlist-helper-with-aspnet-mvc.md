...
Cambie la lista de selección a Drama del sistema y presione la **enviar** botón. La dirección URL en el explorador es `http://localhost:2468/Home/CategoryChosen?MovieType=1` y muestra la página **seleccionó: 1**.
