...
<span data-ttu-id="a01a7-112">Después, agregará la edición y crear vistas que se pueden modificar los álbumes en la base de datos, con la Ayuda de los elementos de formulario como listas desplegables.</span><span class="sxs-lookup"><span data-stu-id="a01a7-112">Afterwards, you will add the Edit and Create Views that will let you alter the albums in the database, with the help of form elements like dropdowns.</span></span>
...
1. [<span data-ttu-id="a01a7-139">Crear el controlador de Store Manager y su vista de índice</span><span class="sxs-lookup"><span data-stu-id="a01a7-139">Creating the Store Manager controller and its Index view</span></span>](#Exercise1)
...
2. <span data-ttu-id="a01a7-161">Agregar un nuevo controlador.</span><span class="sxs-lookup"><span data-stu-id="a01a7-161">Add a new controller.</span></span> <span data-ttu-id="a01a7-162">Para ello, haga clic en el **controladores** carpeta en el Explorador de soluciones, seleccione **agregar** y, a continuación, el **controlador** comando.</span><span class="sxs-lookup"><span data-stu-id="a01a7-162">To do this, right-click the **Controllers** folder within the Solution Explorer, select **Add** and then the **Controller** command.</span></span> <span data-ttu-id="a01a7-163">Cambiar el **controlador** **nombre** a **StoreManagerController** y asegúrese de que la opción **controlador de MVC con acciones de lectura/escritura vacías**está seleccionada.</span><span class="sxs-lookup"><span data-stu-id="a01a7-163">Change the **Controller** **Name** to **StoreManagerController** and make sure the option **MVC controller with empty read/write actions** is selected.</span></span> <span data-ttu-id="a01a7-164">Haga clic en **Agregar**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-164">Click **Add**.</span></span>
    ...
    <span data-ttu-id="a01a7-166">*Agregar cuadro de diálogo de controlador*</span><span class="sxs-lookup"><span data-stu-id="a01a7-166">*Add Controller Dialog*</span></span>
...
3. <span data-ttu-id="a01a7-187">En el cuadro de diálogo Agregar vista, compruebe que el nombre de vista es **índice**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-187">In the Add View dialog, verify that the View Name is **Index**.</span></span> <span data-ttu-id="a01a7-188">Seleccione el **crear una vista fuertemente tipada** opción y seleccione **álbum (MvcMusicStore.Models)** desde el **clase modelo** lista desplegable.</span><span class="sxs-lookup"><span data-stu-id="a01a7-188">Select the **Create a strongly-typed view** option, and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="a01a7-189">Seleccione **lista** desde el **plantilla Scaffold** lista desplegable.</span><span class="sxs-lookup"><span data-stu-id="a01a7-189">Select **List** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="a01a7-190">Deje el **motor de vista** a **Razor** y los demás campos con su valor predeterminado de valor y, a continuación, haga clic en **agregar**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-190">Leave the **View engine** to **Razor** and the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="a01a7-191">![Agregar una vista de índice](aspnet-mvc-4-helpers-forms-and-validation/_static/image3.png "agregar una vista de índice")</span><span class="sxs-lookup"><span data-stu-id="a01a7-191">![Adding an index view](aspnet-mvc-4-helpers-forms-and-validation/_static/image3.png "Adding an index view")</span></span>
...
<span data-ttu-id="a01a7-214">![Examinar la lista de álbumes con texto truncado no](aspnet-mvc-4-helpers-forms-and-validation/_static/image5.png "no examinar la lista de álbumes con texto truncado")</span><span class="sxs-lookup"><span data-stu-id="a01a7-214">![Browsing the list of Albums with not truncated text](aspnet-mvc-4-helpers-forms-and-validation/_static/image5.png "Browsing the list of Albums with not truncated text")</span></span>
...
<span data-ttu-id="a01a7-272">En esta tarea, creará una plantilla de vista de edición que más adelante se mostrará las propiedades del álbum.</span><span class="sxs-lookup"><span data-stu-id="a01a7-272">In this task, you will create an Edit View template that will later display the album properties.</span></span>
...
2. <span data-ttu-id="a01a7-284">El proyecto se inicia en la página principal.</span><span class="sxs-lookup"><span data-stu-id="a01a7-284">The project starts in the Home page.</span></span> <span data-ttu-id="a01a7-285">Cambiar la dirección URL de **/StoreManager/Edit/1** para comprobar que se muestran los valores de las propiedades del álbum pasado.</span><span class="sxs-lookup"><span data-stu-id="a01a7-285">Change the URL to **/StoreManager/Edit/1** to verify that the properties' values for the album passed are displayed.</span></span>
    ...
    <span data-ttu-id="a01a7-287">*Exploración de la vista de edición del álbum*</span><span class="sxs-lookup"><span data-stu-id="a01a7-287">*Browsing Album's Edit view*</span></span>
...
2. <span data-ttu-id="a01a7-306">Reemplace **HTTP-POST editar** código del método de acción con los siguientes (tenga en cuenta que el método que se debe reemplazar es una versión sobrecargada que recibe dos parámetros):</span><span class="sxs-lookup"><span data-stu-id="a01a7-306">Replace **HTTP-POST Edit** action method code with the following (note that the method that must be replaced is overloaded version that receives two parameters):</span></span>
    ...
    >     2. <span data-ttu-id="a01a7-315">Guarde los cambios y redirigir a la vista de índice.</span><span class="sxs-lookup"><span data-stu-id="a01a7-315">Save the changes and redirect to the index view.</span></span>
...
1. <span data-ttu-id="a01a7-367">Cierre el explorador si es necesario, para volver a la ventana de Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="a01a7-367">Close the browser if needed, to return to the Visual Studio window.</span></span> <span data-ttu-id="a01a7-368">Abra **StoreManagerController** clase.</span><span class="sxs-lookup"><span data-stu-id="a01a7-368">Open **StoreManagerController** class.</span></span> <span data-ttu-id="a01a7-369">Para ello, expanda el **controladores** carpeta y haga doble clic en **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-369">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
...
2. <span data-ttu-id="a01a7-376">El proyecto se inicia en la página principal.</span><span class="sxs-lookup"><span data-stu-id="a01a7-376">The project starts in the Home page.</span></span> <span data-ttu-id="a01a7-377">Cambiar la dirección URL de **/StoreManager/crear**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-377">Change the URL to **/StoreManager/Create**.</span></span> <span data-ttu-id="a01a7-378">Rellenar todos los campos de formulario con datos de un álbum nuevo, como el de la siguiente ilustración:</span><span class="sxs-lookup"><span data-stu-id="a01a7-378">Fill all the form fields with data for a new Album, like the one in the following figure:</span></span>
    ...
    <span data-ttu-id="a01a7-380">*Crear un álbum*</span><span class="sxs-lookup"><span data-stu-id="a01a7-380">*Creating an Album*</span></span>
...
5. <span data-ttu-id="a01a7-408">En el cuadro de diálogo Agregar vista, compruebe que el nombre de vista es **eliminar**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-408">In the Add View dialog, verify that the View name is **Delete**.</span></span> <span data-ttu-id="a01a7-409">Seleccione el **crear una vista fuertemente tipada** opción y seleccione **álbum (MvcMusicStore.Models)** desde el **clase modelo** lista desplegable.</span><span class="sxs-lookup"><span data-stu-id="a01a7-409">Select the **Create a strongly-typed view** option and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="a01a7-410">Seleccione **eliminar** desde el **plantilla Scaffold** lista desplegable.</span><span class="sxs-lookup"><span data-stu-id="a01a7-410">Select **Delete** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="a01a7-411">Deje los demás campos con sus valores predeterminados y, a continuación, haga clic en **agregar**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-411">Leave the other fields with their default value and then click **Add**.</span></span>

    <span data-ttu-id="a01a7-412">![Agregar una vista Delete](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "agregar una vista Delete")</span><span class="sxs-lookup"><span data-stu-id="a01a7-412">![Adding a Delete View](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Adding a Delete View")</span></span>

    <span data-ttu-id="a01a7-413">*Agregar una vista Delete*</span><span class="sxs-lookup"><span data-stu-id="a01a7-413">*Adding a Delete View*</span></span>
6. <span data-ttu-id="a01a7-414">La plantilla de eliminación muestra todos los campos del modelo.</span><span class="sxs-lookup"><span data-stu-id="a01a7-414">The Delete template shows all the fields from the model.</span></span> <span data-ttu-id="a01a7-415">Se mostrará solo del álbum.</span><span class="sxs-lookup"><span data-stu-id="a01a7-415">You will show only the album's title.</span></span> <span data-ttu-id="a01a7-416">Para ello, reemplace el contenido de la vista con el código siguiente:</span><span class="sxs-lookup"><span data-stu-id="a01a7-416">To do this, replace the content of the view with the following code:</span></span>
...
#### <a name="task-2---running-the-application"></a><span data-ttu-id="a01a7-417">Tarea 2: ejecutar la aplicación</span><span class="sxs-lookup"><span data-stu-id="a01a7-417">Task 2 - Running the Application</span></span>

<span data-ttu-id="a01a7-418">En esta tarea, probará que la **StoreManager** **eliminar** ver página muestra un formulario de eliminación de confirmación.</span><span class="sxs-lookup"><span data-stu-id="a01a7-418">In this task, you will test that the **StoreManager** **Delete** View page displays a confirmation deletion form.</span></span>

1. <span data-ttu-id="a01a7-419">Presione **F5** para ejecutar la aplicación.</span><span class="sxs-lookup"><span data-stu-id="a01a7-419">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="a01a7-420">El proyecto se inicia en la página principal.</span><span class="sxs-lookup"><span data-stu-id="a01a7-420">The project starts in the Home page.</span></span> <span data-ttu-id="a01a7-421">Cambiar la dirección URL de **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-421">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="a01a7-422">Seleccione un álbum que desea eliminar haciendo clic en **eliminar** y compruebe que se cargue la nueva vista.</span><span class="sxs-lookup"><span data-stu-id="a01a7-422">Select one album to delete by clicking **Delete** and verify that the new view is uploaded.</span></span>

    <span data-ttu-id="a01a7-423">![Al eliminar un álbum](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "al eliminar un álbum")</span><span class="sxs-lookup"><span data-stu-id="a01a7-423">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "Deleting an Album")</span></span>

    <span data-ttu-id="a01a7-424">*Al eliminar un álbum*</span><span class="sxs-lookup"><span data-stu-id="a01a7-424">*Deleting an Album*</span></span>

<a id="Ex05Task3"></a>

<a id="Task_3-_Implementing_the_HTTP-POST_Delete_Action_Method"></a>
#### <a name="task-3--implementing-the-http-post-delete-action-method"></a><span data-ttu-id="a01a7-425">Tarea 3: implementar el método de acción Delete de HTTP-POST</span><span class="sxs-lookup"><span data-stu-id="a01a7-425">Task 3- Implementing the HTTP-POST Delete Action Method</span></span>

<span data-ttu-id="a01a7-426">En esta tarea, implementará la versión HTTP-POST del método de acción de eliminación que se invocará cuando un usuario hace clic en el **eliminar** botón.</span><span class="sxs-lookup"><span data-stu-id="a01a7-426">In this task, you will implement the HTTP-POST version of the Delete action method that will be invoked when a user clicks the **Delete** button.</span></span> <span data-ttu-id="a01a7-427">El método debe eliminar el álbum en la base de datos.</span><span class="sxs-lookup"><span data-stu-id="a01a7-427">The method should delete the album in the database.</span></span>

1. <span data-ttu-id="a01a7-428">Cierre el explorador si es necesario, para volver a la ventana de Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="a01a7-428">Close the browser if needed, to return to the Visual Studio window.</span></span> <span data-ttu-id="a01a7-429">Abra **StoreManagerController** clase.</span><span class="sxs-lookup"><span data-stu-id="a01a7-429">Open **StoreManagerController** class.</span></span> <span data-ttu-id="a01a7-430">Para ello, expanda el **controladores** carpeta y haga doble clic en **StoreManagerController.cs**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-430">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
2. <span data-ttu-id="a01a7-431">Reemplace **HTTP-POST Delete** código del método de acción con lo siguiente:</span><span class="sxs-lookup"><span data-stu-id="a01a7-431">Replace **HTTP-POST Delete** action method code with the following:</span></span>

    <span data-ttu-id="a01a7-432">(Código de fragmento de código - *las aplicaciones auxiliares de ASP.NET MVC 4 y formularios y validación - HTTP-POST eliminación de control de Ex5 Eliminar acción*)</span><span class="sxs-lookup"><span data-stu-id="a01a7-432">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-POST Delete action*)</span></span>
...
#### <a name="task-4---running-the-application"></a><span data-ttu-id="a01a7-433">Tarea 4: ejecución de la aplicación</span><span class="sxs-lookup"><span data-stu-id="a01a7-433">Task 4 - Running the Application</span></span>

<span data-ttu-id="a01a7-434">En esta tarea, probará que la **StoreManager Delete** ver página permite eliminar un álbum y, a continuación, se redirige a la vista de índice StoreManager.</span><span class="sxs-lookup"><span data-stu-id="a01a7-434">In this task, you will test that the **StoreManager Delete** View page lets you delete an Album and then redirects to the StoreManager Index View.</span></span>

1. <span data-ttu-id="a01a7-435">Presione **F5** para ejecutar la aplicación.</span><span class="sxs-lookup"><span data-stu-id="a01a7-435">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="a01a7-436">El proyecto se inicia en la página principal.</span><span class="sxs-lookup"><span data-stu-id="a01a7-436">The project starts in the Home page.</span></span> <span data-ttu-id="a01a7-437">Cambiar la dirección URL de **/StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-437">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="a01a7-438">Seleccione un álbum que desea eliminar haciendo clic en **eliminar.**</span><span class="sxs-lookup"><span data-stu-id="a01a7-438">Select one album to delete by clicking **Delete.**</span></span> <span data-ttu-id="a01a7-439">Haga clic en confirmar la eliminación **eliminar** botón:</span><span class="sxs-lookup"><span data-stu-id="a01a7-439">Confirm the deletion by clicking **Delete** button:</span></span>

    <span data-ttu-id="a01a7-440">![Al eliminar un álbum](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "al eliminar un álbum")</span><span class="sxs-lookup"><span data-stu-id="a01a7-440">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "Deleting an Album")</span></span>

    <span data-ttu-id="a01a7-441">*Al eliminar un álbum*</span><span class="sxs-lookup"><span data-stu-id="a01a7-441">*Deleting an Album*</span></span>
3. <span data-ttu-id="a01a7-442">Compruebe que se eliminó el álbum puesto que no aparece en el **índice** página.</span><span class="sxs-lookup"><span data-stu-id="a01a7-442">Verify that the album was deleted since it does not appear in the **Index** page.</span></span>

<a id="Exercise6"></a>

<a id="Exercise_6_Adding_Validation"></a>
### <a name="exercise-6-adding-validation"></a><span data-ttu-id="a01a7-443">Ejercicio 6: Agregar validación</span><span class="sxs-lookup"><span data-stu-id="a01a7-443">Exercise 6: Adding Validation</span></span>

<span data-ttu-id="a01a7-444">Actualmente, los formularios de Create y Edit con que de contar no realizan ningún tipo de validación.</span><span class="sxs-lookup"><span data-stu-id="a01a7-444">Currently, the Create and Edit forms you have in place do not perform any kind of validation.</span></span> <span data-ttu-id="a01a7-445">Si el usuario deja un campo obligatorio en blanco o escriba las letras en el campo de precio, será el primer error, obtendrá de la base de datos.</span><span class="sxs-lookup"><span data-stu-id="a01a7-445">If the user leaves a required field blank or type letters in the price field, the first error you will get will be from the database.</span></span>

<span data-ttu-id="a01a7-446">Puede agregar validación a la aplicación mediante la adición de anotaciones de datos a la clase de modelo.</span><span class="sxs-lookup"><span data-stu-id="a01a7-446">You can add validation to the application by adding Data Annotations to your model class.</span></span> <span data-ttu-id="a01a7-447">Las anotaciones de datos permiten que describe las reglas que desea aplicadas a las propiedades del modelo y ASP.NET MVC se encargará de aplicar y mostrar el mensaje adecuado a los usuarios.</span><span class="sxs-lookup"><span data-stu-id="a01a7-447">Data Annotations allow describing the rules you want applied to your model properties, and ASP.NET MVC will take care of enforcing and displaying appropriate message to users.</span></span>

<a id="Ex06Task1"></a>

<a id="Task_1_-_Adding_Data_Annotations"></a>
#### <a name="task-1---adding-data-annotations"></a><span data-ttu-id="a01a7-448">Tarea 1: agregar anotaciones de datos</span><span class="sxs-lookup"><span data-stu-id="a01a7-448">Task 1 - Adding Data Annotations</span></span>

<span data-ttu-id="a01a7-449">En esta tarea, agregará las anotaciones de datos para el modelo de álbum que hará que la página Create y Edit mostrar mensajes de validación cuando corresponda.</span><span class="sxs-lookup"><span data-stu-id="a01a7-449">In this task, you will add Data Annotations to the Album Model that will make the Create and Edit page display validation messages when appropriate.</span></span>

<span data-ttu-id="a01a7-450">Para una clase de modelo simple, agregar una anotación de datos se controla simplemente agregando un **mediante** instrucción para **System.ComponentModel.DataAnnotation**, a continuación, colocar un **[obligatorio]** atributo en las propiedades adecuadas.</span><span class="sxs-lookup"><span data-stu-id="a01a7-450">For a simple Model class, adding a Data Annotation is just handled by adding a **using** statement for **System.ComponentModel.DataAnnotation**, then placing a **[Required]** attribute on the appropriate properties.</span></span> <span data-ttu-id="a01a7-451">En el ejemplo siguiente se podría hacer que el **nombre** un campo obligatorio en la vista de la propiedad.</span><span class="sxs-lookup"><span data-stu-id="a01a7-451">The following example would make the **Name** property a required field in the View.</span></span>

[!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample18.cs)]

<span data-ttu-id="a01a7-452">Esto es un poco más complejo en casos como esta aplicación donde se genera el Entity Data Model.</span><span class="sxs-lookup"><span data-stu-id="a01a7-452">This is a little more complex in cases like this application where the Entity Data Model is generated.</span></span> <span data-ttu-id="a01a7-453">Si agrega las anotaciones de datos directamente a las clases del modelo, se sobrescribirán si actualiza el modelo de la base de datos.</span><span class="sxs-lookup"><span data-stu-id="a01a7-453">If you added Data Annotations directly to the model classes, they would be overwritten if you update the model from the database.</span></span> <span data-ttu-id="a01a7-454">En su lugar, puede hacer uso de clases parciales de los metadatos que existirá para almacenar las anotaciones y están asociadas con el modelo de clases con el **[MetadataType]** atributo.</span><span class="sxs-lookup"><span data-stu-id="a01a7-454">Instead, you can make use of metadata partial classes which will exist to hold the annotations and are associated with the model classes using the **[MetadataType]** attribute.</span></span>

1. <span data-ttu-id="a01a7-455">Abra el **comenzar** solución ubicado en **origen/Ex6-AddingValidation/inicio/** carpeta.</span><span class="sxs-lookup"><span data-stu-id="a01a7-455">Open the **Begin** solution located at **Source/Ex6-AddingValidation/Begin/** folder.</span></span> <span data-ttu-id="a01a7-456">En caso contrario, es posible que siga usando la **final** solución obtenido completando el ejercicio anterior.</span><span class="sxs-lookup"><span data-stu-id="a01a7-456">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="a01a7-457">Si abrió proporcionado **comenzar** solución, deberá descargar algunos paquetes de NuGet que faltan antes de continuar.</span><span class="sxs-lookup"><span data-stu-id="a01a7-457">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="a01a7-458">Para ello, haga clic en el **proyecto** menú y seleccione **administrar paquetes de NuGet**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-458">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="a01a7-459">En el **administrar paquetes de NuGet** cuadro de diálogo, haga clic en **restaurar** para descargar los paquetes que falten.</span><span class="sxs-lookup"><span data-stu-id="a01a7-459">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="a01a7-460">Por último, compile la solución haciendo **compilar** | **compilar solución**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-460">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="a01a7-461">Una de las ventajas de usar NuGet es que no tienen que enviar todas las bibliotecas en el proyecto, lo que reduce el tamaño del proyecto.</span><span class="sxs-lookup"><span data-stu-id="a01a7-461">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="a01a7-462">Con las herramientas avanzadas de NuGet, mediante la especificación de las versiones del paquete en el archivo Packages.config, podrá descargar todas las bibliotecas requeridas en la primera vez que ejecute el proyecto.</span><span class="sxs-lookup"><span data-stu-id="a01a7-462">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="a01a7-463">Esto es por eso tendrá que ejecutar estos pasos después de abrir una solución existente de este laboratorio.</span><span class="sxs-lookup"><span data-stu-id="a01a7-463">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="a01a7-464">Abra el **Album.cs** desde el **modelos** carpeta.</span><span class="sxs-lookup"><span data-stu-id="a01a7-464">Open the **Album.cs** from the **Models** folder.</span></span>
3. <span data-ttu-id="a01a7-465">Reemplace **Album.cs** de contenido con el código resaltado, por lo que se parezca a lo siguiente:</span><span class="sxs-lookup"><span data-stu-id="a01a7-465">Replace **Album.cs** content with the highlighted code, so that it looks like the following:</span></span>

    > [!NOTE]
    > <span data-ttu-id="a01a7-466">La línea **[DisplayFormat(ConvertEmptyStringToNull=false)]** indica que no se puede convertir las cadenas vacías del modelo en null cuando se actualiza el campo de datos en el origen de datos.</span><span class="sxs-lookup"><span data-stu-id="a01a7-466">The line **[DisplayFormat(ConvertEmptyStringToNull=false)]** indicates that empty strings from the model won't be converted to null when the data field is updated in the data source.</span></span> <span data-ttu-id="a01a7-467">Esta configuración evitará una excepción cuando Entity Framework asigna valores null para el modelo antes de anotación de datos valida los campos.</span><span class="sxs-lookup"><span data-stu-id="a01a7-467">This setting will avoid an exception when the Entity Framework assigns null values to the model before Data Annotation validates the fields.</span></span>

    <span data-ttu-id="a01a7-468">(Código de fragmento de código - *las aplicaciones auxiliares de ASP.NET MVC 4 y formularios y validación - clase parcial de metadatos de álbum Ex6*)</span><span class="sxs-lookup"><span data-stu-id="a01a7-468">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex6 Album metadata partial class*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample19.cs)]

    > [!NOTE]
    > <span data-ttu-id="a01a7-469">Esto **álbum** clase parcial tiene un **MetadataType** atributo que apunta a la **AlbumMetaData** clase para las anotaciones de datos.</span><span class="sxs-lookup"><span data-stu-id="a01a7-469">This **Album** partial class has a **MetadataType** attribute which points to the **AlbumMetaData** class for the Data Annotations.</span></span> <span data-ttu-id="a01a7-470">Estos son algunos de los atributos de anotación de datos que se usa para anotar el modelo de álbum:</span><span class="sxs-lookup"><span data-stu-id="a01a7-470">These are some of the Data Annotation attributes you are using to annotate the Album model:</span></span>
    > 
    > - <span data-ttu-id="a01a7-471">Requerido: indica que la propiedad es un campo obligatorio</span><span class="sxs-lookup"><span data-stu-id="a01a7-471">Required - Indicates that the property is a required field</span></span>
    > - <span data-ttu-id="a01a7-472">DisplayName: define el texto que se usará en los campos de formulario y los mensajes de validación</span><span class="sxs-lookup"><span data-stu-id="a01a7-472">DisplayName - Defines the text to be used on form fields and validation messages</span></span>
    > - <span data-ttu-id="a01a7-473">DisplayFormat: especifica cómo se muestran y formato de los campos de datos.</span><span class="sxs-lookup"><span data-stu-id="a01a7-473">DisplayFormat - Specifies how data fields are displayed and formatted.</span></span>
    > - <span data-ttu-id="a01a7-474">StringLength - define una longitud máxima para un campo de cadena</span><span class="sxs-lookup"><span data-stu-id="a01a7-474">StringLength - Defines a maximum length for a string field</span></span>
    > - <span data-ttu-id="a01a7-475">Intervalo: da como resultado un valor máximo y mínimo de un campo numérico</span><span class="sxs-lookup"><span data-stu-id="a01a7-475">Range - Gives a maximum and minimum value for a numeric field</span></span>
    > - <span data-ttu-id="a01a7-476">ScaffoldColumn - permite la ocultación de campos de formularios de editor</span><span class="sxs-lookup"><span data-stu-id="a01a7-476">ScaffoldColumn - Allows hiding fields from editor forms</span></span>

<a id="Ex06Task2"></a>

<a id="Task_2_-_Running_the_Application"></a>
#### <a name="task-2---running-the-application"></a><span data-ttu-id="a01a7-477">Tarea 2: ejecutar la aplicación</span><span class="sxs-lookup"><span data-stu-id="a01a7-477">Task 2 - Running the Application</span></span>

<span data-ttu-id="a01a7-478">En esta tarea, realizará las pruebas que las páginas Create y Edit validan campos, con los nombres para mostrar elegidos en la última tarea.</span><span class="sxs-lookup"><span data-stu-id="a01a7-478">In this task, you will test that the Create and Edit pages validate fields, using the display names chosen in the last task.</span></span>

1. <span data-ttu-id="a01a7-479">Presione **F5** para ejecutar la aplicación.</span><span class="sxs-lookup"><span data-stu-id="a01a7-479">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="a01a7-480">El proyecto se inicia en la página principal.</span><span class="sxs-lookup"><span data-stu-id="a01a7-480">The project starts in the Home page.</span></span> <span data-ttu-id="a01a7-481">Cambiar la dirección URL de **/StoreManager/crear**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-481">Change the URL to **/StoreManager/Create**.</span></span> <span data-ttu-id="a01a7-482">Compruebe que los nombres coinciden con los de la clase parcial (como **URL carátulas de álbum** en lugar de **AlbumArtUrl**)</span><span class="sxs-lookup"><span data-stu-id="a01a7-482">Verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**)</span></span>
3. <span data-ttu-id="a01a7-483">Haga clic en **crear**, sin rellenar el formulario.</span><span class="sxs-lookup"><span data-stu-id="a01a7-483">Click **Create**, without filling the form.</span></span> <span data-ttu-id="a01a7-484">Compruebe que se obtienen los mensajes de validación correspondiente.</span><span class="sxs-lookup"><span data-stu-id="a01a7-484">Verify that you get the corresponding validation messages.</span></span>

    <span data-ttu-id="a01a7-485">![Valida los campos en la página crear](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "valida los campos en la página Crear")</span><span class="sxs-lookup"><span data-stu-id="a01a7-485">![Validated fields in the Create page](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "Validated fields in the Create page")</span></span>

    <span data-ttu-id="a01a7-486">*Campos validados en la página Crear*</span><span class="sxs-lookup"><span data-stu-id="a01a7-486">*Validated fields in the Create page*</span></span>
4. <span data-ttu-id="a01a7-487">Puede comprobar que lo mismo ocurre con el **editar** página.</span><span class="sxs-lookup"><span data-stu-id="a01a7-487">You can verify that the same occurs with the **Edit** page.</span></span> <span data-ttu-id="a01a7-488">Cambiar la dirección URL de **/StoreManager/Edit/1** y compruebe que los nombres coinciden con los de la clase parcial (como **URL carátulas de álbum** en lugar de **AlbumArtUrl**).</span><span class="sxs-lookup"><span data-stu-id="a01a7-488">Change the URL to **/StoreManager/Edit/1** and verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**).</span></span> <span data-ttu-id="a01a7-489">Vacía la **título** y **precio** campos y haga clic en **guardar**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-489">Empty the **Title** and **Price** fields and click **Save**.</span></span> <span data-ttu-id="a01a7-490">Compruebe que se obtienen los mensajes de validación correspondiente.</span><span class="sxs-lookup"><span data-stu-id="a01a7-490">Verify that you get the corresponding validation messages.</span></span>

    ![Campos validados en la página de edición](aspnet-mvc-4-helpers-forms-and-validation/_static/image19.png)

    <span data-ttu-id="a01a7-492">*Campos validados en la página de edición*</span><span class="sxs-lookup"><span data-stu-id="a01a7-492">*Validated fields in the Edit page*</span></span>

<a id="Exercise7"></a>

<a id="Exercise_7_Using_Unobtrusive_jQuery_at_Client_Side"></a>
### <a name="exercise-7-using-unobtrusive-jquery-at-client-side"></a><span data-ttu-id="a01a7-493">Ejercicio 7: Uso de jQuery discreta en el lado cliente</span><span class="sxs-lookup"><span data-stu-id="a01a7-493">Exercise 7: Using Unobtrusive jQuery at Client Side</span></span>

<span data-ttu-id="a01a7-494">En este ejercicio, obtendrá información sobre cómo habilitar la validación de jQuery discreta de MVC 4 en el lado del cliente.</span><span class="sxs-lookup"><span data-stu-id="a01a7-494">In this exercise, you will learn how to enable MVC 4 Unobtrusive jQuery validation at client side.</span></span>

> [!NOTE]
> <span data-ttu-id="a01a7-495">JQuery discreta usa el prefijo de datos ajax JavaScript para invocar métodos de acción en el servidor en lugar de manera intrusiva emitir los scripts de cliente en línea.</span><span class="sxs-lookup"><span data-stu-id="a01a7-495">The Unobtrusive jQuery uses data-ajax prefix JavaScript to invoke action methods on the server rather than intrusively emitting inline client scripts.</span></span>


<a id="Ex7Task1"></a>

<a id="Task_1_-_Running_the_Application_before_Enabling_Unobtrusive_jQuery"></a>
#### <a name="task-1---running-the-application-before-enabling-unobtrusive-jquery"></a><span data-ttu-id="a01a7-496">Tarea 1: ejecutar la aplicación antes de habilitar discreta de jQuery</span><span class="sxs-lookup"><span data-stu-id="a01a7-496">Task 1 - Running the Application before Enabling Unobtrusive jQuery</span></span>

<span data-ttu-id="a01a7-497">En esta tarea, ejecutará la aplicación antes de incluir jQuery con el fin de comparar ambos modelos de validación.</span><span class="sxs-lookup"><span data-stu-id="a01a7-497">In this task, you will run the application before including jQuery in order to compare both validation models.</span></span>

1. <span data-ttu-id="a01a7-498">Abra el **comenzar** solución ubicado en **origen/Ex7-UnobtrusivejQueryValidation/inicio/** carpeta.</span><span class="sxs-lookup"><span data-stu-id="a01a7-498">Open the **Begin** solution located at **Source/Ex7-UnobtrusivejQueryValidation/Begin/** folder.</span></span> <span data-ttu-id="a01a7-499">En caso contrario, es posible que siga usando la **final** solución obtenido completando el ejercicio anterior.</span><span class="sxs-lookup"><span data-stu-id="a01a7-499">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="a01a7-500">Si abrió proporcionado **comenzar** solución, deberá descargar algunos paquetes de NuGet que faltan antes de continuar.</span><span class="sxs-lookup"><span data-stu-id="a01a7-500">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="a01a7-501">Para ello, haga clic en el **proyecto** menú y seleccione **administrar paquetes de NuGet**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-501">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="a01a7-502">En el **administrar paquetes de NuGet** cuadro de diálogo, haga clic en **restaurar** para descargar los paquetes que falten.</span><span class="sxs-lookup"><span data-stu-id="a01a7-502">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="a01a7-503">Por último, compile la solución haciendo **compilar** | **compilar solución**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-503">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="a01a7-504">Una de las ventajas de usar NuGet es que no tienen que enviar todas las bibliotecas en el proyecto, lo que reduce el tamaño del proyecto.</span><span class="sxs-lookup"><span data-stu-id="a01a7-504">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="a01a7-505">Con las herramientas avanzadas de NuGet, mediante la especificación de las versiones del paquete en el archivo Packages.config, podrá descargar todas las bibliotecas requeridas en la primera vez que ejecute el proyecto.</span><span class="sxs-lookup"><span data-stu-id="a01a7-505">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="a01a7-506">Esto es por eso tendrá que ejecutar estos pasos después de abrir una solución existente de este laboratorio.</span><span class="sxs-lookup"><span data-stu-id="a01a7-506">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="a01a7-507">Presione **F5** para ejecutar la aplicación.</span><span class="sxs-lookup"><span data-stu-id="a01a7-507">Press **F5** to run the application.</span></span>
3. <span data-ttu-id="a01a7-508">El proyecto se inicia en la página principal.</span><span class="sxs-lookup"><span data-stu-id="a01a7-508">The project starts in the Home page.</span></span> <span data-ttu-id="a01a7-509">Examinar **/StoreManager/Create** y haga clic en **crear** sin rellenar el formulario para que compruebe que se obtienen mensajes de validación:</span><span class="sxs-lookup"><span data-stu-id="a01a7-509">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="a01a7-510">![Validación de cliente deshabilitado](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "validación de cliente deshabilitado")</span><span class="sxs-lookup"><span data-stu-id="a01a7-510">![Client validation disabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "Client validation disabled")</span></span>

    <span data-ttu-id="a01a7-511">*Validación de cliente deshabilitado*</span><span class="sxs-lookup"><span data-stu-id="a01a7-511">*Client validation disabled*</span></span>
4. <span data-ttu-id="a01a7-512">En el explorador, abra el código fuente HTML:</span><span class="sxs-lookup"><span data-stu-id="a01a7-512">In the browser, open the HTML source code:</span></span>
...
#### <a name="task-2---enabling-unobtrusive-client-validation"></a><span data-ttu-id="a01a7-513">Tarea 2: Habilitar validación del cliente discreta</span><span class="sxs-lookup"><span data-stu-id="a01a7-513">Task 2 - Enabling Unobtrusive Client Validation</span></span>

<span data-ttu-id="a01a7-514">En esta tarea, permitirá jQuery **validación del cliente discreta** desde **Web.config** archivo, que se establece en false en todos los nuevos proyectos de ASP.NET MVC 4 de forma predeterminada.</span><span class="sxs-lookup"><span data-stu-id="a01a7-514">In this task, you will enable jQuery **unobtrusive client validation** from **Web.config** file, which is by default set to false in all new ASP.NET MVC 4 projects.</span></span> <span data-ttu-id="a01a7-515">Además, agregará que las referencias para realizar el trabajo de validación de cliente discreta de jQuery de secuencias de comandos necesarios.</span><span class="sxs-lookup"><span data-stu-id="a01a7-515">Additionally, you will add the necessary scripts references to make jQuery Unobtrusive Client Validation work.</span></span>

1. <span data-ttu-id="a01a7-516">Abra **Web.Config** de archivos en la raíz del proyecto y asegúrese de que el **ClientValidationEnabled** y **UnobtrusiveJavaScriptEnabled** valores de las claves se establecen en **true**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-516">Open **Web.Config** file at project root, and make sure that the **ClientValidationEnabled** and **UnobtrusiveJavaScriptEnabled** keys values are set to **true**.</span></span>

    [!code-xml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample21.xml)]

    > [!NOTE]
    > <span data-ttu-id="a01a7-517">También puede habilitar la validación del cliente mediante código a Global.asax.cs para obtener los mismos resultados:</span><span class="sxs-lookup"><span data-stu-id="a01a7-517">You can also enable client validation by code at Global.asax.cs to get the same results:</span></span>
    > 
    > <span data-ttu-id="a01a7-518">**HtmlHelper.ClientValidationEnabled = true;**</span><span class="sxs-lookup"><span data-stu-id="a01a7-518">**HtmlHelper.ClientValidationEnabled = true;**</span></span>
    > 
    > <span data-ttu-id="a01a7-519">Además, puede asignar el atributo de ClientValidationEnabled en cualquier controlador de tener un comportamiento personalizado.</span><span class="sxs-lookup"><span data-stu-id="a01a7-519">Additionally, you can assign ClientValidationEnabled attribute into any controller to have a custom behavior.</span></span>
2. <span data-ttu-id="a01a7-520">Abra **Create.cshtml** en **Views\StoreManager**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-520">Open **Create.cshtml** at **Views\StoreManager**.</span></span>
3. <span data-ttu-id="a01a7-521">Asegúrese de que los siguientes archivos de script, **jquery.validate** y **jquery.validate.unobtrusive**, se hace referencia en el a través de la vista la &quot; **~/bundles/jqueryval** &quot; agrupación.</span><span class="sxs-lookup"><span data-stu-id="a01a7-521">Make sure the following script files, **jquery.validate** and **jquery.validate.unobtrusive**, are referenced in the view throught the &quot;**~/bundles/jqueryval**&quot; bundle.</span></span>

    [!code-cshtml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample22.cshtml)]

    > [!NOTE]
    > <span data-ttu-id="a01a7-522">Todas estas bibliotecas de jQuery se incluyen en los nuevos proyectos de MVC 4.</span><span class="sxs-lookup"><span data-stu-id="a01a7-522">All these jQuery libraries are included in MVC 4 new projects.</span></span> <span data-ttu-id="a01a7-523">Puede encontrar más bibliotecas en el **/Scripts** carpeta del proyecto.</span><span class="sxs-lookup"><span data-stu-id="a01a7-523">You can find more libraries in the **/Scripts** folder of you project.</span></span>
    > 
    > <span data-ttu-id="a01a7-524">Para realizar esta validación bibliotecas funcionan, deberá agregar una referencia a la biblioteca del marco de jQuery.</span><span class="sxs-lookup"><span data-stu-id="a01a7-524">In order to make this validation libraries work, you need to add a reference to the jQuery framework library.</span></span> <span data-ttu-id="a01a7-525">Puesto que esta referencia se ha agregado en el  **\_Layout.cshtml** archivo, no es necesario agregarlo en esta vista.</span><span class="sxs-lookup"><span data-stu-id="a01a7-525">Since this reference is already added in the **\_Layout.cshtml** file, you do not need to add it in this particular view.</span></span>

<a id="Ex7Task3"></a>

<a id="Task_3_-_Running_the_Application_Using_Unobtrusive_jQuery_Validation"></a>
#### <a name="task-3---running-the-application-using-unobtrusive-jquery-validation"></a><span data-ttu-id="a01a7-526">Tarea 3: ejecutar la validación de jQuery discreta de uso de aplicación</span><span class="sxs-lookup"><span data-stu-id="a01a7-526">Task 3 - Running the Application Using Unobtrusive jQuery Validation</span></span>

<span data-ttu-id="a01a7-527">En esta tarea, probará que la **StoreManager** Crear vista plantilla realiza la validación del lado cliente mediante bibliotecas de jQuery cuando el usuario crea un nuevo álbum.</span><span class="sxs-lookup"><span data-stu-id="a01a7-527">In this task, you will test that the **StoreManager** create view template performs client side validation using jQuery libraries when the user creates a new album.</span></span>

1. <span data-ttu-id="a01a7-528">Presione **F5** para ejecutar la aplicación.</span><span class="sxs-lookup"><span data-stu-id="a01a7-528">Press **F5** to run the application.</span></span>
2. <span data-ttu-id="a01a7-529">El proyecto se inicia en la página principal.</span><span class="sxs-lookup"><span data-stu-id="a01a7-529">The project starts in the Home page.</span></span> <span data-ttu-id="a01a7-530">Examinar **/StoreManager/Create** y haga clic en **crear** sin rellenar el formulario para que compruebe que se obtienen mensajes de validación:</span><span class="sxs-lookup"><span data-stu-id="a01a7-530">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="a01a7-531">![Validación del cliente con jQuery habilitado](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "validación del cliente con jQuery habilitado")</span><span class="sxs-lookup"><span data-stu-id="a01a7-531">![Client validation with jQuery enabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "Client validation with jQuery enabled")</span></span>

    <span data-ttu-id="a01a7-532">*Validación del cliente con jQuery habilitado*</span><span class="sxs-lookup"><span data-stu-id="a01a7-532">*Client validation with jQuery enabled*</span></span>
3. <span data-ttu-id="a01a7-533">En el explorador, abra el código fuente de la vista de creación:</span><span class="sxs-lookup"><span data-stu-id="a01a7-533">In the browser, open the source code for Create view:</span></span>

    [!code-html[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample23.html)]

   > [!NOTE]
   > <span data-ttu-id="a01a7-534">Para cada regla de validación del cliente, jQuery discreta agrega un atributo con datos-val -*rulename*=&quot;*mensaje*&quot;.</span><span class="sxs-lookup"><span data-stu-id="a01a7-534">For each client validation rule, Unobtrusive jQuery adds an attribute with data-val-*rulename*=&quot;*message*&quot;.</span></span> <span data-ttu-id="a01a7-535">A continuación se presenta una lista de etiquetas que discreta jQuery se inserta en el campo de entrada html para realizar la validación de cliente:</span><span class="sxs-lookup"><span data-stu-id="a01a7-535">Below is a list of tags that Unobtrusive jQuery inserts into the html input field to perform client validation:</span></span>
   > 
   > - <span data-ttu-id="a01a7-536">Datos val</span><span class="sxs-lookup"><span data-stu-id="a01a7-536">Data-val</span></span>
   > - <span data-ttu-id="a01a7-537">Número de datos val</span><span class="sxs-lookup"><span data-stu-id="a01a7-537">Data-val-number</span></span>
   > - <span data-ttu-id="a01a7-538">Rango de datos val</span><span class="sxs-lookup"><span data-stu-id="a01a7-538">Data-val-range</span></span>
   > - <span data-ttu-id="a01a7-539">Datos-val-range-min / datos-val-range-Max.</span><span class="sxs-lookup"><span data-stu-id="a01a7-539">Data-val-range-min / Data-val-range-max</span></span>
   > - <span data-ttu-id="a01a7-540">Datos necesarios para val</span><span class="sxs-lookup"><span data-stu-id="a01a7-540">Data-val-required</span></span>
   > - <span data-ttu-id="a01a7-541">Longitud de datos val</span><span class="sxs-lookup"><span data-stu-id="a01a7-541">Data-val-length</span></span>
   > - <span data-ttu-id="a01a7-542">Datos val longitud máxima / datos val longitud mínima</span><span class="sxs-lookup"><span data-stu-id="a01a7-542">Data-val-length-max / Data-val-length-min</span></span>
   > 
   > <span data-ttu-id="a01a7-543">Todos los valores de datos se rellenan con el modelo **anotación de datos**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-543">All the data values are filled with model **Data Annotation**.</span></span> <span data-ttu-id="a01a7-544">A continuación, se puede ejecutar toda la lógica que funciona en el lado del servidor en el lado del cliente.</span><span class="sxs-lookup"><span data-stu-id="a01a7-544">Then, all the logic that works at server side can be run at client side.</span></span> <span data-ttu-id="a01a7-545">Por ejemplo, el atributo precio tiene la siguiente anotación de datos en el modelo:</span><span class="sxs-lookup"><span data-stu-id="a01a7-545">For example, Price attribute has the following data annotation in the model:</span></span>
   > 
   > [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample24.cs)]
   > 
   > <span data-ttu-id="a01a7-546">Después de usar jQuery discreta, el código generado es:</span><span class="sxs-lookup"><span data-stu-id="a01a7-546">After using Unobtrusive jQuery, the generated code is:</span></span>
   > 
...
<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="a01a7-547">Resumen</span><span class="sxs-lookup"><span data-stu-id="a01a7-547">Summary</span></span>

<span data-ttu-id="a01a7-548">Al completar este laboratorio práctico ha aprendido cómo habilitar usuarios cambiar los datos almacenados en la base de datos con el uso de las siguientes acciones:</span><span class="sxs-lookup"><span data-stu-id="a01a7-548">By completing this Hands-On Lab you have learned how to enable users to change the data stored in the database with the use of the following:</span></span>

- <span data-ttu-id="a01a7-549">Las acciones de controlador, como Index, Create, Edit, Delete</span><span class="sxs-lookup"><span data-stu-id="a01a7-549">Controller actions like Index, Create, Edit, Delete</span></span>
- <span data-ttu-id="a01a7-550">Característica de scaffolding de ASP.NET MVC para mostrar las propiedades en una tabla HTML</span><span class="sxs-lookup"><span data-stu-id="a01a7-550">ASP.NET MVC's scaffolding feature for displaying properties in an HTML table</span></span>
- <span data-ttu-id="a01a7-551">Experimentan de aplicaciones auxiliares HTML personalizadas para mejorar el usuario</span><span class="sxs-lookup"><span data-stu-id="a01a7-551">Custom HTML helpers to improve user experience</span></span>
- <span data-ttu-id="a01a7-552">Métodos de acción que reaccionan a HTTP-GET o las llamadas HTTP-POST</span><span class="sxs-lookup"><span data-stu-id="a01a7-552">Action methods that react to either HTTP-GET or HTTP-POST calls</span></span>
- <span data-ttu-id="a01a7-553">Una plantilla de editor compartida para las plantillas de vista similares, como Create y Edit</span><span class="sxs-lookup"><span data-stu-id="a01a7-553">A shared editor template for similar View templates like Create and Edit</span></span>
- <span data-ttu-id="a01a7-554">Elementos de formulario como listas desplegables</span><span class="sxs-lookup"><span data-stu-id="a01a7-554">Form elements like drop-downs</span></span>
- <span data-ttu-id="a01a7-555">Anotaciones de datos para la validación del modelo</span><span class="sxs-lookup"><span data-stu-id="a01a7-555">Data annotations for Model validation</span></span>
- <span data-ttu-id="a01a7-556">Validación del lado cliente mediante la biblioteca de jQuery discreta</span><span class="sxs-lookup"><span data-stu-id="a01a7-556">Client Side Validation using jQuery Unobtrusive library</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="a01a7-557">Apéndice A: instalación de Visual Studio Express 2012 para Web</span><span class="sxs-lookup"><span data-stu-id="a01a7-557">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="a01a7-558">Puede instalar **Microsoft Visual Studio Express 2012 para Web** u otro &quot;Express&quot; versión utilizando el **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-558">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="a01a7-559">Las instrucciones siguientes le guían a través de los pasos necesarios para instalar *Visual studio Express 2012 para Web* mediante *Microsoft Web Platform Installer*.</span><span class="sxs-lookup"><span data-stu-id="a01a7-559">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="a01a7-560">Vaya a [ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169).</span><span class="sxs-lookup"><span data-stu-id="a01a7-560">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="a01a7-561">Como alternativa, si ya ha instalado el instalador de plataforma Web, puede abrirla y busque el producto &quot; <em>Visual Studio Express 2012 for Web con SDK de Windows Azure</em>&quot;.</span><span class="sxs-lookup"><span data-stu-id="a01a7-561">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Windows Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="a01a7-562">Haga clic en **instalar ahora**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-562">Click on **Install Now**.</span></span> <span data-ttu-id="a01a7-563">Si no tienes **instalador de plataforma Web** se le redirigirá para descargarlo e instalarlo en primer lugar.</span><span class="sxs-lookup"><span data-stu-id="a01a7-563">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="a01a7-564">Una vez **instalador de plataforma Web** está abierto, haga clic en **instalar** para iniciar el programa de instalación.</span><span class="sxs-lookup"><span data-stu-id="a01a7-564">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="a01a7-565">![Instale Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "instale Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="a01a7-565">![Install Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="a01a7-566">*Instale Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="a01a7-566">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="a01a7-567">Leer todos los productos las licencias y los términos y haga clic en **acepto** para continuar.</span><span class="sxs-lookup"><span data-stu-id="a01a7-567">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![Acepte los términos de licencia](aspnet-mvc-4-helpers-forms-and-validation/_static/image23.png)

    <span data-ttu-id="a01a7-569">*Acepte los términos de licencia*</span><span class="sxs-lookup"><span data-stu-id="a01a7-569">*Accepting the license terms*</span></span>
5. <span data-ttu-id="a01a7-570">Espere hasta que finalice el proceso de descarga e instalación.</span><span class="sxs-lookup"><span data-stu-id="a01a7-570">Wait until the downloading and installation process completes.</span></span>

    ![Progreso de la instalación](aspnet-mvc-4-helpers-forms-and-validation/_static/image24.png)

    <span data-ttu-id="a01a7-572">*Progreso de la instalación*</span><span class="sxs-lookup"><span data-stu-id="a01a7-572">*Installation progress*</span></span>
6. <span data-ttu-id="a01a7-573">Cuando se complete la instalación, haga clic en **finalizar**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-573">When the installation completes, click **Finish**.</span></span>

    ![Instalación completada](aspnet-mvc-4-helpers-forms-and-validation/_static/image25.png)

    <span data-ttu-id="a01a7-575">*Instalación completada*</span><span class="sxs-lookup"><span data-stu-id="a01a7-575">*Installation completed*</span></span>
7. <span data-ttu-id="a01a7-576">Haga clic en **Exit** para cerrar el instalador de plataforma Web.</span><span class="sxs-lookup"><span data-stu-id="a01a7-576">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="a01a7-577">Para abrir Visual Studio Express para Web, vaya a la **iniciar** pantalla y comienza a escribir &quot; **VS Express**&quot;, a continuación, haga clic en el **VS Express para Web** icono.</span><span class="sxs-lookup"><span data-stu-id="a01a7-577">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express para el icono de Web](aspnet-mvc-4-helpers-forms-and-validation/_static/image26.png)

    <span data-ttu-id="a01a7-579">*VS Express para el icono de Web*</span><span class="sxs-lookup"><span data-stu-id="a01a7-579">*VS Express for Web tile*</span></span>

<a id="AppendixB"></a>

<a id="Appendix_B_Using_Code_Snippets"></a>
## <a name="appendix-b-using-code-snippets"></a><span data-ttu-id="a01a7-580">Apéndice B: uso de fragmentos de código</span><span class="sxs-lookup"><span data-stu-id="a01a7-580">Appendix B: Using Code Snippets</span></span>

<span data-ttu-id="a01a7-581">Con fragmentos de código, tiene todo el código que necesita a su alcance.</span><span class="sxs-lookup"><span data-stu-id="a01a7-581">With code snippets, you have all the code you need at your fingertips.</span></span> <span data-ttu-id="a01a7-582">El documento de laboratorio le dirá exactamente cuándo se pueden utilizar, como se muestra en la ilustración siguiente.</span><span class="sxs-lookup"><span data-stu-id="a01a7-582">The lab document will tell you exactly when you can use them, as shown in the following figure.</span></span>

<span data-ttu-id="a01a7-583">![Uso de fragmentos de código de Visual Studio para insertar código en el proyecto](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "fragmentos de código en Visual Studio para insertar código en el proyecto")</span><span class="sxs-lookup"><span data-stu-id="a01a7-583">![Using Visual Studio code snippets to insert code into your project](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "Using Visual Studio code snippets to insert code into your project")</span></span>

<span data-ttu-id="a01a7-584">*Uso de fragmentos de código de Visual Studio para insertar código en el proyecto*</span><span class="sxs-lookup"><span data-stu-id="a01a7-584">*Using Visual Studio code snippets to insert code into your project*</span></span>

<span data-ttu-id="a01a7-585">***Para agregar un fragmento de código mediante el teclado (solo C#)***</span><span class="sxs-lookup"><span data-stu-id="a01a7-585">***To add a code snippet using the keyboard (C# only)***</span></span>

1. <span data-ttu-id="a01a7-586">Coloque el cursor donde desea insertar el código.</span><span class="sxs-lookup"><span data-stu-id="a01a7-586">Place the cursor where you would like to insert the code.</span></span>
2. <span data-ttu-id="a01a7-587">Comience a escribir el nombre del fragmento de código (sin espacios ni guiones).</span><span class="sxs-lookup"><span data-stu-id="a01a7-587">Start typing the snippet name (without spaces or hyphens).</span></span>
3. <span data-ttu-id="a01a7-588">Observe cómo IntelliSense muestra los nombres de fragmentos de código coincidentes.</span><span class="sxs-lookup"><span data-stu-id="a01a7-588">Watch as IntelliSense displays matching snippets' names.</span></span>
4. <span data-ttu-id="a01a7-589">Seleccione el fragmento de código correcto (o siga escribiendo hasta que se selecciona el nombre del fragmento de código completo).</span><span class="sxs-lookup"><span data-stu-id="a01a7-589">Select the correct snippet (or keep typing until the entire snippet's name is selected).</span></span>
5. <span data-ttu-id="a01a7-590">Presione la tecla Tab dos veces para insertar el fragmento de código en la ubicación del cursor.</span><span class="sxs-lookup"><span data-stu-id="a01a7-590">Press the Tab key twice to insert the snippet at the cursor location.</span></span>

<span data-ttu-id="a01a7-591">![Comience a escribir el nombre del fragmento](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "comience a escribir el nombre del fragmento de código")</span><span class="sxs-lookup"><span data-stu-id="a01a7-591">![Start typing the snippet name](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "Start typing the snippet name")</span></span>

<span data-ttu-id="a01a7-592">*Comience a escribir el nombre del fragmento de código*</span><span class="sxs-lookup"><span data-stu-id="a01a7-592">*Start typing the snippet name*</span></span>

<span data-ttu-id="a01a7-593">![Presione la tecla Tab para seleccionar el fragmento de código resaltada](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "presione Tab para seleccionar el fragmento de código resaltada")</span><span class="sxs-lookup"><span data-stu-id="a01a7-593">![Press Tab to select the highlighted snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "Press Tab to select the highlighted snippet")</span></span>

<span data-ttu-id="a01a7-594">*Presione la tecla Tab para seleccionar el fragmento de código resaltada*</span><span class="sxs-lookup"><span data-stu-id="a01a7-594">*Press Tab to select the highlighted snippet*</span></span>

<span data-ttu-id="a01a7-595">![Vuelva a presionar Tab y el fragmento de código se expandirán](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "vuelva a presionar Tab y el fragmento de código se expandirán")</span><span class="sxs-lookup"><span data-stu-id="a01a7-595">![Press Tab again and the snippet will expand](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "Press Tab again and the snippet will expand")</span></span>

<span data-ttu-id="a01a7-596">*Vuelva a presionar Tab y el fragmento de código se expandirán*</span><span class="sxs-lookup"><span data-stu-id="a01a7-596">*Press Tab again and the snippet will expand*</span></span>

<span data-ttu-id="a01a7-597">***Para agregar un fragmento de código con el mouse (C#, en Visual Basic y XML)*** 1.</span><span class="sxs-lookup"><span data-stu-id="a01a7-597">***To add a code snippet using the mouse (C#, Visual Basic and XML)*** 1.</span></span> <span data-ttu-id="a01a7-598">Haga doble clic en el desea insertar el fragmento de código.</span><span class="sxs-lookup"><span data-stu-id="a01a7-598">Right-click where you want to insert the code snippet.</span></span>

1. <span data-ttu-id="a01a7-599">Seleccione **Insertar fragmento de código** seguido **Mis fragmentos de código**.</span><span class="sxs-lookup"><span data-stu-id="a01a7-599">Select **Insert Snippet** followed by **My Code Snippets**.</span></span>
2. <span data-ttu-id="a01a7-600">Seleccione el fragmento de código relevante en la lista, haciendo clic en él.</span><span class="sxs-lookup"><span data-stu-id="a01a7-600">Pick the relevant snippet from the list, by clicking on it.</span></span>

<span data-ttu-id="a01a7-601">![Con el botón secundario donde desea insertar el fragmento de código y seleccione Insertar fragmento de código](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "contextual donde desea insertar el fragmento de código y seleccione Insertar fragmento de código")</span><span class="sxs-lookup"><span data-stu-id="a01a7-601">![Right-click where you want to insert the code snippet and select Insert Snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "Right-click where you want to insert the code snippet and select Insert Snippet")</span></span>

<span data-ttu-id="a01a7-602">*Haga doble clic donde desea insertar el fragmento de código y seleccione Insertar fragmento de código*</span><span class="sxs-lookup"><span data-stu-id="a01a7-602">*Right-click where you want to insert the code snippet and select Insert Snippet*</span></span>

<span data-ttu-id="a01a7-603">![Elegir el fragmento de código relevante en la lista, hacer clic en ella](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "elegir el fragmento de código relevante en la lista, hacer clic en ella")</span><span class="sxs-lookup"><span data-stu-id="a01a7-603">![Pick the relevant snippet from the list, by clicking on it](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "Pick the relevant snippet from the list, by clicking on it")</span></span>

<span data-ttu-id="a01a7-604">*Elegir el fragmento de código relevante en la lista, hacer clic en ella*</span><span class="sxs-lookup"><span data-stu-id="a01a7-604">*Pick the relevant snippet from the list, by clicking on it*</span></span>
