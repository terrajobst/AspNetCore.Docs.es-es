...
- Relevante [HttpApplication](https://msdn.microsoft.com/en-us/library/system.web.httpapplication.aspx) fases para ayudarle a entender dónde MVC se integra en el [ciclo de vida de aplicación de ASP.NET](https://msdn.microsoft.com/en-us/library/bb470252.aspx).
...
- Selección de ubicación y finalidad de todos los métodos reemplazables en el [controlador](https://msdn.microsoft.com/en-us/library/system.web.mvc.controller.aspx) objeto en la canalización de procesamiento de solicitudes. Puede o no puede tener la necesidad de reemplazar un método de prueba, pero es importante para comprender su rol en el ciclo de vida de la aplicación para que pueda escribir código en la fase del ciclo de vida adecuado para el efecto deseado.
