...
## <a name="perform-raw-sql-queries"></a>Realizar consultas SQL sin formato
...
## <a name="create-an-abstraction-layer"></a>Crear una capa de abstracción
