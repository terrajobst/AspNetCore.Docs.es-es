...
ms.locfileid: "30872889"
---
<a name="displaying-a-table-of-database-data-c"></a>Muestra una tabla de la base de datos (C#)
====================
por [Microsoft](https://github.com/microsoft)

[Descarga de PDF](http://download.microsoft.com/download/1/1/f/11f721aa-d749-4ed7-bb89-a681b68894e6/ASPNET_MVC_Tutorial_11_CS.pdf)
...
**Figura 01**: crear clases de LINQ to SQL ([haga clic aquí para ver la imagen a tamaño completo](displaying-a-table-of-database-data-cs/_static/image2.png))
...
**Figura 02**: el Entity Data Model Designer ([haga clic aquí para ver la imagen a tamaño completo](displaying-a-table-of-database-data-cs/_static/image4.png))
...
**Figura 03**: controlador de agregar el menú ([haga clic aquí para ver la imagen a tamaño completo](displaying-a-table-of-database-data-cs/_static/image6.png))
...
**Figura 04**: cuadro de diálogo de agregar el controlador ([haga clic aquí para ver la imagen a tamaño completo](displaying-a-table-of-database-data-cs/_static/image8.png))
...
En la lista 1, la clase MoviesDBEntities se usa para representar la base de datos de MoviesDB. Para utilizar esta clase, debe importar el espacio de nombres MvcApplication1.Models similar al siguiente:
...
**Figura 05**: agregar una vista ([haga clic aquí para ver la imagen a tamaño completo](displaying-a-table-of-database-data-cs/_static/image10.png))
...
**Figura 06**: cuadro de diálogo de agregar la vista ([haga clic aquí para ver la imagen a tamaño completo](displaying-a-table-of-database-data-cs/_static/image12.png))
...
**Figura 07**: una tabla de películas ([haga clic aquí para ver la imagen a tamaño completo](displaying-a-table-of-database-data-cs/_static/image14.png))
...
La vista en el listado 4 contiene un bucle foreach que recorre en iteración todas las películas. Para cada película, el MovieTemplate parcial se usa para dar formato a la película. El MovieTemplate se representa mediante una llamada al método de aplicación auxiliar RenderPartial().
