...
---
<a name="validation-with-the-data-annotation-validators-c"></a>Validación con los controles de validación de la anotación de datos (C#)
====================
...
**Figura 1**: agregar una referencia al enlazador de modelos de anotaciones de datos ([haga clic aquí para ver la imagen a tamaño completo](validation-with-the-data-annotation-validators-cs/_static/image3.png))
...
Esta línea de código registra el ataAnnotationsModelBinder como el enlazador de modelos predeterminado para toda la aplicación ASP.NET MVC.
...
**Figura 6**: usar validadores con Entity Framework ([haga clic aquí para ver la imagen a tamaño completo](validation-with-the-data-annotation-validators-cs/_static/image14.png))
