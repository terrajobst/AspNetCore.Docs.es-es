...
**Figura 01**: cuadro de diálogo nuevo proyecto ([haga clic aquí para ver imagen en tamaño completo](iteration-1-create-the-application-vb/_static/image2.png))
...
**Figura 02**: cuadro de diálogo de la creación de proyecto de prueba de unidad ([haga clic aquí para ver imagen en tamaño completo](iteration-1-create-the-application-vb/_static/image4.png))
...
**Figura 03**: ventana del explorador de soluciones ([haga clic aquí para ver imagen en tamaño completo](iteration-1-create-the-application-vb/_static/image6.png))
...
**Figura 06**: cuadro de diálogo Agregar nuevo elemento ([haga clic aquí para ver imagen en tamaño completo](iteration-1-create-the-application-vb/_static/image12.png))
...
**Figura 08**: elegir la conexión de datos ([haga clic aquí para ver imagen en tamaño completo](iteration-1-create-the-application-vb/_static/image16.png))
...
**Figura 10**: clase Contact The ([haga clic aquí para ver imagen en tamaño completo](iteration-1-create-the-application-vb/_static/image20.png))
...
**Figura 12**: adición de la vista de índice ([haga clic aquí para ver imagen en tamaño completo](iteration-1-create-the-application-vb/_static/image24.png))
...
**Figura 13**: cuadro de diálogo de agregar la vista ([haga clic aquí para ver imagen en tamaño completo](iteration-1-create-the-application-vb/_static/image26.png))
...
**Figura 15**: vista de índice de la ([haga clic aquí para ver imagen en tamaño completo](iteration-1-create-the-application-vb/_static/image30.png))
...
**Figura 18**: The Create View ([haga clic aquí para ver imagen en tamaño completo](iteration-1-create-the-application-vb/_static/image36.png))
...
**Figura 19**: adición de una vista de edición ([haga clic aquí para ver imagen en tamaño completo](iteration-1-create-the-application-vb/_static/image38.png))
