...
ms.locfileid: "41829883"
---
<a name="iteration-6--use-test-driven-development-vb"></a>Iteración #6: usar el desarrollo controlado por pruebas (VB)
====================
por [Microsoft](https://github.com/microsoft)

[Descargue el código](iteration-6-use-test-driven-development-vb/_static/contactmanager_6_vb1.zip)
...
**Listado 13 - Models\EntityContactManagerRepository.vb**
...
**Figura 07**: ver el índice de grupo ([haga clic aquí para ver imagen en tamaño completo](iteration-6-use-test-driven-development-vb/_static/image14.png))
...
**Figura 08**: vista de índice de póngase en contacto con el ([haga clic aquí para ver imagen en tamaño completo](iteration-6-use-test-driven-development-vb/_static/image16.png))
