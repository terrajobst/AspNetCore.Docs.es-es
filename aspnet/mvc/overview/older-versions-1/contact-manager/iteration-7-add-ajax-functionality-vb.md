...
[Descargar código](iteration-7-add-ajax-functionality-vb/_static/contactmanager_7_vb1.zip)
...
**Figura 01**: actualizar solo contactos ([haga clic aquí para ver la imagen a tamaño completo](iteration-7-add-ajax-functionality-vb/_static/image2.png))
...
**El listado 3 - Controllers\ContactController.vb (método de Index)**
...
**Figura 02**: la página de confirmación de eliminación ([haga clic aquí para ver la imagen a tamaño completo](iteration-7-add-ajax-functionality-vb/_static/image4.png))
