...
title: Autenticar a los usuarios con la autenticación de Windows (VB) | Documentos de Microsoft
author: microsoft
...
Después de habilitar la autenticación de Windows, puede usar el &lt;Authorize&gt; atributo para controlar el acceso a los controladores o las acciones de controlador. Este atributo se puede aplicar a un controlador MVC completo o una acción de controlador determinado.
