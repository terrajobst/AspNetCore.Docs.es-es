...
(Ya que hemos creado el mensaje que nosotros mismos en ProductController, realmente no necesitamos codificar el mensaje. Sin embargo, es un buen hábito siempre llamar al método Html.Encode() al mostrar el contenido de recuperarse de los datos de vista en una vista.)
