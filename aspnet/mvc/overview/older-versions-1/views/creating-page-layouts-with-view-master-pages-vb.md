...
**Figura 01**: adición de una página de vista maestra ([haga clic aquí para ver imagen en tamaño completo](creating-page-layouts-with-view-master-pages-vb/_static/image3.png))
...
**Figura 03**: adición de una página de contenido de vista ([haga clic aquí para ver imagen en tamaño completo](creating-page-layouts-with-view-master-pages-vb/_static/image9.png))
...
**Figura 05**: página de índice de la vista contenido ([haga clic aquí para ver imagen en tamaño completo](creating-page-layouts-with-view-master-pages-vb/_static/image15.png))
