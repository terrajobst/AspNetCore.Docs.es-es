...
**Figura 01**: cuadro de diálogo nuevo proyecto ([haga clic aquí para ver la imagen a tamaño completo](understanding-models-views-and-controllers-cs/_static/image2.png))
...
[![Crear cuadro de diálogo de pruebas unitarias](understanding-models-views-and-controllers-cs/_static/image2.jpg)](understanding-models-views-and-controllers-cs/_static/image3.png)

**Figura 02**: crear unidad Probar cuadro de diálogo ([haga clic aquí para ver la imagen a tamaño completo](understanding-models-views-and-controllers-cs/_static/image4.png))
...
**Figura 03**: la ventana del explorador de soluciones ([haga clic aquí para ver la imagen a tamaño completo](understanding-models-views-and-controllers-cs/_static/image6.png))
...
**Figura 04**: cuadro de diálogo de depuración no habilitada ([haga clic aquí para ver la imagen a tamaño completo](understanding-models-views-and-controllers-cs/_static/image8.png))
...
**Figura 05**: la página de índice ([haga clic aquí para ver la imagen a tamaño completo](understanding-models-views-and-controllers-cs/_static/image11.png))
...
Un controlador es simplemente una clase (por ejemplo, una clase de Visual Basic o C#). El ejemplo de aplicación de ASP.NET MVC incluye un controlador denominado HomeController.cs que se encuentra en la carpeta de controladores. El contenido del archivo HomeController.cs se reproduce en el listado 2.
