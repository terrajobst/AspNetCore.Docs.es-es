...
ms.locfileid: "37831205"
---
<a name="create-a-movie-database-application-in-15-minutes-with-aspnet-mvc-vb"></a>Crear una aplicación de base de datos de la película en 15 minutos con ASP.NET MVC (VB)
====================
por [Stephen Walther](https://github.com/StephenWalther)

[Descargue el código](http://download.microsoft.com/download/7/2/8/728F8794-E59A-4D18-9A56-7AD2DB05BD9D/MovieApp_VB.zip)
...
**Figura 01**: cuadro de diálogo nuevo proyecto ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image2.png))
...
**Figura 02**: cuadro de diálogo de la creación de proyecto de prueba de unidad ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image4.png))
...
**Figura 03**: creación de una base de datos de Microsoft SQL Server ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image6.png))
...
**Figura 04**: tabla de base de datos de las películas ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image8.png))
...
**Figura 05**: inserción de registros de película ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image10.png))
...
**Figura 06**: generar un modelo de base de datos con el Asistente para Entity Data Model ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image12.png))
...
**Figura 07**: The Entity Data Model Designer ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image14.png))
...
**Figura 08**: agregar un nuevo controlador de MVC de ASP.NET ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image16.png))
...
**Listado 2 – Controllers/HomeController.vb (método de índice modificado)**
...
**Figura 09**: adición de una vista desde una acción de controlador ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image18.png))
...
**Figura 10**: crear una nueva vista con el cuadro de diálogo Agregar vista ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image20.png))
...
**Figura 11**: vista de índice de la ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image22.png))
...
**Listado 4 – Controllers\HomeController.vb (método Create modificado)**
...
**Figura 12**: adición de la vista de creación ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image24.png))
...
**Figura 13**: crear un nuevo registro de base de datos de películas ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image26.png))
...
En primer lugar, tenemos que generar el formulario de edición. Este paso es fácil, ya que Visual Studio generará el formulario de edición para que podamos automáticamente. Abra la clase HomeController.vb en el editor de código de Visual Studio y siga estos pasos:
...
**Figura 14**: adición de la vista de edición ([haga clic aquí para ver imagen en tamaño completo](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-vb/_static/image28.png))
...
**Listado 6 – Controllers\HomeController.vb (métodos)**
