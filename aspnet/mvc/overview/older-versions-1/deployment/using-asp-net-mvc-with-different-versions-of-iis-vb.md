...
**Figura 1**: detectar el modo de procesamiento de solicitud ([haga clic aquí para ver la imagen a tamaño completo](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image2.png))
...
**Figura 2**: recibir un error 404 no encontrado ([haga clic aquí para ver la imagen a tamaño completo](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image4.png))
...
**Figura 3**: crear una asignación de script comodín con IIS 7.0 ([haga clic aquí para ver la imagen a tamaño completo](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image6.png))
...
**Figura 4**: crear una asignación de script comodín con IIS 6.0 ([haga clic aquí para ver la imagen a tamaño completo](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image8.png))
...
**Figura 5**: error de la ruta de raíz que faltan ([haga clic aquí para ver la imagen a tamaño completo](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image10.png))
