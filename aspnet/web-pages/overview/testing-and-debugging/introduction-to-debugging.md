...
3. Guarde la página y ejecútelo en un explorador.
   ...
   - Variables de servidor ASP.NET. En esta sección se proporcionan detalles acerca de los numerosos detalles de protocolo HTTP (llamado HTTP variables) y los valores que forman parte de cada solicitud de página web.
