...
Este error puede producirse si el servidor no está configurado correctamente para usar .NET Framework 4 o posterior y, por tanto, no reconoce el código en `@{ }` bloques. Consulte la descripción anterior de *Error HTTP 403 - Prohibido: acceso denegado*.
