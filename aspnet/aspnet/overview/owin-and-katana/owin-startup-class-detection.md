...
2. Agregar una clase de inicio OWIN. En Visual Studio 2013 haga clic en el proyecto y seleccione **Agregar clase**.: en la **Agregar nuevo elemento** diálogo cuadro, escriba *OWIN* en el campo de búsqueda y cambie el nombre a Startup.cs, y, a continuación, haga clic en **agregar**.  
