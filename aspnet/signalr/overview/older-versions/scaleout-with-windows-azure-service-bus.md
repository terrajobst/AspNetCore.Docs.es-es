...
---
<a name="signalr-scaleout-with-azure-service-bus-signalr-1x"></a>Ampliación de SignalR con el Bus de servicio de Azure (SignalR 1.x)
====================
por [Mike Wasson](https://github.com/MikeWasson), [Patrick Fletcher](https://github.com/pfletcher)

En este tutorial, implementará una aplicación de SignalR para un rol Web de Windows Azure mediante el backplane de Bus de servicio para distribuir mensajes a cada instancia de rol.
...
El backplane de bus de servicio también es compatible con [Service Bus para Windows Server](https://msdn.microsoft.com/library/windowsazure/dn282144.aspx), versión 1.1. Sin embargo, no es compatible con la versión 1.0 de Service Bus para Windows Server.
...
En el **nuevo servicio de nube de Windows Azure** cuadro de diálogo, seleccione un rol de Web de 4 de ASP.NET MVC. Haga clic en el botón de flecha derecha (**&gt;**) para agregar el rol a la solución.
...
Para crear la aplicación de chat, siga los pasos del tutorial [Getting Started with SignalR y MVC 4](tutorial-getting-started-with-signalr-and-mvc-4.md).
